"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-171
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="equipa-secao-171" ref={raiz}>
      <div className="page-wrapper">
      <section className="sec_team"> <div className="padding-section-medium"></div> <div className="padding-global"> <div className="container-large"> <div data-reveal="" className="team_header"> <div className="tag"> <div className="dot-square"></div> <div>Teams</div> </div> <h2 className="scroll-right">{s.titulo}</h2> <div className="scroll-right"> <div className="spacer-medium hide-mobile-landscape"></div> <a href="/contact" className="button-arrow is-black w-inline-block"> <div className="button-arrow_wrap"> <div className="button-arrow_text"> <div className="text_button">Contact us</div> </div> <div className="button_container-arrow is-black"><svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 20 20" fill="none" className="icon-1x1-main"> <path d="M13.0457 8.13128L5.8733 15.3037L4.69479 14.1252L11.8672 6.95277L5.54568 6.95277L5.54568 5.28636H14.7121V14.4528L13.0457 14.4528V8.13128Z" fill="currentColor"></path> </svg></div> <div className="button-arrow_bg is-black"></div> </div> </a> </div> </div> <div className="spacer-section-medium"></div> <div data-reveal="">  <div className="team_cards swiper"> <div role="list" className="team_track swiper-wrapper"> <div role="listitem" className="team_card-item w-dyn-item swiper-slide"> <a style={{backgroundColor: 'rgb(236,236,236)'}} href="/team/cheyenne-george" className="team_card scroll-right w-inline-block"> <div className="arrow_button"><svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 20 20" fill="none" className="icon-1x1-main"> <path d="M13.0457 8.13128L5.8733 15.3037L4.69479 14.1252L11.8672 6.95277L5.54568 6.95277L5.54568 5.28636H14.7121V14.4528L13.0457 14.4528V8.13128Z" fill="currentColor"></path> </svg></div> <div className="team_card-header"> <div className="max-text is-name"> <h3 className="h2 text-weight-semibold">{s.subtitulo}</h3> </div> <div className="text-sm">Marketing Officer</div> </div> <div className="team_card-img"><img src={s.imagem} loading="lazy" alt="Cheyenne George" className="img" /></div> </a> </div><div role="listitem" className="team_card-item w-dyn-item swiper-slide"> <a style={{backgroundColor: 'rgb(236,236,236)'}} href="/team/erin-siphron" className="team_card scroll-right w-inline-block"> <div className="arrow_button"><svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 20 20" fill="none" className="icon-1x1-main"> <path d="M13.0457 8.13128L5.8733 15.3037L4.69479 14.1252L11.8672 6.95277L5.54568 6.95277L5.54568 5.28636H14.7121V14.4528L13.0457 14.4528V8.13128Z" fill="currentColor"></path> </svg></div> <div className="team_card-header"> <div className="max-text is-name"> <h3 className="h2 text-weight-semibold">{s.subtitulo2}</h3> </div> <div className="text-sm">Director of HR</div> </div> <div className="team_card-img"><img src={s.imagem2} loading="lazy" alt="Erin Siphron" className="img" /></div> </a> </div><div role="listitem" className="team_card-item w-dyn-item swiper-slide"> <a style={{backgroundColor: 'rgb(236,236,236)'}} href="/team/jaylon-calzoni" className="team_card scroll-right w-inline-block"> <div className="arrow_button"><svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 20 20" fill="none" className="icon-1x1-main"> <path d="M13.0457 8.13128L5.8733 15.3037L4.69479 14.1252L11.8672 6.95277L5.54568 6.95277L5.54568 5.28636H14.7121V14.4528L13.0457 14.4528V8.13128Z" fill="currentColor"></path> </svg></div> <div className="team_card-header"> <div className="max-text is-name"> <h3 className="h2 text-weight-semibold">{s.subtitulo3}</h3> </div> <div className="text-sm">Senior Analyst</div> </div> <div className="team_card-img"><img src={s.imagem3} loading="lazy" alt="Jaylon Calzoni" className="img" /></div> </a> </div> </div> </div>  <div className="arrows_wrap is-team"> <div className="arrow_container slide_prev"><svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" className="icon-1x1-medium"> <path d="M7.828 13.0007L20 13.0007L20 11.0007L7.828 11.0007L13.192 5.63666L11.778 4.22266L4 12.0007L11.778 19.7787L13.192 18.3647L7.828 13.0007Z" fill="currentColor"></path> </svg></div> <div className="arrow_container slide_next"><svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" className="icon-1x1-medium"> <path d="M16.172 13.0007L4 13.0007L4 11.0007L16.172 11.0007L10.808 5.63666L12.222 4.22266L20 12.0007L12.222 19.7787L10.808 18.3647L16.172 13.0007Z" fill="currentColor"></path> </svg></div> </div> </div> </div> </div> <div className="padding-section-medium"></div> </section>
        </div>
    </section>
  );
}