"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-174
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // hirely-team — no local logic. The grid reveal (.scroll-animation growIn on the
  //   // heading, subtitle and each .team_card) is driven by /hirely/scripts/scroll-reveal.js.
  ...
  return (
    <section className="dobra" data-dobra="equipa-secao-174" ref={raiz}>
              ...
              <div className="padding-global">
                <div className="container-large">
                  <div className="text-align-center">
                    ...
                    <div className="text-color-secondary scroll-animation">Meet the dedicated professionals behind our success.</div>
                  </div>
                  <div className="spacer">
                    <div style={{height: '4.75rem'}} className="spacer-desktop"></div>
                    <div style={{height: '3.75rem'}} className="spacer-tablet"></div>
                    <div style={{height: '2.75rem'}} className="spacer-mobile"></div>
                  </div>
                  <div className="team_grid">
                    <div className="team_card scroll-animation">
                      <div className="team_card-img"><img src={s.imagem} loading="lazy" alt="A formally dressed woman smiling confidently, conveying professionalism and trust in recruitment services." sizes="(max-width: 656px) 100vw, 656px" className="img" /></div>
                      <div className="team_card-content">
                        <div>
                          <div className="text-xl">Mark Tressler</div>
                          <div className="text-color-secondary">CEO</div>
                        </div>
                        <a href={s.destino || '#'} className="social_icon w-inline-block"><img src={s.imagem2} loading="lazy" alt="LinkedIn Icon" className="icon-1x1-medium" /></a>
                      </div>
                    </div>
                    <div className="team_card scroll-animation">
                      <div className="team_card-img"><img src={s.imagem3} loading="lazy" alt="A professionally dressed man smiling confidently, reflecting reliability and success in recruitment and HR solutions." sizes="(max-width: 656px) 100vw, 656px" className="img" /></div>
                      <div className="team_card-content">
                        <div>
                          <div className="text-xl">Mark Tressler</div>
                          <div className="text-color-secondary">CEO</div>
                        </div>
                        <a href={s.destino2 || '#'} className="social_icon w-inline-block"><img src={s.imagem4} loading="lazy" alt="LinkedIn Icon" className="icon-1x1-medium" /></a>
                      </div>
                    </div>
                    <div className="team_card scroll-animation">
                      <div className="team_card-img"><img src={s.imagem5} loading="lazy" alt="A formally dressed woman smiling confidently, conveying professionalism and trust in recruitment services." sizes="(max-width: 656px) 100vw, 656px" className="img" /></div>
                      <div className="team_card-content">
                        <div>
                          <div className="text-xl">Mark Tressler</div>
                          <div className="text-color-secondary">CEO</div>
                        </div>
                        <a href={s.destino3 || '#'} className="social_icon w-inline-block"><img src={s.imagem6} loading="lazy" alt="LinkedIn Icon" className="icon-1x1-medium" /></a>
                      </div>
                    </div>
                    <div className="team_card scroll-animation">
                      <div className="team_card-img"><img src={s.imagem7} loading="lazy" alt="A professionally dressed man smiling confidently, reflecting reliability and success in recruitment and HR solutions." sizes="(max-width: 656px) 100vw, 656px" className="img" /></div>
                      <div className="team_card-content">
                        <div>
                          <div className="text-xl">Mark Tressler</div>
                          <div className="text-color-secondary">CEO</div>
                        </div>
                        <a href={s.destino4 || '#'} className="social_icon w-inline-block"><img src={s.imagem8} loading="lazy" alt="LinkedIn Icon" className="icon-1x1-medium" /></a>
                      </div>
                    </div>
                    <div className="team_card scroll-animation">
                      <div className="team_card-img"><img src={s.imagem9} loading="lazy" alt="A formally dressed woman smiling confidently, conveying professionalism and trust in recruitment services." sizes="(max-width: 656px) 100vw, 656px" className="img" /></div>
                      <div className="team_card-content">
                        <div>
                          <div className="text-xl">Mark Tressler</div>
                          <div className="text-color-secondary">CEO</div>
                        </div>
                        <a href={s.destino5 || '#'} className="social_icon w-inline-block"><img src={s.imagem10} loading="lazy" alt="LinkedIn Icon" className="icon-1x1-medium" /></a>
                      </div>
                    </div>
                    <div className="team_card scroll-animation">
                      <div className="team_card-img"><img src={s.imagem11} loading="lazy" alt="A professionally dressed man smiling confidently, reflecting reliability and success in recruitment and HR solutions." sizes="(max-width: 656px) 100vw, 656px" className="img" /></div>
                      <div className="team_card-content">
                        <div>
                          <div className="text-xl">Mark Tressler</div>
                          <div className="text-color-secondary">CEO</div>
                        </div>
                        <a href={s.destino6 || '#'} className="social_icon w-inline-block"><img src={s.imagem12} loading="lazy" alt="LinkedIn Icon" className="icon-1x1-medium" /></a>
                      </div>
                    </div>
                  </div>
                </div>
