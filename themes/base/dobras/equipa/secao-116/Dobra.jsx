"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-116
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* hirekit-about-hero: sin logica local; reveals desde /hirekit/scripts/animations.js. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="equipa-secao-116" ref={raiz}>
      <div className="page-wrapper">  <div data-navbar="" data-collapse="medium" className="navbar w-nav" role="banner"> <div className="navbar_spacer"></div>  <div className="nav_backdrop" data-nav-backdrop="" aria-hidden="true"></div> <div className="container-large is-navbar"> <div className="navbar_content"> <a href="/" aria-label="Hirekit, home" className="navbar_logo-link w-nav-brand"> <img loading="eager" src={s.imagem} alt="Hirekit" className="navbar_logo" /> </a> <div className="nav_wrap"> <nav role="navigation" className="nav_mobile w-nav-menu" aria-label="Primary"> <div className="navbar_list"> <a href="/" aria-current="page" className="nav_links w-nav-link w--current">{s.acao}</a><a href="/about" className="nav_links w-nav-link">{s.acao2}</a><a href="/services" className="nav_links w-nav-link">{s.acao3}</a><a href="/blog" className="nav_links w-nav-link">{s.acao4}</a> </div>  <div className="nav_mobile-footer"> <p className="nav_mobile-eyebrow">{s.texto}</p> <div className="nav_mobile-cta"> <a href="/contact" className="button_component w-inline-block"> <div className="button_content"> <div className="button_text is-one">Contact</div> <div className="button_text is-two">Contact</div> </div> </a> </div> </div> </nav> </div> <div className="nav_buttons-wrap"> <div className="login-wrap hide-mobile-landscape"> <a href="/contact" className="button_component w-inline-block"> <div className="button_content"> <div className="button_text is-one">Contact</div> <div className="button_text is-two">Contact</div> </div> </a> </div> <button type="button" className="menu-button w-nav-button" aria-label="Open menu" aria-expanded="false" aria-controls="nav-menu" data-nav-toggle="" onClick={s.onClick}> <div className="nav-button_component"> <div className="nav-button_line is-first"></div> <div className="nav-button_line is-second"></div> <div className="nav-button_line is-third"></div> </div> </button> </div> </div> </div> </div>
        <section className="section_hero"> <div className="about_wrapper"> <div className="container-large"> <div className="home_layout-two"> <div className="services_hero-heading"> <div> <h1 className="grow-0-1s">{s.titulo}</h1> <div className="spacer-medium"></div> <div className="text-color-subtle grow-2s">
      Our mission is to connect businesses with exceptional talent for lasting success.
      </div> </div> <div className="button_group grow-2s"> <a href="/contact" className="button_secondary w-inline-block"> <div className="button_text">Start Free Trial</div> <div className="button_icon"> <img src={s.imagem2} loading="lazy" alt="" className="arrow-icon is-one" /> <img src={s.imagem3} loading="lazy" alt="" className="arrow-icon is-two" /> </div> </a> <a href="/contact" className="button_component w-variant-80e6b38b-d28d-2ab1-9288-d37ecdfe2267 w-inline-block"> <div className="button_content"> <div className="button_text is-one">Request a Demo</div> <div className="button_text is-two">Request a Demo</div> </div> </a> </div> </div> <div className="spacer"> <div style={{height: '3rem'}} className="spacer-desktop"></div> <div style={{height: '3rem'}} className="spacer-tablet"></div> <div style={{height: '2rem'}} className="spacer-mobile"></div> </div> </div> </div> <div className="about_visuals"> <div className="about_image is-three"> <img src={s.imagem4} loading="eager" sizes="(max-width: 767px) 100vw, 950px" srcSet="https://d173woph5zl366.cloudfront.net/hirekit/images/aboutImg03-p-500.avif 500w, https://d173woph5zl366.cloudfront.net/hirekit/images/aboutImg03.avif 720w" alt="Young man and woman standing side by side, smiling against a plain purple background." className="img" /> </div> <div className="about_image is-one"> <img src={s.imagem5} loading="eager" sizes="(max-width: 767px) 100vw, 950px" srcSet="https://d173woph5zl366.cloudfront.net/hirekit/images/aboutImg01-p-500.avif 500w, https://d173woph5zl366.cloudfront.net/hirekit/images/aboutImg01.avif 720w" alt="Two women and one man standing side by side against a purple background, all smiling and dressed in stylish neutral-toned outfits." className="img" /> </div> <div className="about_image is-two"> <img src={s.imagem6} loading="eager" sizes="(max-width: 767px) 100vw, 720px" srcSet="https://d173woph5zl366.cloudfront.net/hirekit/images/aboutImg02-p-500.avif 500w, https://d173woph5zl366.cloudfront.net/hirekit/images/aboutImg02.avif 720w" alt="Smiling young woman with shoulder-length brown hair wearing a beige plaid blazer and cream turtleneck against a purple background." className="img" /> </div> </div> </div> </section>
