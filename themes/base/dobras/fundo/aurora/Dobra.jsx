"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/backgrounds/aurora
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  //   	
  //   	// Prevent 0 dimension assignments
  //   	const w = Math.max(1, innerWidth);
  //   	const h = Math.max(1, innerHeight);
  //   
  //   	// Only draw/copy if the source canvas dimensions are currently valid
  //   	if (canvas.a.width > 0 && canvas.a.height > 0 && canvas.b.width > 0 && canvas.b.height > 0) {
  //   		try {
  ...
  //   
  //   function render() {
  //     // Prevent calling drawImage with source canvas of width or height 0
  //     if (canvas.a.width > 0 && canvas.a.height > 0 && canvas.b.width > 0 && canvas.b.height > 0) {
  //   		try {
  //   			ctx.b.save();
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="fundo-aurora" ref={raiz}>
      <div className="content--canvas"></div>
        <h2 className="label">{s.titulo}</h2>
    </section>
  );
}