"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-40
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="sobre-duas-colunas" ref={raiz}>
      <div className="page-wrapper">
          <section className="section_goals">
            <div className="padding-global padding-section-large">
              <div className="container-large">
                <div className="content-wrap is-centered">
                  <div className="goals_title" data-reveal="up">
                    <h2 className="text-5xl">We are passionate about empowering individuals and <span className="text-color-secondary">{s.rotulo}</span></h2>
                  </div>
                  <div className="button-wrapper" data-reveal="up" data-reveal-delay="200">
                    <a data-wf--primary-button--variant="with-icon" href="/features" className="button is-primary w-inline-block">
                      <div className="button-text-wrap">
                        <div className="button-text is-firts">See More</div>
                        <div className="button-text is-second">See More</div>
                        <div className="button-shadow-up"></div>
                        <div className="button-shadow-down"></div>
                      </div><img loading="lazy" src={s.imagem} alt="" className="button-icon w-variant-0430e78c-6198-4121-8bff-0731d31f0de9" />
                    </a>
                  </div>
                </div>
              </div>
