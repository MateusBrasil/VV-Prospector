"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-35
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // Aurae — Banner Cta
  //   // No section-specific JS. The dark CTA band's only animation is the heading
  //   // reveal, driven by the shared /aurae/scripts/reveal.js:
  //   //   [animation="section-heading"] is SplitText-split into chars that rise from
  //   //   y 50% + fade in (stagger amount .3) when the section scrolls into view, once.
  //   // The button's fill/hover is pure CSS (.button-component in /aurae/styles.css).
  //   // With prefers-reduced-motion the heading renders in its static, fully-visible state.
  //   
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-35" ref={raiz}>
      <div className="page-wrapper">
          <section className="section_banner">
            <div className="banner_wrapper is-one">
              <div className="container-large">
                <div className="max-heading is-38rem">
                  <h2 animation="section-heading" className="h3 text-color-on-primary">Gentle on skin. Powerful <em className="italic-heading">results.</em></h2>
                </div>
              </div>
              <div className="cta-card">
                <div className="cta-card_heading">
                  <div className="text-5xl">Care for your skin, <span className="italic-heading">{s.rotulo}</span></div>
                </div>
                <div>
                  <div className="max-description is-22rem">
                    <div className="text-color-tertiary">Experience clean, science-led skincare designed to support healthy skin—day after day.</div>
                  </div>
                  <div className="spacer-huge"></div>
                  <div className="button-wrap">
                    <a href="/shop" className="button-component w-variant-6bb8cd6e-fbb0-deb4-bb1a-41fa9cbbb659 w-inline-block">
                      <div className="button_text">Shop Now</div>
                      <div className="button_background w-variant-6bb8cd6e-fbb0-deb4-bb1a-41fa9cbbb659"></div>
                    </a>
                  </div>
                </div>
              </div>
