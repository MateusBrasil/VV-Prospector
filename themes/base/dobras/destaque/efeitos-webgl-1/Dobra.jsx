"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/webgl-threejs/efeitos-webgl-1
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-efeitos-webgl-1" ref={raiz}>
      <main>
      
          <div id="canvas-container"></div>
          <div id="control-ui-container">
            <button className="E33-button" id="gommage-button" onClick={s.onClick}>{s.acao}</button>
          </div>
        </main>
    </section>
  );
