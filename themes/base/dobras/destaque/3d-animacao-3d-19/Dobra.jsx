"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/efeitos-3d/animacao-3d-19
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-3d-animacao-3d-19" ref={raiz}>
      <div className="model"></div>
          ...
          <section className="scanner">
            <div className="scan-info">
              <div className="product-id"><h2>{s.titulo3}</h2></div>
            ...
            <div className="purchased"><p>{s.texto8}</p></div>
          </section>
