"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes-de-rolagem/animacoes-rolagem-2
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
    ...
    const content = raiz.current.querySelector('.slider-content')
    ...
    function animateSlider() {
      ...
      const activeSlide = raiz.current.querySelector('.slide-active')
      const activeImage = activeSlide.querySelector('img')
      const nextSlide = raiz.current.querySelector('.slide-next')
      const nextImageWrap = nextSlide.querySelector('.slide-next-img')
    
      const activeTitleWrap = raiz.current.querySelector('.slider-content-active')
      const nextTitleWrap = raiz.current.querySelector('.slider-content-next')
  ...
  return (
    <section className="dobra" data-dobra="destaque-animacoes-rolagem-2" ref={raiz}>
      <nav className="topbar">
        ...
        <section className="slider-content"></section>
    </section>
  );
}