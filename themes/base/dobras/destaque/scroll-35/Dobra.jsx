"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/scroll/scroll-35
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-scroll-35" ref={raiz}>
      <div className="index">
            <section className="hero">
               ...
               <h1 className="animated-text">
                  ...
                  <span className="text-segment">{s.rotulo}</span>
                  <div className="placeholder-icon"></div>
                  <span className="text-segment">{s.rotulo2}</span>
                  <span className="text-segment">{s.rotulo3}</span>
                  <div className="placeholder-icon"></div>
                  <span className="text-segment">{s.rotulo4}</span>
                  <div className="placeholder-icon"></div>
                  <span className="text-segment">{s.rotulo5}</span>
                  <div className="placeholder-icon"></div>
                  <span className="text-segment">{s.rotulo6}</span>
               </h1>
            </section>
