"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes-svg/animacoes-svg-1/svg-shape-overlays/dist
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-svg-1" ref={raiz}>
