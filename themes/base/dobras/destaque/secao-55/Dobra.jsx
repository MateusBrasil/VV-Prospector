"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-55
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-55" ref={raiz}>
      <section className="section_talk"> <div className="container-large"> <div className="talk_card-wrapper"> <div className="talk_card"> <div className="talk_heading"> <h2 animation="section-heading" className="text-style-allcaps">{s.titulo}</h2> <div className="max-description is-31rem"> <div className="scroll-into-view">Our goal each day is to provide the level of outstanding service we once wished we’d found.</div> </div> </div> <div className="scroll-into-view"> <a href="/contact" className="button_component w-inline-block"> <div className="button_mask"><div className="button_text">Contact us</div></div> <div className="button_icon"> <img loading="lazy" src={s.imagem} alt="" className="button_arrow is-one" /> <img loading="lazy" src={s.imagem2} alt="" className="button_arrow is-two" /> </div> </a> </div> </div> </div> </div> </section>
    </section>
  );
}