"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes/hover-13
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-anim-hover-13" ref={raiz}>
      <section className="hero">
            <canvas id="grid"></canvas>
      
            <div className="logo">
              <img id="source" src={s.imagem} />
            </div>
          </section>
    </section>
  );
