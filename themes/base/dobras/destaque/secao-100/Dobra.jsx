"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-100
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-100" ref={raiz}>
              ...
              <div className="padding-global padding-section-small">
                <div className="content-wrapper-medium">
                  <div className="blog_header">
                    ...
                    <h1 className="blog_title">{s.titulo}</h1>
                    <div className="text-color-secondary">A practical guide to safeguarding patents, trademarks, and copyrights, helping innovators secure their creations and maintain competitive advantage.</div>
                  </div>
                  <div data-wf--horizontal-line--variant="base" className="horizontal-line scroll-into-view"></div>
                  <div className="blog_image">
                    <div className="img-wrapper">
                      <img src={s.imagem2} loading="eager" alt="Protecting Intellectual Property: Strategies for Innovators" className="img is-top-center" />
                    </div>
                  </div>
                </div>
              </div>
