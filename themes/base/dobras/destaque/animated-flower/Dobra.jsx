"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/ui-effects/animated-flower
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-animated-flower" ref={raiz}>
      <svg className="sunflowerSVG" viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
              <g className="wholeFlower">
                  <line className="stalk" x1="400" y1="600" x2="400" y2="186" fill="none" stroke="var(--base-300)" strokeMiterlimit="10" strokeWidth="10"/>
                  <g className="leafGroup2">
                      <path className="leaf leafR" d="M421,442.6l-11-.38,9.53-27.08c6.87-19.52,22.85-30.46,43.44-29.75l11,.38-9.53,27.09C457.56,432.37,441.58,443.31,421,442.6Z" fill="var(--base-300)"/>
                      <path className="leaf leafL" d="M379,401.37l11-.38-9.53-27.09c-6.87-19.52-22.85-30.46-43.44-29.75l-11,.38,9.53,27.09C342.4,391.14,358.38,402.08,379,401.37Z" fill="var(--base-300)"/>
                  </g>
                  <g className="leafGroup1">
                      <path className="leaf leafR" d="M421,568.34,410,568l9.53-27.09c6.87-19.51,22.85-30.45,43.44-29.74l11,.37-9.53,27.09C457.56,558.11,441.58,569.05,421,568.34Z" fill="var(--base-300)"/>
                      <path className="leaf leafL" d="M379,535.79l11-.37-9.53-27.09c-6.87-19.52-22.85-30.46-43.44-29.75L326,479l9.53,27.09C342.4,525.56,358.38,536.5,379,535.79Z" fill="var(--base-300)"/>
                  </g>
                  <g className="flowerHead">
                      <g className="petalGroupBack" fill="var(--acento)">
                      ...
                      <g className="petalGroup" fill="var(--base-300)">
                      ...
                      <circle className="face" cx="400" cy="186" r="86.5" fill="var(--base-600)"/>
                      <g className="seedGroup" fill="var(--base-500)" stroke="none" strokeMiterlimit="10">
