"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-60
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-60" ref={raiz}>
      <section className="section_about"> <div className="padding-section-small"></div> <div className="container-large"> <div className="w-layout-grid default-grid"> <div id="w-node-_33a97c17-8175-8286-99a6-dccdccdad734-fb62f1e5" className="about_title"> <div className="wrap scroll-into-view"> <div className="section_tag">[ About us ]</div> </div> <div className="wrap"> <h2 animation="heading-large" className="text-style-allcaps">{s.titulo}</h2> </div> </div> </div> <div className="spacer"> <div style={{height: '6rem'}} className="spacer-desktop"></div> <div style={{height: '3rem'}} className="spacer-tablet"></div> <div style={{height: '2rem'}} className="spacer-mobile"></div> </div> <div className="w-layout-grid about_stats-grid" data-stagger=""> <div className="about_numbers"> <div className="text-color-secondary">Project value</div> <div className="stat-number"> <div className="h5" data-counter="">$30</div> <div className="text-2xl text-color-orange">M</div> </div> </div><div className="about_numbers"> <div className="text-color-secondary">Project value</div> <div className="stat-number"> <div className="h5" data-counter="">$10</div> <div className="text-2xl text-color-orange">M</div> </div> </div><div className="about_numbers"> <div className="text-color-secondary">Project value</div> <div className="stat-number"> <div className="h5" data-counter="">$1200</div> <div className="text-2xl text-color-orange">M</div> </div> </div><div className="about_numbers"> <div className="text-color-secondary">Project value</div> <div className="stat-number"> <div className="h5" data-counter="">$520</div> <div className="text-2xl text-color-orange">M</div> </div> </div> </div> </div> </section>
    </section>
  );
}