"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/cards/pixel-canvas-hover-effect
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-pixel-canvas-hover-effect" ref={raiz}>
      <main>
        <div className="card">
        ...
        <div className="card" style={{'-ActiveColor': 'var(--base-100)'}}>
          <pixel-canvas data-gap="10" data-speed="25" data-colors="var(--base-100), var(--base-200), var(--base-200)"></pixel-canvas>
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 256 256">
          ...
          <button onClick={s.onClick}>{s.acao2}</button>
        </div>
      
        <div className="card" style={{'-ActiveColor': 'var(--base-100)'}}>
          <pixel-canvas data-gap="3" data-speed="20" data-colors="var(--base-100), var(--base-100), var(--acento)"></pixel-canvas>
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 256 256">
          ...
          <button onClick={s.onClick}>{s.acao3}</button>
        </div>
      
        <div className="card" style={{'-ActiveColor': 'var(--base-100)'}}>
          <pixel-canvas data-gap="6" data-speed="80" data-colors="var(--base-100), var(--base-200), var(--base-300)" data-no-focus></pixel-canvas>
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 256 256">
          ...
          <button onClick={s.onClick}>{s.acao4}</button>
        </div>
      </main>
    </section>
  );
