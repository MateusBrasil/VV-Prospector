"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-152
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-152" ref={raiz}>
                ...
                <div className="w-layout-grid grid-3gap">
                  <div className="statistic_img" data-reveal-image="">
                    <div className="img-wrapper">
                      <img src={s.imagem3} sizes="(max-width: 846px) 100vw, 846px" srcSet="/coverly/images/image_1image.webp 500w, /coverly/images/image_1.webp 846w" alt="Person reviewing insurance quote details on a tablet" className="img" />
                    </div>
                  </div>
                  <div id="w-node-_0603e9d3-19db-0086-6bdb-bfcc61913bea-c482550d" className="content">
                    <div>
                    ...
                    <div>
                      <div className="text-color-secondary scroll-slide-left">
                        Experience a seamless process to get the coverage you need. Our platform is designed to be simple, fast, and secure.
                      </div>
                      ...
                      <div className="button-wrapper scroll-slide-left">
                        <a href="/contact" className="button w-inline-block">
                          <div className="button-content">
                            <div className="button-text is-one">Get in touch</div>
