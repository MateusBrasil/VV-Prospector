"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/webgl-threejs/efeitos-webgl-18
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-efeitos-webgl-18" ref={raiz}>
      <header>
          <h1>Immersive WebGL <br /> Image Transitions</h1>
        </header>
      
        <div id="gl-container">
          <div id="gl-scroller"></div>
        </div>
