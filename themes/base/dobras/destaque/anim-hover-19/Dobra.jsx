"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes/hover-19
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-anim-hover-19" ref={raiz}>
      <section className="spotlight">
            <div className="cards">
              <div className="card"><img src={s.imagem} alt="" /></div>
              <div className="card"><img src={s.imagem2} alt="" /></div>
              <div className="card"><img src={s.imagem3} alt="" /></div>
              <div className="card"><img src={s.imagem4} alt="" /></div>
            </div>
          </section>
    </section>
  );
