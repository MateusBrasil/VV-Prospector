"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes-de-rolagem/animacao-rolagem-6
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  //   		img: './img/slider_img_01.jpg',
  //   		url: '/sample-project.html',
  //   	},
  //   	{
  //   		title: 'Floral Circuit',
  //   		img: './img/slider_img_02.jpg',
  //   		url: '/sample-project.html',
  //   	},
  //   	{
  //   		title: 'Synthetic Horizon',
  //   		img: './img/slider_img_03.jpg',
  //   		url: '/sample-project.html',
  //   	},
  //   	{
  //   		title: 'Portal Sequence',
  //   		img: './img/slider_img_04.jpg',
  //   		url: '/sample-project.html',
  //   	},
  //   	{
  //   		title: 'Projected Memory',
  //   		img: './img/slider_img_05.jpg',
  //   		url: '/sample-project.html',
  //   	},
  //   	{
  //   		title: 'Fractured Self',
  //   		img: './img/slider_img_06.jpg',
  //   		url: '/sample-project.html',
  //   	},
  //   	{
  //   		title: 'Moonlit Constructs',
  //   		img: './img/slider_img_07.jpg',
  //   		url: '/sample-project.html',
  //   	},
  //   	{
  //   		title: 'Fading Room',
  //   		img: './img/slider_img_08.jpg',
  //   		url: '/sample-project.html',
  //   	},
  //   ]
  //   
  ...
  return (
    <section className="dobra" data-dobra="destaque-animacao-rolagem-6" ref={raiz}>
      <nav>
            <div className="logo">
               <a href="#">{s.acao}</a>
            </div>
