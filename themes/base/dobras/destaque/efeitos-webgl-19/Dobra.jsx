"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/webgl-threejs/efeitos-webgl-19
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-efeitos-webgl-19" ref={raiz}>
      <div className="container">
          <div className="canvas1"></div>
          <div className="canvas2"></div>
          <div className="text-overlay">
            <h1 className="dynamic-text">{s.titulo}</h1>
          </div>
        </div>
    </section>
  );
