"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-136
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-136" ref={raiz}>
      <div className="navbar w-nav" role="banner" data-navbar="">
        ...
        <div className="page-wrapper">
          <main className="main-wrapper">
            <section className="section_blogs-hero">
                ...
                <div className="content-wrapper-medium">
                  <div className="header">
                    <div data-wf--label--variant="base" className="label">
                      <div className="text-style-allcaps">Blog and articles</div>
                    </div>
                    <h1>{s.titulo}</h1>
                    <div className="text-color-secondary">Explore our blog for expert advice, industry trends, and innovative strategies that empower your team and elevate your business</div>
                  </div>
                  <div data-wf--horizontal-line--variant="base" className="horizontal-line scroll-into-view"></div>
                  <div className="w-dyn-list">
                    <div role="list" className="w-dyn-items">
                      <div role="listitem" className="w-dyn-item">
                        <div className="w-layout-grid blogs-hero_card">
                          <div className="blogs-hero_card-content">
                            <div className="header-small scroll-into-view">
                              <div data-wf--label--variant="base" className="label">
                                <div className="text-style-allcaps scroll-into-view">Featured</div>
                              </div>
                              <div className="text-font-lora">June 18, 2025</div>
                            </div>
                            <div className="block-wrapper is-stretch scroll-into-view">
                              <div className="blogs-hero_card-botton">
                                <h2 className="text-2xl">{s.titulo2}</h2>
                                <div className="text-color-secondary">A practical guide to understanding and resolving business disputes, helping entrepreneurs protect their interests and grow their ventures.</div>
                              </div>
                              <a href="/blog/navigating-the-complexities-of-business-disputes-a-guide-for-entrepreneurs" className="button is-secondary w-inline-block">
                                <div className="button-content">
                                  <div className="button-text is-one">Learn more</div>
                                  <div className="button-text is-two">Learn more</div>
                                </div>
                              </a>
                            </div>
                          </div>
                          <div className="blogs-hero_image">
                            <div className="img-wrapper"><img src={s.imagem2} loading="lazy" alt="Navigating the Complexities of Business Disputes: A Guide for Entrepreneurs" className="img" /></div>
                          </div>
                        </div>
                      </div>
                    </div>
