"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/efeitos-3d/animacao-3d-10
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-3d-animacao-3d-10" ref={raiz}>
      <main>
            ...
            <div className="container">
              <div className="shirts-container">
                <img
                  ...
                  data-model-size="L" />
                <img src={s.imagem2} alt="Model wearing Product" className="rat-center" id="centerImage" />
                <span id="info-tooltip" data-tooltip='Model is 5ft 4" and wears size S'>?</span>
                <img
                  src={s.imagem3}
                  alt="Product 3"
