"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/scroll/scroll-37-hero
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-scroll-37-hero" ref={raiz}>
      <section className="gallery">
            <div className="img"><img className="ascii-reveal" src={s.imagem} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem2} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem3} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem4} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem5} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem6} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem7} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem8} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem9} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem10} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem11} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem12} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem13} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem14} /></div>
            <div className="img"><img className="ascii-reveal" src={s.imagem15} /></div>
          </section>
    </section>
  );
}