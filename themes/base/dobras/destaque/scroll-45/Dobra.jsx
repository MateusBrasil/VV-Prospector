"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/scroll/scroll-45
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-scroll-45" ref={raiz}>
      <section className="intro">
            <p>{s.texto}</p>
          </section>
          <section className="spotlight">
            <div className="spotlight-img"><img src={s.imagem} alt="" /></div>
            <div className="spotlight-img"><img src={s.imagem2} alt="" /></div>
            <div className="spotlight-img"><img src={s.imagem3} alt="" /></div>
            <div className="spotlight-img"><img src={s.imagem4} alt="" /></div>
            <div className="spotlight-img"><img src={s.imagem5} alt="" /></div>
