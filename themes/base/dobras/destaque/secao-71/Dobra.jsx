"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-71
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* Luzen — About Intro
  //      Sin lógica local. Las animaciones corren desde /luzen/scripts/animations.js:
  //      - reveals [data-reveal] vía GSAP + ScrollTrigger (+ SplitText para headings)
  //      - aparición de imágenes .img-appear / .img-bg con su .img-wrap is-secondary
  //      - parallax de las dos imágenes .img-parallax ligado al scroll */
  //   
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-71" ref={raiz}>
      <div className="page-wrapper">
          <main className="main-wrapper">
            <section className="section_about bg-secondary">
              <div className="padding-global is-about">
                <div className="container-large">
                  <div className="about_heading">
                    <div className="heading_number" data-reveal="">
                      <div className="text-6xl">01</div>
                      <div>About us</div>
                    </div>
                    <div className="max-description is-19rem">
                      <div className="text-color-secondary" data-reveal="">
                        Let’s create a space that’s not just beautiful—but
                        beautifully yours.
                      </div>
                    </div>
                  </div>
                  <div className="spacer">
                    <div style={{paddingTop: '5%'}} className="spacer-desktop"></div>
                    <div style={{paddingTop: '5%'}} className="spacer-tablet"></div>
                    <div style={{height: '2rem'}} className="spacer-mobile"></div>
                  </div>
                  <div className="about_content">
                    <div className="max-heading is-26rem">
                      <h2 className="h3" data-reveal="">{s.titulo}</h2>
                    </div>
                    <div className="spacer">
                      <div style={{paddingTop: '10%'}} className="spacer-desktop"></div>
                      <div style={{paddingTop: '10%'}} className="spacer-tablet"></div>
                      <div style={{height: '2rem'}} className="spacer-mobile"></div>
                    </div>
                    <div className="about_content-layout">
                      <div className="about_data is-left">
                        <div data-reveal="">
                          At Luzen, we believe that great design goes beyond
                          aesthetics—it should tell your story, support your
                          lifestyle, and inspire daily living
                        </div>
                        <div className="spacer-10vw">
                          <div className="img-appear">
                            <div className="img-bg is-one">
                              <img src={s.imagem} loading="lazy" sizes="(max-width: 848px) 100vw, 848px, 100vw" srcSet="https://d173woph5zl366.cloudfront.net/luzen/images/about-img-01_1about-img-01.avif 500w, https://d173woph5zl366.cloudfront.net/luzen/images/about-img-01_1.avif 848w" alt="A wooden desk and chair illuminated by natural sunlight from the side, showcasing warm textures and thoughtful architectural lighting design." className="img-parallax" />
                              <div className="img-wrap is-secondary"></div>
                            </div>
                          </div>
                          <div className="spacer-medium"></div>
                          <div className="text-color-dark" data-reveal="">Luzen’s 001</div>
                        </div>
                      </div>
                      <div className="about_data is-right">
                        <div data-reveal="">
                          With years of experience in residential and commercial interiors,
                          our team blends creativity with function to craft spaces that feel
                          as good as they look. From initial concepts to the final styling
                          touches, we’re with you every step of the way.
                        </div>
                        <div className="spacer-64vw">
                          <div className="img-bg is-two img-appear">
                            <img src={s.imagem2} loading="lazy" alt="A modern kitchen designed in beige and cream tones with abundant natural light, emphasizing a warm, sophisticated atmosphere and high-quality architectural finishes." className="img-parallax" />
                            <div className="img-wrap is-secondary"></div>
                          </div>
                          <div className="spacer-medium"></div>
                          <div className="text-color-dark" data-reveal="">Luzen’s 002</div>
                        </div>
                      </div>
                    </div>
                  </div>
