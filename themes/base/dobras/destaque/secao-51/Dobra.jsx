"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-51
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // aurae-philosophy-section — no section-specific boot needed.
  //   // The heading/description SplitText reveals (animation="section-heading" /
  //   // "section-description") and the .scroll-into-view item fade-ups are all handled by
  //   // the shared /aurae/scripts/reveal.js. GSAP + ScrollTrigger + SplitText globals load
  //   // in the head. reveal.js sets the hidden start-state, so content stays visible if JS fails.
  //   
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-51" ref={raiz}>
      <div className="page-wrapper">
          <section className="section_philosophy">
            <div className="container-large">
              <div className="philosophy_wrapper">
                <div className="philosophy_card">
                  <div>
                    <h2 animation="section-heading" className="h6">Our <em className="italic-heading">philosophy</em></h2>
                    <div className="spacer-medium"></div>
                    <div animation="section-description" className="text-color-secondary">Skincare is not about perfection. It’s about consistency, care, and respect for your skin’s natural process.</div>
                  </div>
                  <div className="philosophy_list">
                    <div className="philosophy_item scroll-into-view">
                      <div className="philosophy_icon"><img src={s.imagem} loading="lazy" alt="" className="icon-1x1-medium" /></div>
                      <div>Less can be more when ingredients are chosen thoughtfully</div>
                    </div>
                    <div className="philosophy_item scroll-into-view">
                      <div className="philosophy_icon"><img src={s.imagem2} loading="lazy" alt="" className="icon-1x1-medium" /></div>
                      <div>Long-term skin health matters more than instant fixes</div>
                    </div>
                    <div className="philosophy_item scroll-into-view">
                      <div className="philosophy_icon"><img src={s.imagem3} loading="lazy" alt="" className="icon-1x1-medium" /></div>
                      <div>Daily routines should feel effortless, not overwhelming</div>
                    </div>
                  </div>
                </div>
              </div>
