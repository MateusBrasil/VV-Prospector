"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes/hover-17
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-anim-hover-17" ref={raiz}>
      <div className="inversion-lens">
