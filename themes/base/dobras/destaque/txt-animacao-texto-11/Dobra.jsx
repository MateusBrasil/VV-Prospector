"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/textos/animacao-texto-11
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-txt-animacao-texto-11" ref={raiz}>
      <div className="index">
