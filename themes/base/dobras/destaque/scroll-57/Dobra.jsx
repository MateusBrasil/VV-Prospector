"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/scroll/scroll-57
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-scroll-57" ref={raiz}>
      <main>
          <header className="frame">
            ...
            <nav className="frame__demos">
              <span>{s.rotulo}</span>
              <a href="index2.html">{s.acao7}</a>
              <a href="index3.html">{s.acao8}</a>
              <a href="index4.html">{s.acao9}</a>
              <a href="index5.html">{s.acao10}</a>
            </nav>
          </header>
          <div className="gallery">
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem2})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem3})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem4})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem5})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem6})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem7})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem8})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem9})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem10})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem11})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem12})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem13})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem14})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem15})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem16})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem17})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem18})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem19})`}}></div>
            <div className="gallery__item" style={{backgroundImage: `url(${s.imagem20})`}}></div>
          </div>
          <div className="mark font-1">
            <div className="mark__inner">
              <span>{s.rotulo2}</span> <span>/</span>
              <span>{s.rotulo3}</span> <span>/</span>
              <span>{s.rotulo4}</span> <span>/</span>
              <span>{s.rotulo5}</span> <span>/</span>
              <span>{s.rotulo6}</span> <span>/</span>
              <span>{s.rotulo7}</span> <span>/</span>
              <span>{s.rotulo8}</span> <span>/</span>
              <span>{s.rotulo9}</span> <span>/</span>
              <span>{s.rotulo10}</span> <span>/</span>
