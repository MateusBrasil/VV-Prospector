"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/physics/efeitos-de-fisica-6
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-efeitos-de-fisica-6" ref={raiz}>
