"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/physics/efeitos-de-fisica-7
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-efeitos-de-fisica-7" ref={raiz}>
      <h1 className="title">
            <span>{s.rotulo}</span>
            <em>metal.</em>
         </h1>
         ...
         <span className="hint" id="js-hint">{s.rotulo2}</span>
