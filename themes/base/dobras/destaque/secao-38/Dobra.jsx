"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-38
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* catalis-cta: sin logica local; reveals desde /catalis/scripts/. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-38" ref={raiz}>
      <section className="section_join"> <div className="padding-box"> <div className="join_wrap"> <div className="container-medium"> <div className="badge-wrapper"> <div animation="" className="badge w-variant-bbfb6a6c-d3ec-5a08-a531-cec36f932128"><img src={s.imagem} loading="lazy" alt="" className="badge_image" /> <div className="badge_text">Join Us</div> </div> </div> <div className="spacer-xlarge"></div> <div className="max-description is-45rem align-center"> <h2 animation="large-heading" className="text-color-on-primary text-align-center">Achieve operational excellence with <em>Catalis</em></h2> </div> <div className="spacer-xlarge"></div> <div className="max-description is-38rem align-center"> <div className="text-color-on-primary text-align-center scroll-into-view">Founded by data experts, we create cutting-edge SaaS analytics platforms tailored for businesses of all sizes.</div> </div> <div className="spacer-xlarge"></div> <div className="button-wrapper is-center scroll-into-view"> <a animation="" href="/contact" className="button_component w-inline-block"> <div className="button_content"> <div className="button_text is-one">Get Started</div> <div className="button_text is-two">Get Started</div> </div> </a> </div> </div> <div className="join_img is-left"><img src={s.imagem2} loading="lazy" alt="" className="img" /></div> <div className="join_img is-right"><img src={s.imagem3} loading="lazy" alt="" className="img" /></div> </div> </div> </section>
    </section>
  );
}