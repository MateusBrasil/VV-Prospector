"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/scroll/scroll-43
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-scroll-43" ref={raiz}>
      <div className="container">
            <section className="hero">
              <h1><span>{s.rotulo}</span> Powered by Imagination</h1>
            </section>
      
            <section className="sticky">
              <div className="bg-img"><img src={s.imagem} alt="" /></div>
      
              <canvas className="outline-layer"></canvas>
      
              <div className="cards">
                <div className="card">
                  <div className="card-img"><img src={s.imagem2} alt="" /></div>
                ...
                <div className="card">
                  <div className="card-img"><img src={s.imagem3} alt="" /></div>
                  <div className="card-title">
                    <h1>{s.titulo2}</h1>
                    <p>{s.texto2}</p>
                  </div>
                ...
                <div className="card">
                  <div className="card-img"><img src={s.imagem4} alt="" /></div>
                  <div className="card-title">
                    <h1>{s.titulo3}</h1>
                    <p>{s.texto3}</p>
                  </div>
            ...
            <section className="outro">
              <h1>Chase the <span>{s.rotulo2}</span> to embrace the light</h1>
            </section>
          </div>
    </section>
  );
