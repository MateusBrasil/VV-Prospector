"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-198
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-198" ref={raiz}>
      <section className="testi_section"> <section className="testimonial-bg"><img loading="lazy" src={s.imagem} alt="" className="stories-visual" /></section> <section className="section_testimonial"> <div className="padding-section-medium"></div> <div className="container-large"> <div className="testimonial_layout"> <div id="w-node-c4ae72e1-fbc9-0238-8626-43969055e12c-9055e125" className="testimonial_card-wrapper is-one"> <div className="testimonial_card"> <div className="testimonial_info"> <img loading="lazy" src={s.imagem2} alt="" className="icon-1x1-xlarge" /> <div className="text-2xl">“We have had two great experiences working with Doorly, as they sold two of our homes. They were professional, attentive, and patient.”</div> </div> <div className="testimonial_user"> <div className="testimonial_img"><img loading="lazy" src={s.imagem3} alt="Dona Mackenzie" className="img" /></div> <div className="testimonial_user-info"> <div>Dona Mackenzie</div> <div className="spacer-xsmall"></div> <div>CEO</div> </div> </div> </div> </div><div id="w-node-c4ae72e1-fbc9-0238-8626-43969055e12e-9055e125" className="testimonial_card-wrapper is-two"> <div className="testimonial_card"> <div className="testimonial_info"> <img loading="lazy" src={s.imagem4} alt="" className="icon-1x1-xlarge" /> <div className="text-2xl">“We have had two great experiences working with Doorly, as they sold two of our homes. They were professional, attentive, and patient.”</div> </div> <div className="testimonial_user"> <div className="testimonial_img"><img loading="lazy" src={s.imagem5} alt="Laura Salas" className="img" /></div> <div className="testimonial_user-info"> <div>Laura Salas</div> <div className="spacer-xsmall"></div> <div>Designer</div> </div> </div> </div> </div><div id="w-node-c4ae72e1-fbc9-0238-8626-43969055e130-9055e125" className="testimonial_card-wrapper is-three"> <div className="testimonial_card"> <div className="testimonial_info"> <img loading="lazy" src={s.imagem6} alt="" className="icon-1x1-xlarge" /> <div className="text-2xl">“We have had two great experiences working with Doorly, as they sold two of our homes. They were professional, attentive, and patient.”</div> </div> <div className="testimonial_user"> <div className="testimonial_img"><img loading="lazy" src={s.imagem7} alt="James Vile" className="img" /></div> <div className="testimonial_user-info"> <div>James Vile</div> <div className="spacer-xsmall"></div> <div>CEO</div> </div> </div> </div> </div><div id="w-node-c4ae72e1-fbc9-0238-8626-43969055e132-9055e125" className="testimonial_card-wrapper is-four"> <div className="testimonial_card"> <div className="testimonial_info"> <img loading="lazy" src={s.imagem8} alt="" className="icon-1x1-xlarge" /> <div className="text-2xl">“We have had two great experiences working with Doorly, as they sold two of our homes. They were professional, attentive, and patient.”</div> </div> <div className="testimonial_user"> <div className="testimonial_img"><img loading="lazy" src={s.imagem9} alt="Peter Jhonas" className="img" /></div> <div className="testimonial_user-info"> <div>Peter Jhonas</div> <div className="spacer-xsmall"></div> <div>Architect</div> </div> </div> </div> </div> </div> <div className="testimonial_spacer"></div> </div> <div className="padding-section-medium"></div> </section> </section>
    </section>
  );
}