"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-178
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // aurae-members-section — no section-specific JS.
  //   // Reveals (section-heading SplitText, section-description SplitText, .scroll-into-view
  //   // block fade) are handled by the shared /aurae/scripts/reveal.js, which self-initializes
  //   // on DOM ready using the GSAP + ScrollTrigger + SplitText globals from the page head.
  //   
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-178" ref={raiz}>
      <div className="page-wrapper">
          <section className="section_members">
            <div className="padding-section-medium"></div>
            <div className="padding-global">
              <div className="container-large">
                <div>
                  <h2 animation="section-heading" className="h4">The <em className="italic-heading">faces</em> behind it</h2>
                  <div className="spacer-medium"></div>
                  <div animation="section-description" className="text-color-secondary">We built AURAE with people who care deeply about what they make.</div>
                </div>
                ...
                <div className="members_grid scroll-into-view">
                  <div className="member_card">
                    <div className="member_card-bg"><img src={s.imagem} loading="lazy" alt="Smiling woman with short brown hair, light freckles, wearing small gold hoop earrings and a white blazer." className="img" /></div>
                    <h3 className="text-color-on-primary">{s.subtitulo}</h3>
                    <div className="member_card-gradient"></div>
                  </div>
                  <div className="member_card">
                    <div className="member_card-bg"><img src={s.imagem2} loading="lazy" sizes="(max-width: 784px) 100vw, 784px, 100vw" srcSet="https://d173woph5zl366.cloudfront.net/aurae/images/member_02-p-500.avif 500w, https://d173woph5zl366.cloudfront.net/aurae/images/member_02.avif 784w" alt="Young woman with long brown hair wearing thin-framed glasses, gold hoop earrings, and a black blazer, smiling softly." className="img" /></div>
                    <div className="member_content">
                      <h3 className="text-color-on-primary">{s.subtitulo2}</h3>
                    </div>
                    <div className="member_card-gradient"></div>
                  </div>
                  <div className="member_card">
                    <div className="member_card-bg"><img src={s.imagem3} loading="lazy" alt="Smiling young woman with shoulder-length brown hair, wearing gold hoop earrings and a gray blazer." className="img" /></div>
                    <h3 className="text-color-on-primary">{s.subtitulo3}</h3>
                    <div className="member_card-gradient"></div>
                  </div>
                </div>
              </div>
