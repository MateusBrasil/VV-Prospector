"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes-de-rolagem/animacao-rolagem-16
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-animacao-rolagem-16" ref={raiz}>
      <div  className="index">
            <div className="slider">
               <p className="slide-title">{s.texto}</p>
            </div>
