"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-187
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-187" ref={raiz}>
      <section className="section_testimonials"> <div className="padding-section-large"></div> <div className="container-full"> <div className="testimonial_layout"> <div className="testimonial_heading"> <div animation="" className="badge w-variant-bbfb6a6c-d3ec-5a08-a531-cec36f932128"><img src={s.imagem} loading="lazy" alt="" className="badge_image" /> <div className="badge_text">TESTIMONIALS</div> </div> <h2 animation="large-heading">What our <em>clients</em> are saying</h2> <div className="scroll-into-view">Our users love how Mondai CRM simplifies their processes and streamlines operations</div> </div> <div className="testimonial_right"> <div className="loop_wrap"> <div className="testimonial_loop"> <div className="testimonial_card"><img src={s.imagem2} loading="lazy" alt="Portrait of a young man with light brown hair and beard, looking forward through green leaves." className="testimonial_img" /><img src={s.imagem3} loading="lazy" alt="" className="icon-1x1-xlarge" /> <div className="text-color-secondary">Catalis has completely transformed the way I manage my finances. With its intuitive interface and powerful features, I now have better control and visibility into my expenses and investments. Highly recommend it!</div> <div> <div className="text-weight-medium">Jaxson Baptista</div> <div className="text-color-secondary">Manager at Lunoxinc</div> </div> <div className="testimonial_sign">Jaxson Baptista</div> </div> <div className="testimonial_card"><img src={s.imagem4} loading="lazy" alt="Smiling man with dark hair, beard, and mustache wearing a gray sweater and dark jacket." className="testimonial_img" /><img src={s.imagem5} loading="lazy" alt="" className="icon-1x1-xlarge" /> <div className="text-color-secondary">Catalis has completely transformed the way I manage my finances. With its intuitive interface and powerful features, I now have better control and visibility into my expenses and investments. Highly recommend it!</div> <div> <div className="text-weight-medium">Davis Vetrovs</div> <div className="text-color-secondary">Manager at Lunoxinc</div> </div> <div className="testimonial_sign">Davis Vetrovs</div> </div> <div className="testimonial_card"><img src={s.imagem6} loading="lazy" alt="Smiling man with beard and long hair wearing a plaid shirt in a warmly lit room." className="testimonial_img" /><img src={s.imagem7} loading="lazy" alt="" className="icon-1x1-xlarge" /> <div className="text-color-secondary">Catalis has completely transformed the way I manage my finances. With its intuitive interface and powerful features, I now have better control and visibility into my expenses and investments. Highly recommend it!</div> <div> <div className="text-weight-medium">Jaydon Siphron</div> <div className="text-color-secondary">Manager at Lunoxinc</div> </div> <div className="testimonial_sign">Jaydon Siphron</div> </div> <div className="testimonial_card"><img src={s.imagem8} loading="lazy" alt="Portrait of a confident young woman with dark hair pulled back, wearing a gray blazer and a heart-shaped necklace." className="testimonial_img" /><img src={s.imagem9} loading="lazy" alt="" className="icon-1x1-xlarge" /> <div className="text-color-secondary">Catalis has completely transformed the way I manage my finances. With its intuitive interface and powerful features, I now have better control and visibility into my expenses and investments. Highly recommend it!</div> <div> <div className="text-weight-medium">Talan Press</div> <div className="text-color-secondary">Manager at Lunoxinc</div> </div> <div className="testimonial_sign">Talan Press</div> </div> <div className="testimonial_card"><img src={s.imagem10} loading="lazy" alt="Young man with curly hair wearing a white hoodie, looking slightly upward with a serious expression, sitting on wooden steps." className="testimonial_img" /><img src={s.imagem11} loading="lazy" alt="" className="icon-1x1-xlarge" /> <div className="text-color-secondary">Catalis has completely transformed the way I manage my finances. With its intuitive interface and powerful features, I now have better control and visibility into my expenses and investments. Highly recommend it!</div> <div> <div className="text-weight-medium">Gretchen Rosser</div> <div className="text-color-secondary">Manager at Lunoxinc</div> </div> <div className="testimonial_sign">Gretchen Rosser</div> </div> </div> <div className="testimonial_loop"> <div className="testimonial_card"><img src={s.imagem12} loading="lazy" alt="Portrait of a young man with light brown hair and beard, looking forward through green leaves." className="testimonial_img" /><img src={s.imagem13} loading="lazy" alt="" className="icon-1x1-xlarge" /> <div className="text-color-secondary">Catalis has completely transformed the way I manage my finances. With its intuitive interface and powerful features, I now have better control and visibility into my expenses and investments. Highly recommend it!</div> <div> <div className="text-weight-medium">Jaxson Baptista</div> <div className="text-color-secondary">Manager at Lunoxinc</div> </div> <div className="testimonial_sign">Jaxson Baptista</div> </div> <div className="testimonial_card"><img src={s.imagem14} loading="lazy" alt="Smiling man with dark hair, beard, and mustache wearing a gray sweater and dark jacket." className="testimonial_img" /><img src={s.imagem15} loading="lazy" alt="" className="icon-1x1-xlarge" /> <div className="text-color-secondary">Catalis has completely transformed the way I manage my finances. With its intuitive interface and powerful features, I now have better control and visibility into my expenses and investments. Highly recommend it!</div> <div> <div className="text-weight-medium">Davis Vetrovs</div> <div className="text-color-secondary">Manager at Lunoxinc</div> </div> <div className="testimonial_sign">Davis Vetrovs</div> </div> <div className="testimonial_card"><img src={s.imagem16} loading="lazy" alt="Smiling man with beard and long hair wearing a plaid shirt in a warmly lit room." className="testimonial_img" /><img src={s.imagem17} loading="lazy" alt="" className="icon-1x1-xlarge" /> <div className="text-color-secondary">Catalis has completely transformed the way I manage my finances. With its intuitive interface and powerful features, I now have better control and visibility into my expenses and investments. Highly recommend it!</div> <div> <div className="text-weight-medium">Jaydon Siphron</div> <div className="text-color-secondary">Manager at Lunoxinc</div> </div> <div className="testimonial_sign">Jaydon Siphron</div> </div> <div className="testimonial_card"><img src={s.imagem18} loading="lazy" alt="Portrait of a confident young woman with dark hair pulled back, wearing a gray blazer and a heart-shaped necklace." className="testimonial_img" /><img src={s.imagem19} loading="lazy" alt="" className="icon-1x1-xlarge" /> <div className="text-color-secondary">Catalis has completely transformed the way I manage my finances. With its intuitive interface and powerful features, I now have better control and visibility into my expenses and investments. Highly recommend it!</div> <div> <div className="text-weight-medium">Talan Press</div> <div className="text-color-secondary">Manager at Lunoxinc</div> </div> <div className="testimonial_sign">Talan Press</div> </div> <div className="testimonial_card"><img src={s.imagem20} loading="lazy" alt="Young man with curly hair wearing a white hoodie, looking slightly upward with a serious expression, sitting on wooden steps." className="testimonial_img" /><img src={s.imagem21} loading="lazy" alt="" className="icon-1x1-xlarge" /> <div className="text-color-secondary">Catalis has completely transformed the way I manage my finances. With its intuitive interface and powerful features, I now have better control and visibility into my expenses and investments. Highly recommend it!</div> <div> <div className="text-weight-medium">Gretchen Rosser</div> <div className="text-color-secondary">Manager at Lunoxinc</div> </div> <div className="testimonial_sign">Gretchen Rosser</div> </div> </div> <div className="left-gradient"></div> <div className="right-gradient"></div> </div> </div> </div> </div> <div className="padding-section-large"></div> </section>
    </section>
  );
}