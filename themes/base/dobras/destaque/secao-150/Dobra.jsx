"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-150
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-150" ref={raiz}>
            ...
            <div className="padding-global padding-section-small">
              <div className="container-large">
                <div className="w-layout-grid grid-3gap">
                  <div id="w-node-_8a70803a-7206-1c21-43af-48bb01a624dc-ee00b5f3" className="content">
                    <div>
                    ...
                    <div>
                      <div className="text-color-secondary scroll-slide-left">We make it easy to protect what matters most. From health and life insurance to vehicle and property coverage, we offer smart, flexible plans designed to fit your needs and budget.</div>
                  ...
                  <div className="statistic_img" data-reveal-image="">
                    <div className="img-wrapper" style={{transform: 'translate3d(0, -100%, 0) scale3d(1, 1, 1)'}}>
                      <img src={s.imagem3} loading="lazy" sizes="(max-width: 1128px) 100vw, 1128px" srcSet="/coverly/images/serice1-p-500.webp 500w, /coverly/images/serice1-p-800.webp 800w, /coverly/images/serice1-p-1080.webp 1080w, /coverly/images/serice1.webp 1128w" alt="Coverly insurance advisor reviewing coverage options with a client" className="img" style={{transform: 'translate3d(0, 100%, 0) scale3d(1.5, 1.5, 1)', filter: 'blur(10px)'}} />
                    </div>
                  </div>
                </div>
              </div>
