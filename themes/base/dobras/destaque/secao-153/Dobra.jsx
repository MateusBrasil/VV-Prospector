"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-153
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-153" ref={raiz}>
          ...
          <section className="section_hero">
            <div className="padding-global padding-section-small">
              <div className="container-large">
                <div>
                  <div className="tag scroll-slide-left">Design</div>
                  <div className="spacer-medium"></div>
                  <h1 className="scroll-slide-left">{s.titulo}</h1>
                </div>
                <div className="spacer-xhuge"></div>
                <div className="line_grey-100"></div>
                <div className="spacer-xhuge"></div>
                <div className="blog_img-inner">
                  <div className="img-wrapper">
                    <img src={s.imagem3} loading="eager" alt="The quiet craft of building covers that earn the first click" className="img" />
                  </div>
                </div>
              </div>
            </div>
