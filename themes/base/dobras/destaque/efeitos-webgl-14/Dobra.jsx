"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/webgl-threejs/efeitos-webgl-14
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-efeitos-webgl-14" ref={raiz}>
      <div id="textContainer" className="text-effect" data-font="Blanquotey" data-font-weight="100" data-bg="var(--base-100)"
            data-color="var(--base-600)" data-grid="40" data-strength="0.4" data-ease-move="0.035" data-ease-idle="0.01">
            ZAYNO
          </div>
    </section>
  );
