"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes/hover-15
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-anim-hover-15" ref={raiz}>
      <section className="services">
            ...
            >
              ...
              <div className="service-images">
                ...
                <div className="img"><img src={s.imagem5} /></div>
                <div className="img"><img src={s.imagem6} /></div>
              </div>
            </div>
            ...
            >
              ...
              <div className="service-images">
                <div className="img"><img src={s.imagem7} /></div>
                <div className="img"><img src={s.imagem8} /></div>
                <div className="img"><img src={s.imagem9} /></div>
              </div>
            </div>
          </section>
    </section>
