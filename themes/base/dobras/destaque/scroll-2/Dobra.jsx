"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/scroll/scroll-2
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-scroll-2" ref={raiz}>
      <main>
      			<header className="frame">
      				<h1 className="frame__title">On-Scroll <br />Text Clip-Path <br />Animations</h1> 
      			
      			</header>
      			<div className="content">
      				<svg> 
      					<clipPath id="clip">
      						<text x="0ch" y="0.95em" className="line-1 font-7 size-3">X</text>
      						<text x="1ch" y="0.95em" className="line-1 font-7 size-3">o</text>
      						<text x="2ch" y="0.95em" className="line-1 font-7 size-3">g</text>
      						<text x="3ch" y="0.95em" className="line-1 font-7 size-3">o</text>
      						<text x="4ch" y="0.95em" className="line-1 font-7 size-3">x</text>
      						<text x="5ch" y="0.95em" className="line-1 font-7 size-3">y</text>
      					</clipPath>
      					<clipPath id="clip-0">
      						<text x="0ch" y="0.95em" className="line-2 font-7 size-3">X</text>
      						<text x="1ch" y="0.95em" className="line-2 font-7 size-3">o</text>
      						<text x="2ch" y="0.95em" className="line-2 font-7 size-3">g</text>
      						<text x="3ch" y="0.95em" className="line-2 font-7 size-3">o</text>
      						<text x="4ch" y="0.95em" className="line-2 font-7 size-3">x</text>
      						<text x="5ch" y="0.95em" className="line-2 font-7 size-3">y</text>
      					</clipPath>
      				</svg>
      				<div className="poster poster--half" style={{clipPath: 'url(#clip)', '-OffsetX': '10%', '-OffsetY': '10%'}}>
      					<div className="poster__inner" style={{backgroundImage: `url(${s.imagem})`}}></div>
      				</div>
      				<div className="poster poster--half" style={{clipPath: 'url(#clip-0)', '-OffsetX': '10%', '-OffsetY': '10%'}}>
      					<div className="poster__inner" style={{backgroundImage: `url(${s.imagem2})`}}></div>
      				</div>
      			</div>
      			...
      			<div className="content">
      				...
      				<div className="poster poster--half" style={{clipPath: 'url(#clip-1)', '-OffsetX': '10%', '-OffsetY': '10%'}}>
      					<div className="poster__inner" style={{backgroundImage: `url(${s.imagem3})`}}></div>
      				</div>
      				<div className="poster poster--half" style={{clipPath: 'url(#clip-1-1)', '-OffsetX': '10%', '-OffsetY': '10%'}}>
      					<div className="poster__inner" style={{backgroundImage: `url(${s.imagem4})`}}></div>
      				</div>
      			</div>
      			<div className="content content--text">
      				<h4>{s.subtitulo2}</h4>
      				<p>Within the caverns of introspection, the patient dragon discovers the treasures of self-awareness, teaching that the journey inward, undertaken with deliberate slowness, unveils the hidden={true} jewels of enlightenment, shimmering in the recesses of the soul.</p>
      			</div>
      			<div className="content">
      				<svg> 
      					<clipPath id="clip-2">
      						<text x="0ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-2 size-3">M</text>
      						<text x="1ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-2 size-3">o</text>
      						<text x="2ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-2 size-3">m</text>
      						<text x="3ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-2 size-3">o</text>
      						<text x="4ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-2 size-3">s</text>
      						<text x="5ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-2 size-3">o</text>
      					</clipPath>
      				</svg>
      				<div className="poster" style={{clipPath: 'url(#clip-2)'}}>
      					<div className="poster__inner" style={{backgroundImage: `url(${s.imagem5})`}}></div>
      				</div>
      			</div>
      			</div>
      			<div className="content content--text">
      			...
      			<div className="content">
      				<svg> 
      					<clipPath id="clip-3">
      						<text x="0ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-3 size-2">n</text>
      						<text x="1ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-3 size-2">o</text>
      						<text x="2ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-3 size-2">n</text>
      						<text x="3ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-3 size-2">o</text>
      						<text x="4ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-3 size-2">n</text>
      					</clipPath>
      				</svg>
      				<div className="poster" style={{clipPath: 'url(#clip-3)', '-OffsetX': '20%'}}>
      					<div className="poster__inner" style={{backgroundImage: `url(${s.imagem6})`}}></div>
      				</div>
      			</div>
      			<div className="content content--text">
      				<h4>{s.subtitulo4}</h4>
      			...
      			<div className="content">
      				<svg> 
      					<clipPath id="clip-4">
      						<text x="0" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-4 size-2">s</text>
      						<text x="1ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-4 size-2">o</text>
      						<text x="2ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-4 size-2">x</text>
      						<text x="3ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-4 size-2">o</text>
      						<text x="4ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-4 size-2">s</text>
      					</clipPath>
      				</svg>
      				<div className="poster" style={{clipPath: 'url(#clip-4)'}}>
      					<div className="poster__inner" style={{backgroundImage: `url(${s.imagem7})`}}></div>
      				</div>
      			</div>
      			<div className="content content--text">
      				<h4>{s.subtitulo5}</h4>
      			...
      			<div className="content">
      				<svg> 
      					<clipPath id="clip-5">
      						<text x="0ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-5 size-2">b</text>
      						<text x="1ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-5 size-2">y</text>
      						<text x="2ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-5 size-2">o</text>
      						<text x="3ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-5 size-2">s</text>
      						<text x="4ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-5 size-2">o</text>
      						<text x="5ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-5 size-2">x</text>
      					</clipPath>
      				</svg>
      				<div className="poster" style={{clipPath: 'url(#clip-5)'}}>
      					<div className="poster__inner poster__inner--fixed" style={{backgroundImage: `url(${s.imagem8})`}}></div>
      				</div>
      			</div>
      			...
      			<div className="content">
      				<svg> 
      					<clipPath id="clip-6">
      						<text x="0ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-6 size-3">k</text>
      						<text x="1ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-6 size-3">e</text>
      						<text x="2ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-6 size-3">l</text>
      						<text x="3ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-6 size-3">p</text>
      						<text x="4ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-6 size-3">f</text>
      						<text x="5ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-6 size-3">o</text>
      						<text x="6ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-6 size-3">r</text>
      						<text x="7ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-6 size-3">e</text>
      						<text x="8ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-6 size-3">s</text>
      						<text x="9ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-6 size-3">t</text>
      						<text x="10ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-6 size-3">s</text>
      					</clipPath>
      				</svg>
      				<div className="poster" style={{clipPath: 'url(#clip-6)'}}>
      					<div className="poster__inner" style={{backgroundImage: `url(${s.imagem9})`}}></div>
      				</div>
      			</div>
      			<div className="content content--text">
      				<h4>{s.subtitulo7}</h4>
      			...
      			<div className="content content--flex">
      				<svg className="h-200 w-25"> 
      					<clipPath id="clip-7">
      						<text x="50%" y="1em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">l</text>
      						<text x="50%" y="2em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">i</text>
      						<text x="50%" y="3em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">u</text>
      						<text x="50%" y="4em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">l</text>
      						<text x="50%" y="5em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">o</text>
      						<text x="50%" y="6em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">n</text>
      						<text x="50%" y="7em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">g</text>
      					</clipPath>
      				</svg>
      				<div className="poster h-200 w-25" style={{clipPath: 'url(#clip-7)'}}>
      					<div className="poster__inner" style={{backgroundImage: `url(${s.imagem10})`}}></div>
      				</div>
      				<svg className="h-200 w-25"> 
      					<clipPath id="clip-8">
      						<text x="50%" y="1em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">g</text>
      						<text x="50%" y="2em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">n</text>
      						<text x="50%" y="3em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">o</text>
      						<text x="50%" y="4em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">l</text>
      						<text x="50%" y="5em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">u</text>
      						<text x="50%" y="6em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">i</text>
      						<text x="50%" y="7em" dominantBaseline="middle" textAnchor="middle" className="font-8 size-4">l</text>
      					</clipPath>
      				</svg>
      				<div className="poster h-200 w-25" style={{clipPath: 'url(#clip-8)'}}>
      					<div className="poster__inner" style={{backgroundImage: `url(${s.imagem11})`}}></div>
      				</div>
      			</div>
      			<div className="content content--text">
      				<h4>{s.subtitulo8}</h4>
      			...
      			<div className="content">
      				<svg> 
      					<clipPath id="clip-9">
      						<text x="0ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-9 size-3">m</text>
      						<text x="1ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-9 size-3">o</text>
      						<text x="2ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-9 size-3">m</text>
      						<text x="3ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-9 size-3">o</text>
      						<text x="4ch" y="50%" dominantBaseline="middle" textAnchor="middle" className="font-9 size-3">m</text>
      					</clipPath>
      				</svg>
      				<div className="poster" style={{clipPath: 'url(#clip-9)'}}>
      					<div className="poster__inner">
      						<video preload muted={true} autoplay={true} loop={true}>
      							<source src={s.video} type="video/webm" />
      							<source src={s.video2} type="video/mp4" />
      						</video>
      					</div>
      				</div>
      			</div>
      			...
      			<div className="content content--more">
      				<h2 className="content__title">{s.titulo}</h2>
      				<div className="card-wrap">
      					<div className="card">
      						<a href={s.destino || '#'} className="card__image" style={{backgroundImage: `url(${s.imagem12})`}}></a>
      						<p className="card__title"><a href={s.destino2 || '#'}>{s.acao}</a></p>
      					</div>
      					<div className="card">
      						<a href={s.destino3 || '#'} className="card__image" style={{backgroundImage: `url(${s.imagem13})`}}></a>
      						<p className="card__title"><a href={s.destino4 || '#'}>{s.acao2}</a></p>
      					</div>
      					<div className="card">
      						<a href={s.destino5 || '#'} className="card__image" style={{backgroundImage: `url(${s.imagem14})`}}></a>
      						<p className="card__title"><a href={s.destino6 || '#'}>{s.acao3}</a></p>
      					</div>
      				</div>
      			</div>
