"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/scroll/scroll-13/pixel-scan-effect-with-vfx-js/dist
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-scroll-13" ref={raiz}>
      <section>
        <img src={s.imagem} 
             data-delay="0.3" />
