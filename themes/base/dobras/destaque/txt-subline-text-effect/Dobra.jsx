"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/textos/subline-text-effect
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  //       
  //       // Registra o plugin para evitar avisos
  ...
  //         ];
  //         
  //         // Adiciona atributos aos elementos <svg>
  ...
  //               }
  //             }
  //             // Avança para o próximo desenho entre todos os itens
  ...
  //   
  //             const playOut = () => {
  //               // Não reinicia se já estiver ocultando
  ...
  //                 onComplete: () => {
  //                   leaveTween = null;
  //                   box.innerHTML = ''; // Remove o SVG quando terminar
  //                 }
  //               });
  //             };
  //   
  //             if (enterTween && enterTween.isActive()) {
  //               // Espera terminar de desenhar antes de apagar
  ...
  //       }
  //   
  //       // Inicializa o Efeito após o carregamento do DOM
  ...
  return (
    <section className="dobra" data-dobra="destaque-txt-subline-text-effect" ref={raiz}>
      <section className="cloneable">
          <a data-draw-line="" href="#" className="text-draw w-inline-block">
            <p className="text-draw__p">{s.texto}</p>
          ...
          <a data-draw-line="" href="#" className="text-draw w-inline-block">
            <p className="text-draw__p">{s.texto2}</p>
            <div data-draw-line-box="" className="text-draw__box"></div>
          </a>
          <a data-draw-line="" href="#" className="text-draw w-inline-block">
            <p className="text-draw__p">{s.texto3}</p>
            <div data-draw-line-box="" className="text-draw__box"></div>
          </a>
        </section>
    </section>
