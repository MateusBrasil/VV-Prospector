"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/efeitos-3d/animacao-3d-1/threejs-font-grid/dist
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-3d-1" ref={raiz}>
      <header className="header">
        <h1 className="header__title title">Make <span className="title__pink">{s.rotulo}</span> <span className="title__green">{s.rotulo2}</span></h1>
        <p className="header__sub-title">But significant.<p/>
        
        <p className="header__exerpt">I have no idea of what it mean, but these characters looks cool.<p/>
      </header>
    </section>
  );
}