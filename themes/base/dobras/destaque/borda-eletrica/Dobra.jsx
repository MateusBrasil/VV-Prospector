"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/cards/electric-border-card
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  //           this.color = options.color || "#fc016e";
  //   
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-borda-eletrica" ref={raiz}>
      <main className="main-container">
          <div className="card-container">
            <div className="inner-container">
              <div className="canvas-container">
                <canvas id="electric-border-canvas" className="electric-border-canvas" width="475" height="625"></canvas>
              </div>
            ...
            <div className="content-container">
              <div className="content-top">
                ...
                <p className="title">{s.texto}</p>
              </div>
      
              <hr className="divider" />
      
              <div className="content-bottom">
                <p className="description">{s.texto2}</p>
              </div>
            </div>
          </div>
        </main>
