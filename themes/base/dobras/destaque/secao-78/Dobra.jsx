"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-78
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-78" ref={raiz}>
      <section className="section_contact"> <div className="contact_container"> <div className="contact_layout" data-soft-reveal=""> <div id="w-node-_5a7eeded-38c9-c807-227d-4fe5c45a6f61-c45a6f5e" className="contact_top"> <h2 className="text-color-on-primary text-style-allcaps">{s.titulo}</h2> </div> <a id="w-node-_5a7eeded-38c9-c807-227d-4fe5c45a6f64-c45a6f5e" href="/contact" className="contact_bottom w-inline-block"> <div className="text-xl">We craft inspiring spaces that blend cutting-edge design</div> <div>CONTACT</div> <div className="contact_icon bg-default"> <img loading="lazy" alt="" src={s.imagem} className="card-arrow is-one" /> <img loading="lazy" alt="" src={s.imagem2} className="card-arrow is-two" /> </div> </a> </div> </div> </section>
    </section>
  );
}