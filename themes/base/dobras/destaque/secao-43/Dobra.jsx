"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-43
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* hirely-cta — no section-specific JS.
  //    *
  //    * All animation is owned by the shared engine script
  //    * `/hirely/scripts/scroll-reveal.js`:
  //    *   - `.scroll-animation` grow-in reveal (heading block + button wrapper).
  //    *   - `initCtaImages()` grows each `.cta_img` inside `.cta_header` from
  //    *     width 0 → natural width (.7s inOutCubic), with a reduced-motion fail-safe.
  //    *
  //    * This file is an intentional empty stub (no top-level `export`) so the section
  //    * loads cleanly as a classic <script src>. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-43" ref={raiz}>
      <div className="page-wrapper">
          <main className="main-wrapper">
            <section className="section_cta bg-dark">
              <div className="padding-section-medium"></div>
              <div className="padding-global">
                <div className="container-large vertical-center">
                  <div className="cta_header scroll-animation">
                    <div className="cta_header-row">
                      <div className="h1">Looking</div>
                      <div className="h1">for</div>
                    </div>
                    <div className="cta_header-row">
                      <div className="h1">your</div>
                      <img src={s.imagem} loading="lazy" alt="" className="cta_img" />
                      <div className="h1">next</div>
                      <img src={s.imagem2} loading="lazy" alt="" className="cta_img" />
                      <div className="h1">big</div>
                    </div>
                    <div className="h1">opportunity?</div>
                  </div>
