"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/textos/animacao-texto-5
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-txt-animacao-texto-5" ref={raiz}>
      <main>
              <div className="frame">
