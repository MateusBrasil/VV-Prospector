"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-69
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* catalis-about-two: sin logica local; reveals desde /catalis/scripts/. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="destaque-secao-69" ref={raiz}>
      <section className="section_about-two"> <div className="padding-global"> <div className="container-large"> <div className="about_layout"> <div className="about_left"> <div> <div className="badge-wrapper is-left"> <div animation="" className="badge w-variant-bbfb6a6c-d3ec-5a08-a531-cec36f932128"><img src={s.imagem} loading="lazy" alt="" className="badge_image" /> <div className="badge_text">ABOUT US</div> </div> </div> <div className="spacer-medium"></div> <h2 animation="large-heading">Expert <em>strategies</em> for your future</h2> <div className="spacer-medium"></div> <div className="text-color-secondary scroll-into-view">We are passionate about empowering individuals and businesses to take control of their finances and achieve their financial goals.</div> <div className="spacer"> <div style={{height: '2.5rem'}} className="spacer-desktop"></div> <div style={{height: '2.5rem'}} className="spacer-tablet"></div> <div style={{height: '2rem'}} className="spacer-mobile"></div> </div> <div className="button-wrapper is-left scroll-into-view"> <a animation="" href="/about" className="button_component w-inline-block"> <div className="button_content"> <div className="button_text is-one">Get Started</div> <div className="button_text is-two">Get Started</div> </div> </a> </div> </div> <div className="about_stats grow-container"> <div className="stat grow-element"> <div className="text-6xl font-header">80%</div> <div className="text-sm">Reduction in reporting time.</div> </div> <div className="stat grow-element"> <div className="text-6xl font-header">99</div> <div className="text-sm">Increase in billing hours</div> </div> </div> </div> <div className="about_img-three"><img src={s.imagem2} loading="lazy" sizes="(max-width: 479px) 100vw, 239.98046875px" srcSet="https://d173woph5zl366.cloudfront.net/catalis/images/about-three-p-500.avif 500w, https://d173woph5zl366.cloudfront.net/catalis/images/about-three.avif 1232w" alt="Smiling young woman and man wearing beige fleece jackets, outdoors under a clear blue sky; the woman holds a smartphone." className="img" /> <div className="about_income"><img src={s.imagem3} loading="lazy" alt="" className="img" /></div> </div> </div> </div> </div> </section>
    </section>
  );
}