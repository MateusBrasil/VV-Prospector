"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes-de-rolagem/animacao-rolagem-5
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="destaque-animacao-rolagem-5" ref={raiz}>
      <main className="image-slider" role="region" aria-label="Image carousel" data-image-slider-init>
          ...
          <section className="featured-image" data-featured-image>
            <div className="featured-image-wrapper" data-featured-wrapper>
              <img src={s.imagem} alt="Project 01" />
            </div>
          </section>
