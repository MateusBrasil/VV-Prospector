"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/menu/svg-shape-overlays-demo-1
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  //   			
  //   			// A navegação entre demos foi prevenida para evitar erros 404
  //   			// já que esta demonstração compila tudo em um único arquivo.
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="menu-svg-shape-overlays-demo-1" ref={raiz}>
      <svg className="hidden">
      	...
      	<main className="main main--demo-1">
      		<div className="content content--fixed">
      			...
      			<nav className="demos">
      				<svg className="icon icon--keyboard"><use xlinkHref="#icon-keyboard"></use></svg>
      				<a className="demo demo--current" href="#"><span>{s.rotulo}</span></a>
      			</nav>
      		</div>
      		<div className="content content--demo-1">
      			...
      			<div className="demo-title demo-title--demo-1">Alloy</div>
      			<div className="global-menu">
      				<div className="global-menu__wrap">
      					<a className="global-menu__item global-menu__item--demo-1" href="#">{s.acao}</a>
      					<a className="global-menu__item global-menu__item--demo-1" href="#">{s.acao2}</a>
      					<a className="global-menu__item global-menu__item--demo-1" href="#">{s.acao3}</a>
      					<a className="global-menu__item global-menu__item--demo-1" href="#">{s.acao4}</a>
      				</div>
      			</div>
