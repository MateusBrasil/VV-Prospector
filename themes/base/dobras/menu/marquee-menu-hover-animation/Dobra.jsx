"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/carrossel/marquee-menu-hover-animation
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  //               }
  //   
  //               // Remove loading class if necessary
  ...
  return (
    <section className="dobra" data-dobra="menu-marquee-menu-hover-animation" ref={raiz}>
      <main>
