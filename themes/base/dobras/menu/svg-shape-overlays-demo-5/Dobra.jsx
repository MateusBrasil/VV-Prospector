"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/menu/svg-shape-overlays-demo-5
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // useEffect(() => {
  //   
  //           /* ==================== js/easings.js (Curvas de animação) ==================== */
  //           const ease = {
  //               cubicInOut: (t) => {
  //                   return t < 0.5
  //                   ? 4.0 * t * t * t
  ...
  //                       // Lógica para criar o movimento em formato de "Onda" característico da Demo 5
  ...
  //                       // Calculado de baixo (100) para cima (0) 
  //                       points[i] = 100 - ease.cubicInOut(Math.min(Math.max(time - this.delayPointsArray[i], 0) / this.duration, 1)) * 100;
  //                   }
  //   
  //                   let str = '';
  //                   // Quando aberto, liga os pontos a partir de baixo; Quando fechado, recua do topo para baixo.
  //                   str += (this.isOpened) ? `M 0 100 V ${points[0]} ` : `M 0 0 V ${points[0]} `;
  //                   
  //                   for (var i = 0; i < this.numPoints - 1; i++) {
  ...
  //               
  //               // A navegação foi prevenida para evitar erros 404
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="menu-svg-shape-overlays-demo-5" ref={raiz}>
      <svg className="hidden">
          ...
          <main className="main main--demo-5">
              <div className="content content--fixed">
                  <header className="codrops-header">
                      <div className="codrops-links">
                          <a className="codrops-icon codrops-icon--prev" href="#" title="Demo Anterior"><svg className="icon icon--arrow"><use xlinkHref="#icon-arrow"></use></svg></a>
              ...
              <div className="content content--demo-5">
                  ...
                  <div className="demo-title demo-title--demo-5">Efeito Onda</div>
                  <div className="global-menu">
                      <div className="global-menu__wrap">
                          <a className="global-menu__item global-menu__item--demo-5" href="#">{s.acao}</a>
                          <a className="global-menu__item global-menu__item--demo-5" href="#">{s.acao2}</a>
                          <a className="global-menu__item global-menu__item--demo-5" href="#">{s.acao3}</a>
                          <a className="global-menu__item global-menu__item--demo-5" href="#">{s.acao4}</a>
                      </div>
                  </div>
