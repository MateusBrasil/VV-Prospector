"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/menu/menu-22
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="menu-menu-22-b" ref={raiz}>
      <main>
            <header className="frame">
              <h1 className="frame__title">
                Clip <a href={s.destino || '#'}>{s.acao}</a> with
              ...
              <p className="frame__credits">
                Read more about <a href={s.destino6 || '#'}>{s.acao6}</a>. Check out the
                <a href={s.destino7 || '#'}>{s.acao7}</a>.
              </p>
            </header>
            <div className="toggle">
              <button aria-label="Open menu" aria-expanded="false" aria-controls="menu" onClick={s.onClick}>
              ...
              <label>
                <input type="checkbox" id="easeReverse" checked={true} />
                <span>{s.rotulo2}</span>
              </label>
              <label>
                <span>interrupt speed: <span id="exitSpeedValue">{s.rotulo3}</span></span>
                <input type="range" id="exitSpeed" min="1" max="4" step="0.25" value="1" />
              </label>
            </div>
            <div className="cover">
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem2})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem3})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem4})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem5})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem6})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem7})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem8})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem9})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem10})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem11})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem12})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem13})`}}></div>
              </div>
              <div className="cover__item">
                <div className="cover__image" style={{backgroundImage: `url(${s.imagem14})`}}></div>
              </div>
            </div>
            <h1 className="title">
              <span>{s.rotulo4}</span>
            ...
            <nav className="menu" id="menu">
              <video className="bg-video" muted={true} loop={true} playsinline={true}>
                <source src={s.video} type="video/mp4" />
              </video>
              <a className="menu__item">{s.acao8}</a>
              <a className="menu__item">{s.acao9}</a>
              <a className="menu__item">{s.acao10}</a>
              <a className="menu__item">{s.acao11}</a>
              <a className="menu__item">{s.acao12}</a>
              <a className="menu__item">{s.acao13}</a>
              <a className="menu__item">{s.acao14}</a>
            </nav>
          </main>
    </section>
  );
