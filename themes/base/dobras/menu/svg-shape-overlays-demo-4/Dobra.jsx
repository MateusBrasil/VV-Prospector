"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/menu/svg-shape-overlays-demo-4
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="menu-svg-shape-overlays-demo-4" ref={raiz}>
      <svg className="hidden">
          ...
          <main className="main main--demo-4">
              ...
              <div className="content content--demo-4">
                  ...
                  <div className="demo-title demo-title--demo-4">Onyx</div>
                  <div className="global-menu">
                      <div className="global-menu__wrap">
                          <a className="global-menu__item global-menu__item--demo-4" href="#">{s.acao}</a>
                          <a className="global-menu__item global-menu__item--demo-4" href="#">{s.acao2}</a>
                          <a className="global-menu__item global-menu__item--demo-4" href="#">{s.acao3}</a>
                          <a className="global-menu__item global-menu__item--demo-4" href="#">{s.acao4}</a>
                      </div>
                  </div>
