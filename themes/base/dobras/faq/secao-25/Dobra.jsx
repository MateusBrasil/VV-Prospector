"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-25
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="faq-secao-25" ref={raiz}>
      <section className="faqs_section"> <div className="padding-section-large"></div> <div className="padding-global"> <div className="container-large"> <div className="faqs_heading"> <div data-reveal="view"> <div className="badge"> <div className="text-sm">FAQS</div> </div> </div> <h2 className="h2" data-reveal="view">{s.titulo}</h2> <div className="text-color-secondary" data-reveal="view">Clear answers to common questions about how the platform works and what to expect.</div> </div> <div className="spacer"> <div style={{height: '4.75rem'}} className="spacer-desktop"></div> <div style={{height: '3.5rem'}} className="spacer-tablet"></div> <div style={{height: '2rem'}} className="spacer-mobile"></div> </div> <div className="accordion_list" data-accordion=""> <div data-reveal="view"> <div className="accordion accordion_wrap"> <button type="button" className="accordion_top" aria-expanded="false" onClick={s.onClick}> <div className="h6">What services do you offer?</div> <div className="accordion_icon"> <img loading="lazy" src={s.imagem} alt="" className="accordion_arrow" /> </div> </button> <div className="accordion_bottom"> <div className="accordion_inner"> <div className="spacer-xlarge"></div> <div className="text-color-secondary">We provide a single platform to keep your business information accurate, organized, and accessible — from day-to-day operations to long-term planning.</div> </div> </div> </div> </div><div data-reveal="view"> <div className="accordion accordion_wrap"> <button type="button" className="accordion_top" aria-expanded="false" onClick={s.onClick}> <div className="h6">How does the process work?</div> <div className="accordion_icon"> <img loading="lazy" src={s.imagem2} alt="" className="accordion_arrow" /> </div> </button> <div className="accordion_bottom"> <div className="accordion_inner"> <div className="spacer-xlarge"></div> <div className="text-color-secondary">Once connected, everything is handled in one place. Data stays updated automatically, workflows run in the background, and your team always works from the same reliable source.</div> </div> </div> </div> </div><div data-reveal="view"> <div className="accordion accordion_wrap"> <button type="button" className="accordion_top" aria-expanded="false" onClick={s.onClick}> <div className="h6">Is my data secure?</div> <div className="accordion_icon"> <img loading="lazy" src={s.imagem3} alt="" className="accordion_arrow" /> </div> </button> <div className="accordion_bottom"> <div className="accordion_inner"> <div className="spacer-xlarge"></div> <div className="text-color-secondary">Yes. Security and reliability are built in from the start, with best practices designed to protect sensitive information and support long-term trust.</div> </div> </div> </div> </div><div data-reveal="view"> <div className="accordion accordion_wrap"> <button type="button" className="accordion_top" aria-expanded="false" onClick={s.onClick}> <div className="h6">How quickly can I get started?</div> <div className="accordion_icon"> <img loading="lazy" src={s.imagem4} alt="" className="accordion_arrow" /> </div> </button> <div className="accordion_bottom"> <div className="accordion_inner"> <div className="spacer-xlarge"></div> <div className="text-color-secondary">Getting started is straightforward. Most teams are up and running quickly, with immediate visibility and value from day one.</div> </div> </div> </div> </div> </div>  <div className="faq_spacer"> <div className="spacer"> <div style={{height: '4.75rem'}} className="spacer-desktop"></div> <div style={{height: '3.5rem'}} className="spacer-tablet"></div> <div style={{height: '2rem'}} className="spacer-mobile"></div> </div> </div> <div className="faq_cta" data-reveal="view"> <div> <h3>{s.subtitulo}</h3> <div className="spacer-medium"></div> <div className="text-color-subtle">Reach out to us anytime for assistance.</div> </div> <a href="/contact" className="button_secondary w-inline-block"> <div className="button_text">Contact Us</div> <div className="button_icon"> <img src={s.imagem5} loading="lazy" alt="" className="arrow-icon is-one" /> <img src={s.imagem6} loading="lazy" alt="" className="arrow-icon is-two" /> </div> </a> </div>  </div> </div> <div className="padding-section-large"></div> </section>
    </section>
  );
}