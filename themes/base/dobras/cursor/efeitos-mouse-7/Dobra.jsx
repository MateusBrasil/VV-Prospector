"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/cursor/efeitos-mouse-7
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="cursor-efeitos-mouse-7" ref={raiz}>
      <div className="stage">
            ...
            <span className="hint" id="js-hint">{s.rotulo}</span>
      
            
            <h1 className="copy">{s.titulo}</h1>
         </div>
    </section>
  );
}