"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-36
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // Firmo — CTA Contact: sección estática. No requiere JS propio.
  //   // El parallax de .contact_image y los reveals de .scroll-into-view los maneja
  //   // la hoja compartida /firmo/scripts/scroll-reveal.js (global, self-init, sin export).
  //   // Stub intencional para mantener el formato de 4 archivos.
  //   
  ...
  return (
    <section className="dobra" data-dobra="contacto-secao-36" ref={raiz}>
      <div className="page-wrapper">
          <main className="main-wrapper">
            <section className="section_contact">
              <div className="padding-global padding-section-small">
                <div className="w-layout-grid contact_wrapper">
                  <div id="w-node-d319cbf7-3467-3efb-6706-a6afdccd6000-dccd5ffc" className="contact_image">
                    <div className="img-wrapper"><img src={s.imagem} loading="lazy" sizes="100vw" srcSet="https://d173woph5zl366.cloudfront.net/firmo/images/Contact-one---image_1Contact-one---image.webp 500w, https://d173woph5zl366.cloudfront.net/firmo/images/Contact-one---image_1Contact-one---image.webp 800w, https://d173woph5zl366.cloudfront.net/firmo/images/Contact-one---image_1Contact-one---image.webp 1080w, https://d173woph5zl366.cloudfront.net/firmo/images/Contact-one---image_1.webp 1128w" alt="" className="img is-top-center" /></div>
                  </div>
                  <div className="block-wrapper">
                    <div className="header">
                      <div data-wf--label--variant="base" className="label">
                        <div className="text-style-allcaps scroll-into-view">Contact</div>
                      </div>
                      <h2 className="text-5xl scroll-into-view">{s.titulo}</h2>
                      <div className="text-color-secondary scroll-into-view">You can also use the feedback form below to reach out to us directly through our website.</div>
                    </div>
