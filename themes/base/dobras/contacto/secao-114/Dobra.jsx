"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-114
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="contacto-secao-114" ref={raiz}>
      ...
      <section data-scroll-trigger="doorly" className="section_home"> <div className="container-large"> <div className="home_layout"> <div className="opa-0"></div> <div className="h1-huge_wrapper"> <h1 data-scroll-h1="doorly" className="h1-huge">{s.titulo}</h1> </div> <div className="home_layout-content"> <div className="max-description is-31rem"> <div className="text-color-on-primary">
      From family houses and luxury apartments to high-value investment properties—our team
                      guides you through a seamless and transparent buying or selling experience.
      </div> </div> <div> <a href="/contact" className="button_component w-inline-block"> <div className="button_mask"><div className="button_text">Contact Us</div></div> <div className="button_icon"> <img loading="lazy" src={s.imagem4} alt="" className="button_arrow is-one" /> <img loading="lazy" src={s.imagem5} alt="" className="button_arrow is-two" /> </div> </a> </div> </div> </div> </div> <div className="hero_gradient"></div> <div className="home-curtain" data-home-curtain="" aria-hidden="true"></div> <div className="home-background"> <img src={s.imagem6} loading="eager" fetchpriority="high" decoding="async" sizes="(max-width: 2560px) 100vw, 2560px" srcSet="https://d173woph5zl366.cloudfront.net/doorly/images/home-hero-01-p-500.avif 500w, https://d173woph5zl366.cloudfront.net/doorly/images/home-hero-01-p-800.avif 800w, https://d173woph5zl366.cloudfront.net/doorly/images/home-hero-01-p-1080.avif 1080w, https://d173woph5zl366.cloudfront.net/doorly/images/home-hero-01-p-1600.avif 1600w, https://d173woph5zl366.cloudfront.net/doorly/images/home-hero-01.avif 2560w" alt="Modern minimalist house with wide concrete steps leading up through a grassy yard with rocks and a tree." className="img" /> </div> </section>
      
      <section className="doorly-hero-spacer" aria-hidden="true"></section>
    </section>
  );
}