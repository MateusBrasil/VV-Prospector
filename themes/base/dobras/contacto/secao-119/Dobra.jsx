"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-119
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="contacto-secao-119" ref={raiz}>
        ...
        <div className="page-wrapper">
          <main className="main-wrapper">
            <section className="section_home">
              <div className="padding-global is-home-one">
                <div className="container-large is-portrait">
                  <div animation="zoom" className="text-align-center">
                    <div className="max-heading is-49rem align-center">
                      <h1 hero="heading">{s.titulo}</h1>
                    </div>
                    <div className="spacer-large"></div>
                    <div className="max-description is-38rem align-center">
                      <div hero="description">
                        Elevate your interior design projects with a sleek, customizable
                        template built to showcase your creative vision. Perfect for
                        designers who want to captivate clients.
                      </div>
                    </div>
                    <div className="spacer-huge"></div>
                    <div hero="button" className="button-wrapper is-center">
                  ...
                  <div className="spacer">
                    <div style={{paddingTop: '45%'}} className="spacer-desktop"></div>
                    <div style={{paddingTop: '45%'}} className="spacer-tablet"></div>
                    <div style={{paddingTop: '45%'}} className="spacer-mobile"></div>
                  </div>
                  <div hero="stats" className="home_bottom">
                    <div className="text-align-center">
                      <div className="text-5xl">250</div>
                      <div className="spacer-small"></div>
                      <div className="text-color-subtle">Projects Complete</div>
                    </div>
                    <div className="text-align-center">
                      <div className="text-5xl">90</div>
                      <div className="spacer-small"></div>
                      <div className="text-color-subtle">Satisfied Clients</div>
                    </div>
                    <div className="text-align-center hide-mobile-portrait">
                      <div className="text-5xl">150</div>
                      <div className="spacer-small"></div>
                      <div className="text-color-subtle">Expert Team</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="home_one-bg"></div>
            </section>
          </main>
        </div>
    </section>
