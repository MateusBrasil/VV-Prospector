"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-113
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="contacto-secao-113" ref={raiz}>
      ...
      <section className="section_services-hero"> <div className="container-large"> <div className="w-layout-grid services-hero_grid"> <div id="w-node-_23917a17-4fe4-a8b6-2c38-660c043ddc51-877e1aa5" className="services-hero_img"> <img className="img" src={s.imagem4} data-clip-reveal="" alt="Two older men and a young woman in business suits standing inside a modern office with large windows showing a scenic outdoor view." sizes="(max-width: 479px) 48vw, (max-width: 2608px) 49vw, 1278px" loading="eager" fetchpriority="high" decoding="async" srcSet="https://d173woph5zl366.cloudfront.net/doorly/images/services-hero-bg-p-500.avif 500w, https://d173woph5zl366.cloudfront.net/doorly/images/services-hero-bg.avif 1278w" /> </div> <div id="w-node-b350e7d8-1e2b-6f82-c50d-9bdf6822582d-877e1aa5" className="services_left"> <div animation="hero-tag" className="wrap"> <div className="section_tag w-variant-11063f80-6b7d-0c32-82a3-15d5a31bbce2">[ Doorly reality ]</div> </div> <div className="wrap"> <h1 animation="hero-title" className="h4 text-style-allcaps">{s.titulo}</h1> </div> <div className="wrap"> <div className="max-description is-29rem"> <div animation="hero-title">At Doorly, we offer a wide range of real estate services tailored to meet the unique needs of each client.</div> </div> </div> <div animation="hero-button" className="wrap"> <a href="/contact" className="button_component w-inline-block"> <div className="button_mask w-variant-8e98b495-41ed-f293-c19c-799db1427c2c"> <div className="button_text w-variant-8e98b495-41ed-f293-c19c-799db1427c2c">Contact Us</div> </div> <div className="button_icon w-variant-8e98b495-41ed-f293-c19c-799db1427c2c"> <img loading="lazy" src={s.imagem5} alt="" className="button_arrow w-variant-8e98b495-41ed-f293-c19c-799db1427c2c is-one" /> <img loading="lazy" src={s.imagem6} alt="" className="button_arrow w-variant-8e98b495-41ed-f293-c19c-799db1427c2c is-two" /> </div> </a> </div> </div> </div> </div> <div className="partners_loop"> <div className="partners_loop-row"> <div className="loop_logo-wrap"><img loading="lazy" src={s.imagem7} alt="" className="loop_logo-img" /></div><div className="loop_logo-wrap"><img loading="lazy" src={s.imagem8} alt="" className="loop_logo-img" /></div><div className="loop_logo-wrap"><img loading="lazy" src={s.imagem9} alt="" className="loop_logo-img" /></div><div className="loop_logo-wrap"><img loading="lazy" src={s.imagem10} alt="" className="loop_logo-img" /></div><div className="loop_logo-wrap"><img loading="lazy" src={s.imagem11} alt="" className="loop_logo-img" /></div><div className="loop_logo-wrap"><img loading="lazy" src={s.imagem12} alt="" className="loop_logo-img" /></div> </div> <div className="partners_loop-row" aria-hidden="true"> <div className="loop_logo-wrap"><img loading="lazy" src={s.imagem13} alt="" className="loop_logo-img" /></div><div className="loop_logo-wrap"><img loading="lazy" src={s.imagem14} alt="" className="loop_logo-img" /></div><div className="loop_logo-wrap"><img loading="lazy" src={s.imagem15} alt="" className="loop_logo-img" /></div><div className="loop_logo-wrap"><img loading="lazy" src={s.imagem16} alt="" className="loop_logo-img" /></div><div className="loop_logo-wrap"><img loading="lazy" src={s.imagem17} alt="" className="loop_logo-img" /></div><div className="loop_logo-wrap"><img loading="lazy" src={s.imagem18} alt="" className="loop_logo-img" /></div> </div> </div> </section>
    </section>
  );
}