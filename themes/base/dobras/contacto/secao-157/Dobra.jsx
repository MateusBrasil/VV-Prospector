"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-157
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="contacto-secao-157" ref={raiz}>
      <section className="csIntHero" aria-label="Case study hero">
          ...
          <div className="csIntHero__inner">
            <header className="csIntHero__header">
              <h1 className="csIntHero__title">{s.titulo}</h1>
              <p className="csIntHero__description">{s.texto}</p>
            </header>
      
            <div className="csIntHero__imageCard">
              <div className="csIntHero__imageReveal">
                <img src={s.imagem2} alt="Northwind Capital investor portal homepage, shown on a desktop browser" width="1355" height="759" className="csIntHero__image" loading="eager" />
              </div>
            </div>
          </div>
        </section>
