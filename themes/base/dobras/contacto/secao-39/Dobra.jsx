"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-39
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* coverly-cta — component-scoped boot logic.
  //    *
  //    * The shared /coverly/scripts/scroll-reveal.js auto-initializes on
  //    * DOMContentLoaded and handles any [data-reveal], [data-reveal-slide],
  //    * [data-reveal-image], and [fs-numbercount-end] elements — plus the
  //    * .scroll-slide-left global pattern used on this CTA's .cta_wrap.
  //    *
  //    * The button hover micro-interaction is part of the shared Coverly CSS
  //    * (no JS needed here for this section).
  //    */
  //   
  //   /**
  ...
  return (
    <section className="dobra" data-dobra="contacto-secao-39" ref={raiz}>
      <section className="section_cta">
            <div className="padding-global is-cta">
              <div className="container-large">
                <div className="cta_wrap scroll-slide-left">
                  <div className="card bg-secondary">
                    <div>
                      <img src={s.imagem} loading="lazy" alt="Coverly logo" />
                      <div className="spacer-xlarge"></div>
                      <h2 className="h3">{s.titulo}</h2>
                      <div className="spacer-xlarge"></div>
                      <div>You can also use the feedback form below to reach out to us directly through our website.</div>
                    </div>
