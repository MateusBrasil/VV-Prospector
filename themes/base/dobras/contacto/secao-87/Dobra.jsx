"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-87
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="contacto-secao-87" ref={raiz}>
            ...
            <section className="section_location">
              <div className="padding-global padding-section-small">
                <div className="content-wrapper">
                  <div className="w-layout-grid location_header">
                    <div data-wf--label--variant="base" className="label">
                      <div className="text-style-allcaps">Our office sites</div>
                    </div>
                    <div className="block-wrapper">
                      <div className="header">
                        <h1>{s.titulo}</h1>
                        <div className="text-color-secondary">to experience our personalized approach to legal representation.</div>
                      </div>
                  ...
                  <div className="location_image">
                    <div className="img-wrapper"><img src={s.imagem2} loading="lazy" sizes="(max-width: 2352px) 100vw, 2352px" alt="" srcSet="https://d173woph5zl366.cloudfront.net/firmo/images/Locations-image_1Locations-image.webp 500w, https://d173woph5zl366.cloudfront.net/firmo/images/Locations-image_1Locations-image.webp 800w, https://d173woph5zl366.cloudfront.net/firmo/images/Locations-image_1Locations-image.webp 1080w, https://d173woph5zl366.cloudfront.net/firmo/images/Locations-image_1Locations-image.webp 1600w, https://d173woph5zl366.cloudfront.net/firmo/images/Locations-image_1Locations-image.webp 2000w, https://d173woph5zl366.cloudfront.net/firmo/images/Locations-image_1Locations-image.webp 2352w" className="img" /></div>
                  </div>
                  <div className="w-layout-grid location_cards-wrapper">
                    <a href="#" className="location_card scroll-into-view w-inline-block">
