"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-81
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="contacto-secao-81" ref={raiz}>
      <div data-nav="" className="nav w-nav" role="banner"> <div className="nav_bar"> <div className="nav_container"> <div className="menu"> <button type="button" data-menu-toggle="" aria-expanded="false" aria-label="Open menu" className="menu_wrap" onClick={s.onClick}> <div className="text-sm">MENU</div> <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" className="menu-icon"> <path d="M3 18H21V16H3V18ZM3 13H21V11H3V13ZM3 6V8H21V6H3Z" fill="currentColor"></path> </svg> </button> </div> <a href="/" aria-current="page" className="home_logo-link"> <div data-scroll-logo="doorly" className="nav_logo">DOORLY</div> </a> <div className="nav_button"> <a href="/contact" className="button_component w-inline-block"> <div className="button_mask"> <div className="button_text">Contact</div> </div> <div className="button_icon"> <img loading="lazy" src={s.imagem} alt="" className="button_arrow is-one" /> <img loading="lazy" src={s.imagem2} alt="" className="button_arrow is-two" /> </div> </a> </div> <div className="menu_content"> <div className="nav_content-wrap"> <div className="nav_menu-main"> <nav className="nav_links" aria-label="Primary"> <a href="/" aria-current="page" className="nav_link is-lg"> <span className="nav_link-clip"> <span className="nav_link-text">{s.rotulo}</span> <span className="nav_link-line"></span> </span> </a><a href="/about" className="nav_link is-lg"> <span className="nav_link-clip"> <span className="nav_link-text">{s.rotulo2}</span> <span className="nav_link-line"></span> </span> </a><a href="/services" className="nav_link is-lg"> <span className="nav_link-clip"> <span className="nav_link-text">{s.rotulo3}</span> <span className="nav_link-line"></span> </span> </a><a href="/blog" className="nav_link is-lg"> <span className="nav_link-clip"> <span className="nav_link-text">{s.rotulo4}</span> <span className="nav_link-line"></span> </span> </a> </nav> <div className="nav_meta"> <div className="nav_meta-col"> <div className="nav_meta-label">Get in touch</div> <a href="mailto:email@example.com" className="nav_meta-link">{s.acao}</a> <a href="tel:+15555555555" className="nav_meta-link">{s.acao2}</a> </div> <div className="nav_meta-col"> <div className="nav_meta-label">Follow</div> <div className="nav_meta-socials"> <a href={s.destino || '#'} target="_blank" rel="noopener" className="nav_meta-link">{s.acao3}</a><a href={s.destino2 || '#'} target="_blank" rel="noopener" className="nav_meta-link">{s.acao4}</a><a href={s.destino3 || '#'} target="_blank" rel="noopener" className="nav_meta-link">{s.acao5}</a> </div> </div> </div> </div> <div className="nav_image hide-tablet"> <img sizes="(max-width: 1152px) 100vw, 1152px" srcSet="https://d173woph5zl366.cloudfront.net/doorly/images/buyers-img-p-500.avif 500w, https://d173woph5zl366.cloudfront.net/doorly/images/buyers-img-p-800.avif 800w, https://d173woph5zl366.cloudfront.net/doorly/images/buyers-img.avif 1152w" alt="Modern two-story house with a beige facade, wooden vertical slats, a balcony planter, and a green driveway." src={s.imagem3} loading="lazy" className="img" /> <div className="nav_image-scrim"></div> <div className="nav_image-caption"> <div className="nav_image-caption-label">Featured</div> <div className="nav_image-caption-title">Find your next home</div> </div> </div> </div> </div> </div> </div> <div className="nav_overlay"></div> </div>
      <section className="section_contact-hero"> <div className="container-large"> <div className="contact-hero"> <div id="w-node-afa53480-008b-5d44-3a93-2131c01bc3a0-c57de13d" className="contact-hero-left"> <div className="contact-hero_heading"> <div animation="hero-tag" className="wrap"> <div className="section_tag w-variant-11063f80-6b7d-0c32-82a3-15d5a31bbce2">[Contact us]</div> </div> <div className="wrap"> <h1 animation="hero-title" className="h4 text-style-allcaps">{s.titulo}</h1> </div> <div className="wrap"> <div animation="hero-title" className="max-description is-29rem"> <div>Receive expert guidance to maximize your next purchase, sale, or investment.</div> </div> </div> </div> <div animation="zoom" className="contact_info-list"> <div animation="hero-stats" className="contact_info-item"> <div className="contact-hero_icon"><img src={s.imagem4} loading="lazy" alt="" className="card-arrow" /></div> <div className="text-color-on-primary">123 Example Road, New York, NY 12345</div> </div><div animation="hero-stats" className="contact_info-item"> <div className="contact-hero_icon"><img src={s.imagem5} loading="lazy" alt="" className="card-arrow" /></div> <div className="text-color-on-primary">email@example.com</div> </div><div animation="hero-stats" className="contact_info-item"> <div className="contact-hero_icon"><img src={s.imagem6} loading="lazy" alt="" className="card-arrow" /></div> <div className="text-color-on-primary">(555) 555-5555</div> </div> </div> </div> <div id="w-node-_52350c93-d6ed-fddc-7c93-63dfdff34c82-c57de13d" className="wrap"> <div animation="hero-form" className="form_component-wrapper bg-default"> <div className="form_component w-form"> <form name="wf-form-Form" data-name="Form" className="form_form" onsubmit="return false"> <div className="form_fields-wrapper"> <div animation="hero-form-input" id="w-node-_92a3656a-7e4f-51d7-9e80-2cb620977eda-c57de13d" className="form_field-wrapper"> <label htmlFor="contact-name" className="form_label">Your name</label> <input className="form_input w-input" maxLength="256" name="name" data-name="Name" placeholder="Your name" type="text" id="contact-name" /> </div> <div animation="hero-form-input" id="w-node-_86be36c5-4c44-9a93-4b13-6ac5b8059cf0-c57de13d" className="form_field-wrapper"> <label htmlFor="contact-email" className="form_label">Email address</label> <input className="form_input w-input" maxLength="256" name="email" data-name="Email" placeholder="Your email address" type="email" id="contact-email" /> </div> <div animation="hero-form-input" id="w-node-_593e174e-18ae-41cd-299f-e154253913ff-c57de13d" className="form_field-wrapper"> <label htmlFor="contact-phone" className="form_label">Phone number</label> <input className="form_input w-input" maxLength="256" name="phone" data-name="Phone" placeholder="Your phone number" type="tel" inputmode="tel" id="contact-phone" /> </div> <div animation="hero-form-input" id="w-node-_92a3656a-7e4f-51d7-9e80-2cb620977ede-c57de13d" className="form_field-wrapper"> <label htmlFor="contact-message" className="form_label">Message</label> <textarea id="contact-message" name="message" maxLength="5000" data-name="Message" placeholder="Type something here" className="form_input is-text-area w-input"></textarea> </div> </div> <div animation="hero-form-input" className="button_wrap is-submit"><input type="submit" data-wait="Please wait..." className="button w-button" value="Submit" /></div> </form> <div className="form_message-success w-form-done" data-form-done=""> <div>Thank you! Your submission has been received!</div> </div> <div className="form_message-error w-form-fail"> <div>Oops! Something went wrong while submitting the form.</div> </div> </div> </div> </div> </div> </div> </section>
    </section>
  );
}