"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-193
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-193" ref={raiz}>
      <section className="testimonials_section"> <div className="section_wrapper"> <div className="container-large"> <div className="testimonials_heading"> <div data-reveal="view"> <div className="badge w-variant-93892c57-1ab8-2863-c67c-6f87b0ee71fc"> <div className="text-sm">Testimonials</div> </div> </div> <div className="max-heading is-48rem" data-reveal="view"> <h2 className="h1">{s.titulo}</h2> </div> <div className="text-color-subtle" data-reveal="view">The LatAm talent partner top performers choose</div> </div> <div className="spacer"> <div style={{height: '6rem'}} className="spacer-desktop"></div> <div style={{height: '4rem'}} className="spacer-tablet"></div> <div style={{height: '2rem'}} className="spacer-mobile"></div> </div> </div> <div className="testimonial_layout"> <div className="testimonial_wrap is-one"> <div className="testimonial_card w-variant-8c81ddad-22bf-d40d-5178-f2087b555d1e"> <div className="testimonial_user"> <img loading="lazy" src={s.imagem} alt="Mark Tressler" className="icon-1x1-xxlarge" /> <div> <div className="text-xl font-header">Mark Tressler</div> <div className="spacer-xxsmall"></div> <div className="text-xs text-color-secondary">COO, FinTech Global</div> </div> </div> <div className="testimonial_content"> <div className="h6">A true partner in growth.</div> <div className="spacer-medium"></div> <div className="text-color-secondary text-style-6lines">"We launched our Mexico City operations in 30 days – no local entity needed. Their payroll and benefits infrastructure saved us $280K in setup costs, and their talent retention rate is 40% higher than industry average."</div> </div> </div> </div><div className="testimonial_wrap is-two"> <div className="testimonial_card w-variant-1eef4daf-1432-6736-8c4c-185432f6a073"> <div className="testimonial_user"> <img loading="lazy" src={s.imagem2} alt="Jake Miller" className="icon-1x1-xxlarge" /> <div> <div className="text-xl font-header w-variant-1eef4daf-1432-6736-8c4c-185432f6a073">Jake Miller</div> <div className="spacer-xxsmall"></div> <div className="text-xs text-color-secondary w-variant-1eef4daf-1432-6736-8c4c-185432f6a073">VP, NorthBridge</div> </div> </div> <div className="testimonial_content"> <div className="h6 w-variant-1eef4daf-1432-6736-8c4c-185432f6a073">They simplified everything.</div> <div className="spacer-medium"></div> <div className="text-color-secondary text-style-6lines w-variant-1eef4daf-1432-6736-8c4c-185432f6a073">"In less than six weeks, they streamlined our entire onboarding workflow across three countries. We cut our administrative load by 55% and reduced compliance errors to virtually zero. The transparency and execution speed are unmatched."</div> </div> </div> </div><div className="testimonial_wrap is-three"> <div className="testimonial_card"> <div className="testimonial_user"> <img loading="lazy" src={s.imagem3} alt="Chloe Adams" className="icon-1x1-xxlarge" /> <div> <div className="text-xl font-header">Chloe Adams</div> <div className="spacer-xxsmall"></div> <div className="text-xs text-color-secondary">CFO, Horizon Labs</div> </div> </div> <div className="testimonial_content"> <div className="h6">A team that delivers.</div> <div className="spacer-medium"></div> <div className="text-color-secondary text-style-6lines">"Their end-to-end HR and payroll support let us expand to Latin America without distraction. We saved $190K in annual overhead, and our hiring cycle went from 28 days to just 9. It’s the kind of operational lift that changes your whole roadmap."</div> </div> </div> </div><div className="testimonial_wrap is-four"> <div className="testimonial_card w-variant-ad564190-d37f-1b5e-5abb-7e5e23ad7a64"> <div className="testimonial_user"> <img loading="lazy" src={s.imagem4} alt="Ryan Parker" className="icon-1x1-xxlarge" /> <div> <div className="text-xl font-header w-variant-ad564190-d37f-1b5e-5abb-7e5e23ad7a64">Ryan Parker</div> <div className="spacer-xxsmall"></div> <div className="text-xs text-color-secondary w-variant-ad564190-d37f-1b5e-5abb-7e5e23ad7a64">CEO, FinTech Global</div> </div> </div> <div className="testimonial_content"> <div className="h6 w-variant-ad564190-d37f-1b5e-5abb-7e5e23ad7a64">Clear impact from day one.</div> <div className="spacer-medium"></div> <div className="text-color-secondary text-style-6lines w-variant-ad564190-d37f-1b5e-5abb-7e5e23ad7a64">"Their ecosystem flagged inefficiencies in our multi-country payouts and fixed them in a week. That alone reduced our monthly burn by 12%. Add their reporting tools, and we now make decisions in hours, not weeks. Truly game-changing."</div> </div> </div> </div> </div> </div> </section>
    </section>
  );
}