"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-165
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-165" ref={raiz}>
            ...
            <section className="section_team">
              <div className="padding-global padding-section-small">
                <div className="content-wrapper">
                  ...
                  <div className="team_slider scroll-into-view" data-team-slider="">
                    <ul className="team_track" data-team-track="">
                      <li className="team_slide">
                        <a href="/lawyers/michael-thompson-johnson" className="team_card w-inline-block">
                          <div className="team_card-image">
                            <div className="img-wrapper">
                              <img src={s.imagem} loading="lazy" alt="Michael Thompson Johnson" className="img" />
                            </div>
                          </div>
                          <div className="team_card-content">
                            ...
                            <div className="team_card-button"><svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" className="button-svg"><path d="M4.50006 10.9999L16.0861 10.9999L11.5861 6.49994L13.0001 5.08594L19.9141 11.9999L13.0001 18.9139L11.5861 17.4999L16.0861 12.9999L4.50006 12.9999L4.50006 10.9999Z" fill="currentColor"></path></svg></div>
                          </div>
                        </a>
                      </li>
                      <li className="team_slide">
                        <a href="/lawyers/adison-dorwart" className="team_card w-inline-block">
                          <div className="team_card-image">
                            <div className="img-wrapper">
                              <img src={s.imagem2} loading="lazy" alt="Adison Dorwart" className="img" />
                            </div>
                          </div>
                          <div className="team_card-content">
                            <div className="team_card-title">
                      ...
                      <li className="team_slide">
                        <a href="/lawyers/cristofer-gouse" className="team_card w-inline-block">
                          <div className="team_card-image">
                            <div className="img-wrapper">
                              <img src={s.imagem3} loading="lazy" alt="Cristofer Gouse" className="img" />
                            </div>
                          </div>
                          <div className="team_card-content">
                            <div className="team_card-title">
                      ...
                      <li className="team_slide">
                        <a href="/lawyers/haylie-curtis" className="team_card w-inline-block">
                          <div className="team_card-image">
                            <div className="img-wrapper">
                              <img src={s.imagem4} loading="lazy" alt="Haylie Curtis" className="img" />
                            </div>
                          </div>
                          <div className="team_card-content">
                            <div className="team_card-title">
                      ...
                      <li className="team_slide">
                        <a href="/lawyers/alfonso-gouse" className="team_card w-inline-block">
                          <div className="team_card-image">
                            <div className="img-wrapper">
                              <img src={s.imagem5} loading="lazy" alt="Alfonso Gouse" className="img" />
                            </div>
                          </div>
                          <div className="team_card-content">
                            <div className="team_card-title">
                      ...
                      <li className="team_slide">
                        <a href="/lawyers/james-stanton" className="team_card w-inline-block">
                          <div className="team_card-image">
                            <div className="img-wrapper">
                              <img src={s.imagem6} loading="lazy" alt="James Stanton" className="img" />
                            </div>
                          </div>
                          <div className="team_card-content">
                            <div className="team_card-title">
                    ...
                    <div className="team_arrows">
                      <button type="button" className="team_arrow" data-team-prev="" aria-label="Previous" onClick={s.onClick}><svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" className="icon-1x1-main"><path d="M10.5 19.5L11.5575 18.4425L5.8725 12.75H21V11.25H5.8725L11.5575 5.5575L10.5 4.5L3 12L10.5 19.5Z" fill="currentColor"></path></svg></button>
                      <button type="button" className="team_arrow" data-team-next="" aria-label="Next" onClick={s.onClick}><svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" className="icon-1x1-main"><path d="M13.5 19.5L12.4425 18.4425L18.1275 12.75H3V11.25H18.1275L12.4425 5.5575L13.5 4.5L21 12L13.5 19.5Z" fill="currentColor"></path></svg></button>
                    </div>
                  </div>
                </div>
              </div>
