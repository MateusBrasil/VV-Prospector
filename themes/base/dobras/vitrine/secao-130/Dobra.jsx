"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-130
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // hirely-service-hero — no local logic. The LOAD entrance (bounce-enter ladder:
  //   // h1, description, button, hero image + service SVG) is driven by
  //   // /hirely/scripts/hero-enter.js; the `.scroll-animation` reveals on the banner by
  //   // /hirely/scripts/scroll-reveal.js; the navbar by navbar.js + navbar-scroll.js;
  //   // the `.loop` logo marquee is pure CSS (in /hirely/styles.css). Stub kept for the
  //   // 4-file convention.
  //   
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-130" ref={raiz}>
                ...
                <div className="container-large">
                  <div className="service_grid">
                    <div className="service_heading">
                      <div bounce-enter="h1" className="hero_header">
                        <h1 className="text-color-white">{s.titulo}</h1>
                      </div>
                      <div className="spacer-medium"></div>
                      <div bounce-enter="description" className="text-color-on-dark">Your all-in-one LATAM HR partner. From hiring to offboarding, we streamline the entire employee lifecycle</div>
                    ...
                    <div className="service_img">
                      <div bounce-enter="hero-img" className="img-wrapper"><img src={s.imagem2} loading="eager" fetchpriority="high" decoding="async" alt="Hire &amp; manage" className="img" /></div><img src={s.imagem3} loading="eager" bounce-enter="hero-svg" alt="" className="service_svg" />
                    </div>
                  </div>
                </div>
              </div>
              <div data-wf--hero-banner--variant="base" className="hero_banner">
                ...
                <div animation="loop" className="loop scroll-animation">
                  <div className="loop_logo">
                    <img loading="lazy" src={s.imagem4} alt="" className="logos_img" />
                    <img loading="lazy" src={s.imagem5} alt="" className="logos_img" />
                    <img loading="lazy" src={s.imagem6} alt="" className="logos_img" />
