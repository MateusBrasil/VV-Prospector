"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-175
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-175" ref={raiz}>
      <section className="section_team bg-primary"> <div className="padding-section-medium"></div> <div className="container-large"> <div className="member_heading"> <div className="scroll-into-view"> <div className="section_tag w-variant-11063f80-6b7d-0c32-82a3-15d5a31bbce2">[ Our team ]</div> </div> <h2 animation="section-heading" className="text-color-on-primary text-style-allcaps">{s.titulo}</h2> </div> <div className="spacer"> <div style={{height: '4rem'}} className="spacer-desktop"></div> <div style={{height: '3rem'}} className="spacer-tablet"></div> <div style={{height: '2rem'}} className="spacer-mobile"></div> </div> <div className="member_layout"> <div className="button_wrap scroll-into-view"> <a href="/about" className="button_component w-inline-block"> <div className="button_mask w-variant-8e98b495-41ed-f293-c19c-799db1427c2c"> <div className="button_text w-variant-8e98b495-41ed-f293-c19c-799db1427c2c">Learn more</div> </div> <div className="button_icon w-variant-8e98b495-41ed-f293-c19c-799db1427c2c"> <img loading="lazy" src={s.imagem} alt="" className="button_arrow w-variant-8e98b495-41ed-f293-c19c-799db1427c2c is-one" /> <img loading="lazy" src={s.imagem2} alt="" className="button_arrow w-variant-8e98b495-41ed-f293-c19c-799db1427c2c is-two" /> </div> </a> </div> <div id="w-node-_0daa5f19-b81d-9f28-17f7-868ed37faba4-41293e7a" className="member_collection"> <div className="member_card-wrapper"> <a href="/member/james-vile" className="member_card scroll-into-view w-inline-block"> <div className="member_card-bg"><img loading="lazy" alt="James Vile" src={s.imagem3} className="img" /></div> <div className="member_icon"> <img loading="lazy" alt="" src={s.imagem4} className="card-arrow is-one" /> <img loading="lazy" alt="" src={s.imagem5} className="card-arrow is-two" /> </div> <div className="member_info"> <div className="text-xl">James Vile</div> <div className="text-sm">CEO</div> </div> </a> </div><div className="member_card-wrapper is-two"> <a href="/member/jaxson-botosh" className="member_card scroll-into-view w-inline-block"> <div className="member_card-bg"><img loading="lazy" alt="Jaxson Botosh" src={s.imagem6} className="img" /></div> <div className="member_icon"> <img loading="lazy" alt="" src={s.imagem7} className="card-arrow is-one" /> <img loading="lazy" alt="" src={s.imagem8} className="card-arrow is-two" /> </div> <div className="member_info"> <div className="text-xl">Jaxson Botosh</div> <div className="text-sm">CEO</div> </div> </a> </div><div className="member_card-wrapper is-three"> <a href="/member/marley-curtis" className="member_card scroll-into-view w-inline-block"> <div className="member_card-bg"><img loading="lazy" alt="Marley Curtis" src={s.imagem9} className="img" /></div> <div className="member_icon"> <img loading="lazy" alt="" src={s.imagem10} className="card-arrow is-one" /> <img loading="lazy" alt="" src={s.imagem11} className="card-arrow is-two" /> </div> <div className="member_info"> <div className="text-xl">Marley Curtis</div> <div className="text-sm">CEO</div> </div> </a> </div> </div> </div> </div> <div className="padding-section-medium"></div> </section>
    </section>
  );
}