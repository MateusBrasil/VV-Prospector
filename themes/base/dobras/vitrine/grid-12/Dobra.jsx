"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes-de-grid/grid-12
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="vitrine-grid-12" ref={raiz}>
      <main>
      			<header className="frame">
      				<h2 className="frame__title">{s.titulo}</h2>
      				...
      				<span className="frame__logo">{s.rotulo2}</span>
      			</header>
      			<section className="content content--padded">
      				<h4 className="type-tiny">{s.subtitulo}</h4>
      			...
      			<section className="content content--full content--padded">
      				<div className="grid grid--spaced" data-grid-first>
      					<div className="grid__img pos-1" style={{backgroundImage: `url(${s.imagem})`}}></div>
      					<div className="grid__img pos-2" style={{backgroundImage: `url(${s.imagem2})`}}></div>
      					<div className="grid__img pos-3" style={{backgroundImage: `url(${s.imagem3})`}}></div>
      					<div className="grid__img pos-4" style={{backgroundImage: `url(${s.imagem4})`}}></div>
      					<div className="grid__img pos-5" style={{backgroundImage: `url(${s.imagem5})`}}></div>
      					<div className="grid__img pos-6" style={{backgroundImage: `url(${s.imagem6})`}}></div>
      					<div className="grid__img pos-7" style={{backgroundImage: `url(${s.imagem7})`}}></div>
      					<div className="grid__img pos-8" style={{backgroundImage: `url(${s.imagem8})`}}></div>
      					<div className="grid__img pos-9" style={{backgroundImage: `url(${s.imagem9})`}}></div>
      					<div className="grid__img pos-10" style={{backgroundImage: `url(${s.imagem10})`}}></div>
      					<div className="grid__img pos-11" style={{backgroundImage: `url(${s.imagem11})`}}></div>
      					<div className="grid__img pos-12" style={{backgroundImage: `url(${s.imagem12})`}}></div>
      					<div className="grid__img pos-13" style={{backgroundImage: `url(${s.imagem13})`}}></div>
      					<div className="grid__img pos-14" style={{backgroundImage: `url(${s.imagem14})`}}></div>
      					<div className="grid__img pos-15" style={{backgroundImage: `url(${s.imagem15})`}}></div>
      					<div className="grid__img pos-16" style={{backgroundImage: `url(${s.imagem16})`}}></div>
      					<div className="grid__img pos-17" style={{backgroundImage: `url(${s.imagem17})`}}></div>
      				</div>
      				<div className="content__title">
      					<h2 className="content__title-main">{s.titulo2}</h2>
      					<p className="type-tiny right end">{s.texto2}</p>
      				</div>
      			</section>
      			<section className="content content--padded">
      				<h4 className="type-tiny">{s.subtitulo2}</h4>
      				<p className="content__text">His lens captures the quiet ache of reality, where shadow and light blur the line between seen and felt. Soft, muted={true} tones breathe life into the ordinary, revealing the sensual curves and fragile textures hidden={true} in plain sight. Each image lingers in the tension of what’s almost forgotten, where touch and absence coexist. There’s no rush, no spectacle—just the raw, intimate beauty of life unfolding in quiet moments. Light grazes skin, shadows hold secrets, and the world feels both distant and deeply near.</p>
      			</section>
      			<section className="content content--padded">
      				<div className="grid grid--columns grid--spaced" data-grid-second>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem18})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem19})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem20})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem21})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem22})`}}></div>
      					<div className="grid__item pos-6">
                    <h4 className="type-tiny">{s.subtitulo3}</h4>
                    <p>{s.texto3}</p>
                </div>
                <div className="grid__item pos-7">
                    <h4 className="type-tiny">{s.subtitulo4}</h4>
                    <p>{s.texto4}</p>
                </div>
                <div className="grid__item pos-18">
                    <h4 className="type-tiny">{s.subtitulo5}</h4>
                    <p>{s.texto5}</p>
                </div>
      				</div>
      			</section>
      			<section className="content content--padded">
      				<h4 className="type-tiny">{s.subtitulo6}</h4>
      				<p className="content__text">Lennox Montgomery, born in 1987 in Brooklyn, grew up attuned to the gentle interplay of light and shadow in the city’s quieter corners. His eye was drawn to the unnoticed beauty in the mundane, the softness in the grit. In his early 20s, he relocated to Los Angeles, where the hazy sunlight, muted={true} colors, and sprawling landscapes deepened his introspective approach to art. There, he found inspiration in the delicate moments between movement and stillness, capturing the fleeting, sensual beauty of everyday life in a way that feels both intimate and timeless.</p>
      			</section>
      			<section className="content content--padded content--full">
      				<div className="grid grid--columns grid--spaced grid--single" data-grid-third>
      					<div className="grid__img pos-2" style={{backgroundImage: `url(${s.imagem23})`}}></div>
      					<div className="grid__img pos-2" style={{backgroundImage: `url(${s.imagem24})`}}></div>
      					<div className="grid__img pos-2" style={{backgroundImage: `url(${s.imagem25})`}}></div>
      					<div className="grid__img pos-2" style={{backgroundImage: `url(${s.imagem26})`}}></div>
      					<div className="grid__img pos-2" style={{backgroundImage: `url(${s.imagem27})`}}></div>
      					<div className="grid__item acenter pos-1">
      						<h4 className="type-tiny">{s.subtitulo7}</h4>
      						<p>{s.texto6}</p>
      					</div>
      					<div className="grid__item acenter pos-4">
      						<h4 className="type-tiny">{s.subtitulo8}</h4>
      						<p>{s.texto7}</p>
      					</div>
      				</div>
      			</section>
      			<section className="content content--padded">
      				<h4 className="type-tiny">{s.subtitulo9}</h4>
      				<p className="content__text">{s.texto8}</p>
      			</section>
      			<section className="content content--padded content--full">
      				<div className="grid grid--spaced grid--small" data-grid-fourth>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem28})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem29})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem30})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem31})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem32})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem33})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem34})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem35})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem36})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem37})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem38})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem39})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem40})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem41})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem42})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem43})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem44})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem45})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem46})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem47})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem48})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem49})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem50})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem51})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem52})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem53})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem54})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem55})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem56})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem57})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem58})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem59})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem60})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem61})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem62})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem63})`}}></div>
      				</div>
      			</section>
            <section className="content content--full">
      				<div className="grid grid--small" data-grid-fourth-v2>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem64})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem65})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem66})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem67})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem68})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem69})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem70})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem71})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem72})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem73})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem74})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem75})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem76})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem77})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem78})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem79})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem80})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem81})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem82})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem83})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem84})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem85})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem86})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem87})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem88})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem89})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem90})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem91})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem92})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem93})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem94})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem95})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem96})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem97})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem98})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem99})`}}></div>
      				</div>
      			</section>
      			<section className="content content--padded">
      				<h4 className="type-tiny">{s.subtitulo10}</h4>
      				<p className="content__text">{s.texto9}</p>
      			</section>
      			<section className="content content--padded content--full">
      				<div className="grid grid--spaced grid--wide" data-grid-fifth>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem100})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem101})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem102})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem103})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem104})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem105})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem106})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem107})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem108})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem109})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem110})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem111})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem112})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem113})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem114})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem115})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem116})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem117})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem118})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem119})`}}></div>
      				</div>
      				<div className="content__title">
      					<h2 className="content__title-main">{s.titulo3}</h2>
      					<p className="type-tiny right end">{s.texto10}</p>
      				</div>
      			</section>
      			<section className="content content--padded">
      				<h4 className="type-tiny">{s.subtitulo11}</h4>
      				<p className="content__text">{s.texto11}</p>
      			</section>
      			<section className="content content--full content--cutoff">
      				<div className="grid grid--spaced grid--zoomed" data-grid-sixth>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem120})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem121})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem122})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem123})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem124})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem125})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem126})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem127})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem128})`}}></div>
      				</div>
      				<div className="content__title">
      					<h2 className="content__title-main">{s.titulo4}</h2>
      					<p className="type-tiny right end">{s.texto12}</p>
      				</div>
      			</section>
      			<section className="content content--padded">
      				<h4 className="type-tiny">{s.subtitulo12}</h4>
      				<p className="content__text">{s.texto13}</p>
      			</section>
      			<section className="content content--full content--padded">
      				<div className="grid grid--column" data-grid-seventh>
      					<div className="grid__item span-3">
      				        <h4 className="type-tiny">{s.subtitulo13}</h4>
      				        <p>{s.texto14}</p>
      				    </div>
      					<div className="grid__img ar-rect span-2">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem129})`}}></div>
      					</div>
      					<div className="grid__img ar-wide">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem130})`}}></div>
      					</div>
      					<div className="grid__img ar-wide span-2">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem131})`}}></div>
      					</div>
      					<div className="grid__img span-2 ar-narrow">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem132})`}}></div>
      					</div>
      					<div className="grid__img ar-wide">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem133})`}}></div>
      					</div>
      					<div className="grid__img ar-wide span-2">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem134})`}}></div>
      					</div>
      					<div className="grid__img span-2 ar-narrow">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem135})`}}></div>
      					</div>
      
                <div className="grid__item span-3">
                  <h4 className="type-tiny">{s.subtitulo14}</h4>
                  <p>{s.texto15}</p>
      				  </div>
      					<div className="grid__img span-2 ar-narrow">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem136})`}}></div>
      					</div>
      					<div className="grid__img ar-wide span-2">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem137})`}}></div>
      					</div>
      					<div className="grid__img ar-rect">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem138})`}}></div>
      					</div>
      					<div className="grid__img ar-wide span-2">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem139})`}}></div>
      					</div>
      					<div className="grid__img ar-narrow span-2">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem140})`}}></div>
      					</div>
      					<div className="grid__img ar-wide span-3">
      					  <div className="grid__img-inner" style={{backgroundImage: `url(${s.imagem141})`}}></div>
      					</div>
      				</div>
      			</section>
      			<section className="content content--padded">
      				<h4 className="type-tiny">{s.subtitulo15}</h4>
      				<p className="content__text">{s.texto16}</p>
      			</section>
      			<section className="content content--full">
      				<div className="grid grid--tiny" data-grid-eighth>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem142})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem143})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem144})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem145})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem146})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem147})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem148})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem149})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem150})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem151})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem152})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem153})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem154})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem155})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem156})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem157})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem158})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem159})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem160})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem161})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem162})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem163})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem164})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem165})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem166})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem167})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem168})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem169})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem170})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem171})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem172})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem173})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem174})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem175})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem176})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem177})`}}></div>
      				</div>
      			</section>
      			<section className="content content--padded">
      				<h4 className="type-tiny">{s.subtitulo16}</h4>
      				<p className="content__text">{s.texto17}</p>
      			</section>
      			<section className="content content--full">
      				<div className="grid grid--columns" data-grid-ninth>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem178})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem179})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem180})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem181})`}}></div>
      					<div className="grid__img" style={{backgroundImage: `url(${s.imagem182})`}}></div>
      				</div>
      			</section>
      			<section className="content content--padded">
      				<h4 className="type-tiny">{s.subtitulo17}</h4>
      				<p className="content__text">{s.texto18}</p>
      			</section>
      			<footer className="page-footer type-tiny">
      				<span>Created by <a href={s.destino6 || '#'}>{s.acao6}</a> 2024</span>
      				<span><a href={s.destino7 || '#'}>{s.acao7}</a></span>
      				<a href={s.destino8 || '#'}>{s.acao8}</a>
      			</footer>
      		</main>
    </section>
  );
