"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-93
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // hirely-contact-hero — no local logic. The on-load entrance (bounce-enter ladder:
  //   // h1 SplitText + description + decorative SVG + the three contact-data rows) is
  //   // driven by /hirely/scripts/hero-enter.js; the form's `.scroll-animation` reveal by
  //   // /hirely/scripts/scroll-reveal.js; the navbar by navbar.js + navbar-scroll.js.
  //   // The contact form is a static stub (`onsubmit="return false;"`) — no backend, no
  //   // client validation script needed. Stub kept for the 4-file convention.
  //   
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-93" ref={raiz}>
                  ...
                  <div className="contact_layout">
                    <div>
                      <div className="contact_heading">
                        <h1 bounce-enter="h1" className="h3">{s.titulo}</h1>
                        <div className="spacer-medium"></div>
                        <div bounce-enter="description" className="text-color-on-dark">We’re here to help you with your staffing needs.</div>
                        <img src={s.imagem2} loading="lazy" bounce-enter="hero-svg" alt="" className="contact_svg" />
                      </div>
                      <div className="spacer-xhuge"></div>
                      <div className="contact_data-list">
                        <div bounce-enter="stats" className="contact_data">
                          <img src={s.imagem3} loading="lazy" alt="" />
                          <div>hello@hirely.com</div>
                        </div>
                        <div bounce-enter="stats" className="contact_data">
                          <img src={s.imagem4} loading="lazy" alt="" />
                          <div>+1 (555) 123-4567</div>
                        </div>
                        <div bounce-enter="stats" className="contact_data">
                          <img src={s.imagem5} loading="lazy" alt="" />
                          <div>456 Example Ave, New York NY 10001 US</div>
                        </div>
                      </div>
                    </div>
                    <div>
                      <div className="contact_form scroll-animation w-form">
                        
                        <form id="email-form" name="email-form" method="post" action="/api/contact" onsubmit="return false;">
                          <div className="form_grid">
                            <div>
                              <label htmlFor="First-Name" className="form_label">Name</label>
                              <div className="spacer-medium"></div>
                              <input className="form_input w-input" maxLength="256" name="First-Name" placeholder="First Name" type="text" id="First-Name" />
                            </div>
                            <div>
                              <label htmlFor="Last-Name" className="form_label">Last Name</label>
                              <div className="spacer-medium"></div>
                              <input className="form_input w-input" maxLength="256" name="Last-Name" placeholder="Last Name" type="text" id="Last-Name" required="" />
                            </div>
                            <div>
                              <label htmlFor="Email" className="form_label">Email</label>
                              <div className="spacer-medium"></div>
                              <input className="form_input w-input" maxLength="256" name="Email" placeholder="Email Address" type="email" id="Email" required="" />
                            </div>
                            <div>
                              <label htmlFor="Phone-Number" className="form_label">Phone Number</label>
                              <div className="spacer-medium"></div>
                              <input className="form_input w-input" maxLength="256" name="Phone-Number" placeholder="Phone Number" type="tel" id="Phone-Number" required="" />
                            </div>
                            <div className="form_message">
                              <label htmlFor="Text-Field" className="form_label">Message</label>
                              <div className="spacer-medium"></div>
                              <textarea id="Text-Field" name="Text-Field" maxLength="5000" placeholder="Enter your message..." className="form_input is-text-area w-input"></textarea>
                            </div>
                            <div className="button-wrap">
                              <input type="submit" data-wait="Please wait..." className="button is-form-submit w-button" value="Send a message" />
                            </div>
                          </div>
                        </form>
