"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-45
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* hirekit-team-cta: sin logica local; reveals desde /hirekit/scripts/animations.js. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-45" ref={raiz}>
      <section className="started_section"> <div className="section_wrapper"> <div className="container-large"> <div className="started_layout"> <div className="started_left"> <div> <div className="started_heading is-two"> <div className="badge secondary" data-reveal="view"> <div className="text-sm secondary-2">GET STARTED</div> </div> <div className="max-heading is-48rem" data-reveal="view"> <h2 className="h2 text-color-on-primary">{s.titulo}</h2> </div> <div data-reveal="view"> <a href="/contact" className="button_secondary w-inline-block"> <div className="button_text">Start Free Trial</div> <div className="button_icon"> <img src={s.imagem} loading="lazy" alt="" className="arrow-icon is-one" /> <img src={s.imagem2} loading="lazy" alt="" className="arrow-icon is-two" /> </div> </a> </div> </div> </div> </div> <div className="started_loop-wrap" data-reveal="view"> <div className="started_loop" data-vloop=""> <div className="started_items"> <a href="/team/ben-turner" className="started_item w-inline-block"> <img src={s.imagem3} loading="eager" decoding="async" alt="Ben Turner" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Quality Assurance</div> </div> <img src={s.imagem4} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/olivia-reed" className="started_item w-inline-block"> <img src={s.imagem5} loading="eager" decoding="async" alt="Olivia Reed" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Project Manager</div> </div> <img src={s.imagem6} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/cole-bennett" className="started_item w-inline-block"> <img src={s.imagem7} loading="eager" decoding="async" alt="Cole Bennett" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Developer</div> </div> <img src={s.imagem8} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/ryan-parker" className="started_item w-inline-block"> <img src={s.imagem9} loading="eager" decoding="async" alt="Ryan Parker" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Social Media</div> </div> <img src={s.imagem10} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/maya-torres" className="started_item w-inline-block"> <img src={s.imagem11} loading="eager" decoding="async" alt="Maya Torres" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Brand Designer</div> </div> <img src={s.imagem12} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/chloe-adams" className="started_item w-inline-block"> <img src={s.imagem13} loading="eager" decoding="async" alt="Chloe Adams" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Accountant</div> </div> <img src={s.imagem14} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/ethan-brooks" className="started_item w-inline-block"> <img src={s.imagem15} loading="eager" decoding="async" alt="Ethan Brooks" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">UI/UX Designer</div> </div> <img src={s.imagem16} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/jake-miller" className="started_item w-inline-block"> <img src={s.imagem17} loading="eager" decoding="async" alt="Jake Miller" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Human Resources</div> </div> <img src={s.imagem18} loading="lazy" alt="" className="member_flag" /> </div> </a> </div> </div><div className="started_loop" data-vloop=""> <div className="started_items"> <a href="/team/ben-turner" className="started_item w-inline-block"> <img src={s.imagem19} loading="eager" decoding="async" alt="Ben Turner" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Quality Assurance</div> </div> <img src={s.imagem20} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/olivia-reed" className="started_item w-inline-block"> <img src={s.imagem21} loading="eager" decoding="async" alt="Olivia Reed" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Project Manager</div> </div> <img src={s.imagem22} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/cole-bennett" className="started_item w-inline-block"> <img src={s.imagem23} loading="eager" decoding="async" alt="Cole Bennett" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Developer</div> </div> <img src={s.imagem24} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/ryan-parker" className="started_item w-inline-block"> <img src={s.imagem25} loading="eager" decoding="async" alt="Ryan Parker" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Social Media</div> </div> <img src={s.imagem26} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/maya-torres" className="started_item w-inline-block"> <img src={s.imagem27} loading="eager" decoding="async" alt="Maya Torres" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Brand Designer</div> </div> <img src={s.imagem28} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/chloe-adams" className="started_item w-inline-block"> <img src={s.imagem29} loading="eager" decoding="async" alt="Chloe Adams" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Accountant</div> </div> <img src={s.imagem30} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/ethan-brooks" className="started_item w-inline-block"> <img src={s.imagem31} loading="eager" decoding="async" alt="Ethan Brooks" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">UI/UX Designer</div> </div> <img src={s.imagem32} loading="lazy" alt="" className="member_flag" /> </div> </a><a href="/team/jake-miller" className="started_item w-inline-block"> <img src={s.imagem33} loading="eager" decoding="async" alt="Jake Miller" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div className="text-miniteam">Human Resources</div> </div> <img src={s.imagem34} loading="lazy" alt="" className="member_flag" /> </div> </a> </div> </div> </div> </div> </div> </div> </section>
    </section>
  );
}