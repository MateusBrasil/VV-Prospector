"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/scroll/scroll-16/sticky-grid-scroll-main/src
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="vitrine-scroll-16" ref={raiz}>
      <main>
          <section className="block block--intro">
            <figure className="media">
              <img className="media__image" src={s.imagem} alt="Image 8" />
          ...
          <section className="block block--main">
            <div className="block__wrapper">
              <div className="content">
                ...
                <a className="content__button" href={s.destino || '#'}>{s.acao}</a>
              </div>
              <div className="gallery">
                <ul className="gallery__grid">
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem2} alt="Image 1" />
                  </li>
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem3} alt="Image 2" />
                  </li>
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem4} alt="Image 3" />
                  </li>
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem5} alt="Image 4" />
                  </li>
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem6} alt="Image 5" />
                  </li>
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem7} alt="Image 6" />
                  </li>
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem8} alt="Image 7" />
                  </li>
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem9} alt="Image 8" />
                  </li>
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem10} alt="Image 9" />
                  </li>
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem11} alt="Image 10" />
                  </li>
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem12} alt="Image 11" />
                  </li>
                  <li className="gallery__item">
                    <img className="gallery__image" src={s.imagem13} alt="Image 12" />
                  </li>
                </ul>
              </div>
            </div>
