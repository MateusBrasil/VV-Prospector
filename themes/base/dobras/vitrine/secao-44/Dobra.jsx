"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-44
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* hirekit-cta: sin logica local; reveals desde /hirekit/scripts/animations.js. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-44" ref={raiz}>
      <section className="started_section"> <div className="section_wrapper"> <div className="container-large"> <div className="started_heading"> <div data-reveal="view"> <div className="badge w-variant-93892c57-1ab8-2863-c67c-6f87b0ee71fc"> <div className="text-sm">GET STARTED</div> </div> </div> <div className="max-heading is-48rem" data-reveal="view"> <h2 className="h1 text-color-on-primary">{s.titulo}</h2> </div> </div> <div className="spacer"> <div style={{height: '6rem'}} className="spacer-desktop"></div> <div style={{height: '6rem'}} className="spacer-tablet"></div> <div style={{height: '6rem'}} className="spacer-mobile"></div> </div> </div> <div className="started_loop-wrapper" data-reveal="view"> <div className="started_list-wrapper"> <div className="started_list"> <a href="/team/jake-miller" className="started_member w-inline-block"> <img src={s.imagem} loading="eager" decoding="async" alt="Jake Miller" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Human Resources</div> </div> <img src={s.imagem2} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/ethan-brooks" className="started_member w-inline-block"> <img src={s.imagem3} loading="eager" decoding="async" alt="Ethan Brooks" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>UI/UX Designer</div> </div> <img src={s.imagem4} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/chloe-adams" className="started_member w-inline-block"> <img src={s.imagem5} loading="eager" decoding="async" alt="Chloe Adams" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Accountant</div> </div> <img src={s.imagem6} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/maya-torres" className="started_member w-inline-block"> <img src={s.imagem7} loading="eager" decoding="async" alt="Maya Torres" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Brand Designer</div> </div> <img src={s.imagem8} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/ryan-parker" className="started_member w-inline-block"> <img src={s.imagem9} loading="eager" decoding="async" alt="Ryan Parker" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Social Media</div> </div> <img src={s.imagem10} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/cole-bennett" className="started_member w-inline-block"> <img src={s.imagem11} loading="eager" decoding="async" alt="Cole Bennett" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Developer</div> </div> <img src={s.imagem12} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/olivia-reed" className="started_member w-inline-block"> <img src={s.imagem13} loading="eager" decoding="async" alt="Olivia Reed" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Project Manager</div> </div> <img src={s.imagem14} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/ben-turner" className="started_member w-inline-block"> <img src={s.imagem15} loading="eager" decoding="async" alt="Ben Turner" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Quality Assurance</div> </div> <img src={s.imagem16} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a> </div> </div><div className="started_list-wrapper"> <div className="started_list"> <a href="/team/jake-miller" className="started_member w-inline-block"> <img src={s.imagem17} loading="eager" decoding="async" alt="Jake Miller" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Human Resources</div> </div> <img src={s.imagem18} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/ethan-brooks" className="started_member w-inline-block"> <img src={s.imagem19} loading="eager" decoding="async" alt="Ethan Brooks" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>UI/UX Designer</div> </div> <img src={s.imagem20} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/chloe-adams" className="started_member w-inline-block"> <img src={s.imagem21} loading="eager" decoding="async" alt="Chloe Adams" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Accountant</div> </div> <img src={s.imagem22} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/maya-torres" className="started_member w-inline-block"> <img src={s.imagem23} loading="eager" decoding="async" alt="Maya Torres" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Brand Designer</div> </div> <img src={s.imagem24} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/ryan-parker" className="started_member w-inline-block"> <img src={s.imagem25} loading="eager" decoding="async" alt="Ryan Parker" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Social Media</div> </div> <img src={s.imagem26} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/cole-bennett" className="started_member w-inline-block"> <img src={s.imagem27} loading="eager" decoding="async" alt="Cole Bennett" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Developer</div> </div> <img src={s.imagem28} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/olivia-reed" className="started_member w-inline-block"> <img src={s.imagem29} loading="eager" decoding="async" alt="Olivia Reed" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Project Manager</div> </div> <img src={s.imagem30} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a><a href="/team/ben-turner" className="started_member w-inline-block"> <img src={s.imagem31} loading="eager" decoding="async" alt="Ben Turner" className="img" /> <div className="member_content"> <div className="member_info"> <div className="member_circle"></div> <div>Quality Assurance</div> </div> <img src={s.imagem32} loading="eager" decoding="async" alt="" className="member_flag" /> </div> </a> </div> </div> </div> </div> </section>
    </section>
  );
}