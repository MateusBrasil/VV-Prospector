"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-168
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-168" ref={raiz}>
      <section className="section_team bg-primary"> <div className="padding-section-medium"></div> <div className="container-large"> <div className="w-layout-grid default-grid"> <div id="w-node-_8ce5e387-9910-6980-0f61-27c4b85a63af-fb62f1e5" className="member_title"> <div className="scroll-into-view"> <div className="section_tag w-variant-11063f80-6b7d-0c32-82a3-15d5a31bbce2">[ Our team ]</div> </div> <h2 animation="section-heading" className="text-color-on-primary text-style-allcaps">{s.titulo}</h2> </div> </div> <div className="spacer"> <div style={{height: '4rem'}} className="spacer-desktop"></div> <div style={{height: '3rem'}} className="spacer-tablet"></div> <div style={{height: '2rem'}} className="spacer-mobile"></div> </div> <div className="container-medium"> <div className="team_grid"> <div className="team_collection-wrapper"> <div className="member_card-wrapper is-three"> <a href="/member/james-vile" className="member_card scroll-into-view w-inline-block"> <div className="member_card-bg"><img loading="lazy" alt="James Vile" src={s.imagem} className="img" /></div> <div className="member_icon"> <img loading="lazy" alt="" src={s.imagem2} className="card-arrow is-one" /> <img loading="lazy" alt="" src={s.imagem3} className="card-arrow is-two" /> </div> <div className="member_info"> <div className="text-xl">James Vile</div> <div className="text-sm">CEO</div> </div> </a> </div> </div><div className="team_collection-wrapper"> <div className="member_card-wrapper"> <a href="/member/jaxson-botosh" className="member_card scroll-into-view w-inline-block"> <div className="member_card-bg"><img loading="lazy" alt="Jaxson Botosh" src={s.imagem4} className="img" /></div> <div className="member_icon"> <img loading="lazy" alt="" src={s.imagem5} className="card-arrow is-one" /> <img loading="lazy" alt="" src={s.imagem6} className="card-arrow is-two" /> </div> <div className="member_info"> <div className="text-xl">Jaxson Botosh</div> <div className="text-sm">CEO</div> </div> </a> </div> </div><div className="team_collection-wrapper"> <div className="member_card-wrapper is-two"> <a href="/member/marley-curtis" className="member_card scroll-into-view w-inline-block"> <div className="member_card-bg"><img loading="lazy" alt="Marley Curtis" src={s.imagem7} className="img" /></div> <div className="member_icon"> <img loading="lazy" alt="" src={s.imagem8} className="card-arrow is-one" /> <img loading="lazy" alt="" src={s.imagem9} className="card-arrow is-two" /> </div> <div className="member_info"> <div className="text-xl">Marley Curtis</div> <div className="text-sm">CEO</div> </div> </a> </div> </div> </div> </div> </div> <div className="padding-section-medium"></div> </section>
    </section>
  );
}