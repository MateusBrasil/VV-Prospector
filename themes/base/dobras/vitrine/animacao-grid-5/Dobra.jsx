"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes-de-grid/animacao-grid-5
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="vitrine-animacao-grid-5" ref={raiz}>
      <main>
      
            <div className="heading">
              <h2 className="heading__title">{s.titulo}</h2>
