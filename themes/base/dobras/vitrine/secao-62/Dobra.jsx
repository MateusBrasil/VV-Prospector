"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-62
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-62" ref={raiz}>
      <section className="section_about"> <div className="padding-section-large"></div> <div className="padding-global"> <div className="container-large"> <div> <div className="badge-wrapper"> <div animation="" className="badge w-variant-bbfb6a6c-d3ec-5a08-a531-cec36f932128"><img src={s.imagem} loading="lazy" alt="" className="badge_image" /> <div className="badge_text">about us</div> </div> </div> <div className="spacer-xlarge"></div> <h2 animation="large-heading" className="heading-large">{s.titulo}</h2> </div> <div className="spacer"> <div style={{height: '4rem'}} className="spacer-desktop"></div> <div style={{height: '3rem'}} className="spacer-tablet"></div> <div style={{height: '2rem'}} className="spacer-mobile"></div> </div> <div className="about_image"><img src={s.imagem2} loading="lazy" sizes="100vw" srcSet="https://d173woph5zl366.cloudfront.net/catalis/images/90b146ec1080897a348935ba2aeba926_about-img-p-500.avif 500w, https://d173woph5zl366.cloudfront.net/catalis/images/about-img.avif 752w" alt="Smiling man wearing sunglasses and a beige fleece jacket taking a selfie outdoors under a blue sky." className="img" /> <div className="about_image-card is-right"><img src={s.imagem3} loading="lazy" alt="" className="img" /></div> <div className="about_image-card is-left"><img src={s.imagem4} loading="lazy" alt="" className="img" /></div> </div> <div className="spacer"> <div style={{height: '4rem'}} className="spacer-desktop"></div> <div style={{height: '3rem'}} className="spacer-tablet"></div> <div style={{height: '2rem'}} className="spacer-mobile"></div> </div> <div className="grow-container"> <div className="about_stats-grid"> <div id="w-node-b5b3ed75-7622-d497-88ab-8ca6752035c1-752035ad" className="about_stat grow-element"> <div className="stat-display">80%</div> <div>Reduction in reporting time.</div> </div> <div className="about_stat grow-element"> <div className="stat-display">$70k</div> <div>Savings per month (approx)</div> </div> <div id="w-node-b5b3ed75-7622-d497-88ab-8ca6752035cb-752035ad" className="about_stat grow-element"> <div className="stat-display">99</div> <div>Increase in billing hours</div> </div> </div> </div> </div> </div> <div className="padding-section-large"></div> </section>
    </section>
  );
}