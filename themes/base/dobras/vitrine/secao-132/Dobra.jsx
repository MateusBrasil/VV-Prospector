"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-132
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // hirely-about-hero — no local logic. The LOAD entrance (SplitText h1 +
  //   // bounce-enter ladder + the `.about_visuals` portrait cluster sliding up) is driven
  //   // by /hirely/scripts/hero-enter.js; the navbar by navbar.js + navbar-scroll.js.
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-132" ref={raiz}>
              ...
              <div className="nav_container">
                <div className="navbar_content">
                  ...
                  <nav className="nav_group" aria-label="Primary">
                    ...
                    <a href="/about" aria-current="page" className="nav_links hide-tablet w-nav-link w--current">{s.acao2}</a>
                      ...
                      <div className="hamburger-nav">
                        ...
                        <div className="hamburger-nav__group">
                          ...
                          <ul className="hamburger-nav__ul">
                            ...
                            <li className="hamburger-nav__li">
                              <a href="/about" aria-current="page" className="hamburger-nav__a">
                ...
                <div className="container-large">
                  <div className="vertical-center">
                    <div className="about_heading">
                      ...
                      <div bounce-enter="description" className="text-color-on-dark">Our mission is to connect businesses with exceptional talent for lasting success.</div>
                  ...
                  <div className="spacer">
                    <div style={{height: '6.875rem'}} className="spacer-desktop"></div>
                    <div style={{height: '4.875rem'}} className="spacer-tablet"></div>
                    <div style={{height: '2.875rem'}} className="spacer-mobile"></div>
                  </div>
                  <div className="about_visuals">
                    <div className="about_img-wrap is-three">
                      <div className="about_img"><img src={s.imagem2} loading="lazy" alt="A smiling man and woman together, showcasing positive workplace relationships and successful hiring outcomes." className="img" /></div>
                    </div>
                    <div className="about_img-wrap is-two">
                      <div className="about_img"><img src={s.imagem3} loading="lazy" alt="Three formally dressed professionals standing together, representing a reliable and diverse hiring team." className="img" /></div>
                    </div>
                    <div className="about_img-wrap is-one">
                      <div className="about_img"><img src={s.imagem4} loading="lazy" alt="A casually dressed woman smiling, representing approachable talent and a friendly recruitment experience." className="img" /></div>
                    </div>
                  </div>
                </div>
              </div>
