"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-131
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // hirely-hero — no local logic. The LOAD entrance (SplitText h1 + bounce-enter
  //   // ladder + 4-bar image slide-in) is driven by /hirely/scripts/hero-enter.js; the
  //   // `.scroll-animation` reveals on the banner by /hirely/scripts/scroll-reveal.js;
  //   // the navbar by navbar.js + navbar-scroll.js; the `.loop` logo marquee is pure CSS
  //   // (in /hirely/styles.css). Stub kept for the 4-file convention.
  //   
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-131" ref={raiz}>
      <div className="page-wrapper">
              ...
              <div className="nav_container">
                <div className="navbar_content">
                  ...
                  <nav className="nav_group" aria-label="Primary">
                    <a href="/" aria-current="page" className="nav_links hide-tablet w-nav-link w--current">{s.acao}</a>
                    <a href="/about" className="nav_links hide-tablet w-nav-link">{s.acao2}</a>
                    <a href="/services" className="nav_links hide-tablet w-nav-link">{s.acao3}</a>
                        ...
                        <div className="hamburger-nav__group">
                          ...
                          <ul className="hamburger-nav__ul">
                            <li className="hamburger-nav__li">
                              <a href="/" aria-current="page" className="hamburger-nav__a">
          ...
          <main className="main-wrapper">
            <section className="section_hero-two bg-dark">
              <div className="padding-global">
                <div className="container-large">
                  <div className="hero-two_grid">
                    <div className="hero-two_left">
                      <div>
                        <div className="hero_header">
                          <h1 bounce-enter="h1" className="text-color-white">{s.titulo}</h1>
                          <div bounce-enter="hero-svg" className="hero-two_svg">
                            <img src={s.imagem2} loading="eager" alt="" />
                          </div>
                        </div>
                        <div className="spacer-medium"></div>
                        <div bounce-enter="description" className="text-color-on-dark">
                          LATAM’s brightest minds – your competitive edge at 70% off
                        </div>
                      ...
                      <div className="hero-two_stats">
                        <div bounce-enter="stats">
                          <div className="h3 text-color-white">300+</div>
                          <div className="text-color-on-dark">Corporate clients</div>
                        </div>
                        <div bounce-enter="stats">
                          <div className="h3 text-color-white">95%</div>
                          <div className="text-color-on-dark">Client satisfaction rate</div>
                        </div>
                      </div>
                    </div>
                    <div className="hero-two_right">
                      <div className="hero-two_bars">
                        <div className="hero-two_bar-top is-one">
                          <div className="hero-two_img">
                            <img src={s.imagem3} loading="eager" fetchpriority="high" decoding="async" alt="A casually dressed man smiling, reflecting an approachable candidate and a positive hiring experience." className="img" />
                          </div>
                        </div>
                        <div className="hero-two_bar-bottom is-three">
                          <div className="hero-two_img is-three">
                            <img src={s.imagem4} loading="eager" alt="A serious professionally dressed woman, conveying confidence and expertise in HR and recruitment decisions." className="img" />
                          </div>
                        </div>
                      </div>
                      <div className="hero-two_bars-right">
                        <div className="hero-two_bar-top is-two">
                          <div className="hero-two_img is-two">
                            <img src={s.imagem5} loading="eager" alt="A serious professionally dressed man with his hand on his chin, portraying strategic thinking and leadership in recruitment decisions." className="img" />
                          </div>
                        </div>
                        <div className="hero-two_bar-bottom is-four">
                          <div className="hero-two_img is-four">
                            <img src={s.imagem6} loading="eager" alt="A casually dressed man smiling, reflecting an approachable candidate and a positive hiring experience." className="img" />
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div data-wf--hero-banner--variant="base" className="hero_banner">
