"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-15
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-15" ref={raiz}>
      <section className="section_pricing"> <div className="padding-box"> <div className="pricing_wrap"> <div className="padding-section-large"></div> <div className="container-medium"> <div> <div className="badge-wrapper"> <div animation="" className="badge w-variant-bbfb6a6c-d3ec-5a08-a531-cec36f932128"><img src={s.imagem} loading="lazy" alt="" className="badge_image" /> <div className="badge_text">PRICING</div> </div> </div> <div className="spacer-xlarge"></div> <h2 animation="large-heading" className="text-color-on-primary text-align-center">Simple, transparent <em>pricing</em></h2> <div className="spacer-xlarge"></div> <div className="text-color-on-primary text-align-center scroll-into-view">Choose a plan that fits your business needs and budget.</div> <div className="spacer"> <div style={{height: '4rem'}} className="spacer-desktop"></div> <div style={{height: '3rem'}} className="spacer-tablet"></div> <div style={{height: '2rem'}} className="spacer-mobile"></div> </div> </div> <div className="pricing_grid grow-container"> <div className="grow-element mobile-width"> <div className="pricing_card"> <div className="pricing_plan"> <div className="pricing_icon-wrap"><img loading="lazy" src={s.imagem2} alt="" className="icon-1x1-large" /></div> <h3 className="text-2xl">{s.subtitulo}</h3> </div> <div className="pricing_card-price"> <div className="h6">$50.00</div> <div className="price-text">/month</div> </div> <div> <div className="text-xl">Features:</div> <div className="spacer-medium"></div> <div className="features_list"> <div className="features_item"><img loading="lazy" src={s.imagem3} alt="" className="icon-1x1-main" /> <div>Basic financial analytics tools</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem4} alt="" className="icon-1x1-main" /> <div>Up to 3 user accounts</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem5} alt="" className="icon-1x1-main" /> <div>Real-time exchange rate monitoring</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem6} alt="" className="icon-1x1-main" /> <div>Monthly financial reports</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem7} alt="" className="icon-1x1-main" /> <div>Email support</div> </div> </div> </div> <div className="margin-top-auto"> <a animation="" href="/pricing" className="button_component w-inline-block"> <div className="button_content"> <div className="button_text is-one">Get Started</div> <div className="button_text is-two">Get Started</div> </div> </a> </div> </div> </div> <div className="grow-element mobile-width"> <div className="pricing_card grow-element"> <div className="pricing_plan"> <div className="pricing_icon-wrap"><img loading="lazy" src={s.imagem8} alt="" className="icon-1x1-large" /></div> <h3 className="text-2xl">{s.subtitulo2}</h3> </div> <div className="pricing_card-price"> <div className="h6">$90.00</div> <div className="price-text">/month</div> </div> <div> <div className="text-xl">Features:</div> <div className="spacer-medium"></div> <div className="features_list"> <div className="features_item"><img loading="lazy" src={s.imagem9} alt="" className="icon-1x1-main" /> <div>Advanced financial analytics tools</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem10} alt="" className="icon-1x1-main" /> <div>Up to 10 user accounts</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem11} alt="" className="icon-1x1-main" /> <div>Real-time exchange rate monitoring</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem12} alt="" className="icon-1x1-main" /> <div>Custom monthly financial reports</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem13} alt="" className="icon-1x1-main" /> <div>Priority email support</div> </div> </div> </div> <div className="margin-top-auto"> <a animation="" href="/pricing" className="button_component w-inline-block"> <div className="button_content"> <div className="button_text is-one">Get Started</div> <div className="button_text is-two">Get Started</div> </div> </a> </div> </div> </div> <div id="w-node-_7ea76096-2b92-3c39-3664-a66fc8fa3ebf-c9fc1811" className="grow-element mobile-width"> <div className="pricing_card"> <div className="pricing_plan"> <div className="pricing_icon-wrap"><img loading="lazy" src={s.imagem14} alt="" className="icon-1x1-large" /></div> <h3 className="text-2xl">{s.subtitulo3}</h3> </div> <div className="pricing_card-price"> <div className="h6">$150.00</div> <div className="price-text">/month</div> </div> <div> <div className="text-xl">Features:</div> <div className="spacer-medium"></div> <div className="features_list"> <div className="features_item"><img loading="lazy" src={s.imagem15} alt="" className="icon-1x1-main" /> <div>Advanced analytics with forecasting tools</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem16} alt="" className="icon-1x1-main" /> <div>Unlimited user accounts</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem17} alt="" className="icon-1x1-main" /> <div>Real-time exchange rate monitoring with alerts</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem18} alt="" className="icon-1x1-main" /> <div>Custom and exportable financial reports</div> </div> <div className="features_item"><img loading="lazy" src={s.imagem19} alt="" className="icon-1x1-main" /> <div>Dedicated support via email and chat</div> </div> </div> </div> <div className="margin-top-auto"> <a animation="" href="/pricing" className="button_component w-inline-block"> <div className="button_content"> <div className="button_text is-one">Get Started</div> <div className="button_text is-two">Get Started</div> </div> </a> </div> </div> </div> </div> </div> </div> </div> </section>
    </section>
  );
}