"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-5
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  //      - reveals [data-reveal] vía GSAP + ScrollTrigger (heading [hero="heading"] +
  //        descripción [hero="description"] + cada card y bloque de info de la grilla)
  //      - .img-parallax → desplazamiento parallax de las imágenes de cada proyecto al
  //        hacer scroll. No se registra GSAP aquí: lo hace el motor compartido. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-5" ref={raiz}>
      <div className="page-wrapper">
          <main className="main-wrapper">
      
            <section className="section_projects-main bg-primary">
              <div className="padding-global">
                <div className="container-large">
                  <div className="text-align-center">
                    <div className="max-heading is-64rem align-center">
                      <h1 hero="heading" className="text-6xl text-color-on-primary">{s.titulo}</h1>
                    </div>
                    <div className="spacer-xlarge"></div>
                    <div className="max-description is-37rem align-center">
                      <div hero="description" className="text-color-subtle">
                        We are passionate about creating inspiring, captivating and long-lasting spaces that
                        adapt. aptivating and long-lasting spaces that adapt.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-dyn-list">
                    <div role="list" className="projects_grid w-dyn-items">
      
                      <div role="listitem" className="w-dyn-item" data-reveal="">
                        <a data-wf--project-card--variant="base" href="/projects/modern-office-design" className="project-wrapper w-inline-block">
                          <div className="project_blog-img" data-reveal="">
                            <img loading="lazy" src={s.imagem} alt="Minimalist luxury in a modern loft." className="img-parallax" />
                          </div>
                          ...
                          <div data-reveal="">
                            <div className="project_info">
                              <div className="text-color-subtle">Location</div>
                              <div className="text-color-on-primary">Chicago, Illinois, United Stated</div>
                            </div>
                            <div className="spacer-large"></div>
                            <div className="project_info">
                              <div className="text-color-subtle">Type of Work:</div>
                              <div className="text-color-on-primary">Residencial</div>
                            </div>
                          </div>
                        </a>
                      </div>
                      ...
                      <div role="listitem" className="w-dyn-item" data-reveal="">
                        <a data-wf--project-card--variant="base" href="/projects/modern-loft-design" className="project-wrapper w-inline-block">
                          <div className="project_blog-img" data-reveal="">
                            <img loading="lazy" src={s.imagem2} alt="Minimalist luxury in a modern loft." className="img-parallax" />
                          </div>
                          <div className="spacer-medium"></div>
                          <div data-reveal="">
                      ...
                      <div role="listitem" className="w-dyn-item" data-reveal="">
                        <a data-wf--project-card--variant="base" href="/projects/modern-loft-design-2" className="project-wrapper w-inline-block">
                          <div className="project_blog-img" data-reveal="">
                            <img loading="lazy" src={s.imagem3} alt="Minimalist luxury in a modern loft." className="img-parallax" />
                          </div>
                          <div className="spacer-medium"></div>
                          <div data-reveal="">
                            <div>Modern Loft Design</div>
                      ...
                      <div role="listitem" className="w-dyn-item" data-reveal="">
                        <a data-wf--project-card--variant="base" href="/projects/modern-loft-design-3" className="project-wrapper w-inline-block">
                          <div className="project_blog-img" data-reveal="">
                            <img loading="lazy" src={s.imagem4} alt="Minimalist luxury in a modern loft." className="img-parallax" />
                          </div>
                          <div className="spacer-medium"></div>
                          <div data-reveal="">
                            <div>Modern Loft Design</div>
