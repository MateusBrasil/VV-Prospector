"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-8
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // luzen-projects-showcase — no local logic. The shared motion runner
  //   // /luzen/scripts/animations.js handles everything this section uses:
  //   //   - [data-reveal] heading / number / description / CTA / project titles
  //   //   - .img-appear image-mask entrance on each .project_img
  //   //   - .img-parallax scroll parallax on each card image
  //   // plus removing the 'wf-anim' FOUC gate once GSAP boots.
  //   // Stub kept for the 4-file convention; add JS here only for behavior the
  //   // shared engine does not cover.
  //   
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-8" ref={raiz}>
      <div className="page-wrapper">
          <main className="main-wrapper">
      
            <section className="section_projects bg-primary">
              <div className="padding-section-small"></div>
              <div className="padding-global">
                <div className="container-large">
                  <div>
                    <div className="heading-projects">
                      <div className="max-heading is-40rem">
                        <div className="text-5xl" data-reveal="">
                          Expert guidance and solutions for your project stages
                        </div>
                      </div>
                      <div className="heading_number is-projects" data-reveal="">
                        <div>Projects</div>
                    ...
                    <div className="projects_cta">
                      <div className="max-description is-26rem">
                        <div data-reveal="">
                      ...
                      <div data-reveal="">
                        <a href="/projects" className="button w-variant-9b956ad1-29f0-1dd9-1d2c-2f0e6a9b956a w-inline-block">
                    ...
                    <div className="spacer">
                      <div style={{height: '4.5rem'}} className="spacer-desktop"></div>
                      <div style={{height: '4.5rem'}} className="spacer-tablet"></div>
                      <div style={{height: '2rem'}} className="spacer-mobile"></div>
                    </div>
                    <div className="projects_list">
                      <div className="projects_list-top">
      
                        
                        <div className="projects_list-item is-one w-dyn-list">
                          <div role="list" className="w-dyn-items">
                            <div role="listitem" className="w-dyn-item">
                              <div className="project_card">
                                <div className="project_img is-one img-appear">
                                  <img src={s.imagem} loading="lazy" alt="Modern Office Design" className="img-parallax" />
                                  <div className="img-wrap is-dark"></div>
                                </div>
                                <div className="project_title" data-reveal="">
                                  <div>Modern Office Design</div>
                                  <div className="clip">
                                    <a href="/projects/modern-office-design" className="project_link">{s.acao}</a>
                        ...
                        <div className="projects_list-item is-two w-dyn-list">
                          <div role="list" className="w-dyn-items">
                            <div role="listitem" className="w-dyn-item">
                              <div className="project_card">
                                <div className="project_img is-two img-appear">
                                  <img src={s.imagem2} loading="lazy" alt="Modern Loft Design" className="img-parallax" />
                                  <div className="img-wrap is-dark"></div>
                                </div>
                                <div className="project_title" data-reveal="">
                                  <div>Modern Loft Design</div>
                                  <div className="clip">
                                    <a href="/projects/modern-loft-design" className="project_link">{s.acao2}</a>
                                    <div className="link-line"></div>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div className="spacer">
                        <div style={{paddingTop: '8%'}} className="spacer-desktop"></div>
                        <div style={{paddingTop: '8%'}} className="spacer-tablet"></div>
                        <div style={{paddingTop: '8%'}} className="spacer-mobile"></div>
                      </div>
                      <div className="project_list-bottom">
      
                        
                        <div className="projects_list-item is-three w-dyn-list">
                          <div role="list" className="w-dyn-items">
                            <div role="listitem" className="w-dyn-item">
                              <div className="project_card">
                                <div className="project_img is-three img-appear">
                                  <img src={s.imagem3} loading="lazy" alt="Modern Loft Design" className="img-parallax" />
                                  <div className="img-wrap is-dark"></div>
                                </div>
                                <div className="project_title" data-reveal="">
                                  <div>Modern Loft Design</div>
                                  <div className="clip">
                                    <a href="/projects/modern-loft-design-2" className="project_link">{s.acao3}</a>
                                    <div className="link-line"></div>
                                  </div>
                                </div>
                              </div>
                        ...
                        <div className="projects_list-item is-four w-dyn-list">
                          <div role="list" className="w-dyn-items">
                            <div role="listitem" className="w-dyn-item">
                              <div className="project_card">
                                <div className="project_img is-four img-appear">
                                  <img src={s.imagem4} loading="lazy" alt="Modern Loft Design" className="img-parallax" />
                                  <div className="img-wrap is-dark"></div>
                                </div>
                                <div className="project_title" data-reveal="">
                                  <div>Modern Loft Design</div>
                                  <div className="clip">
                                    <a href="/projects/modern-loft-design-3" className="project_link">{s.acao4}</a>
                                    <div className="link-line"></div>
                                  </div>
                                </div>
                              </div>
