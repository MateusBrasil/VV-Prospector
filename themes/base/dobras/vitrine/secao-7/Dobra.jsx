"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-7
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* Luzen — Services Projects
  //      Sin lógica local. Las animaciones corren desde /luzen/scripts/animations.js:
  //      - reveals [data-reveal] vía GSAP + ScrollTrigger (el .project_title de cada
  //        una de las 3 tarjetas al entrar al viewport)
  //      - .img-appear → aparición de cada imagen; .img-parallax → su desplazamiento
  //        parallax ligado al scroll. No se registra GSAP aquí: lo hace el motor
  //        compartido. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="vitrine-secao-7" ref={raiz}>
      <div className="page-wrapper">
          <main className="main-wrapper">
      
            <section className="section_serv-projects bg-default">
              <div className="padding-section-small"></div>
              <div className="padding-global">
                <div className="container-large">
                  <div className="projects_container">
                    <div className="services_projects is-one w-dyn-list">
                      <div role="list" className="w-dyn-items">
                        <div role="listitem" className="w-dyn-item">
                          <div className="project_card">
                            <div className="project_image is-one img-appear">
                              <img src={s.imagem} loading="lazy" alt="Minimalist luxury in a modern loft." className="img-parallax" />
                    ...
                    </div><div className="services_projects is-two w-dyn-list">
                      <div role="list" className="w-dyn-items">
                        <div role="listitem" className="w-dyn-item">
                          <div className="project_card">
                            <div className="project_image is-one img-appear">
                              <img src={s.imagem2} loading="lazy" alt="Minimalist luxury in a modern loft." className="img-parallax" />
                              <div className="img-wrap"></div>
                            </div>
                            <div className="project_title" data-reveal="">
                    ...
                    </div><div className="services_projects is-three w-dyn-list">
                      <div role="list" className="w-dyn-items">
                        <div role="listitem" className="w-dyn-item">
                          <div className="project_card">
                            <div className="project_image is-one img-appear">
                              <img src={s.imagem3} loading="lazy" alt="Minimalist luxury in a modern loft." className="img-parallax" />
                              <div className="img-wrap"></div>
                            </div>
                            <div className="project_title" data-reveal="">
                              <div>Modern Loft Design</div>
              ...
              <img src={s.imagem4} loading="lazy" alt="" className="image" />
              <div className="padding-section-small"></div>
            </section>
