"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/animacoes-de-grid/animacao-grid-1
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  //         Oc("snap", jb)
  //       ) || Re;
  //     (te.version = Zt.version = Fe.version = "3.14.1"), (o = 1), x() && Lt();
  //     function yd(t, e) {
  ...
  // }, []);
  return (
    <section className="dobra" data-dobra="vitrine-animacao-grid-1" ref={raiz}>
      <main>
          <header className="frame">
            <nav className="frame__demos">
              <span className="button selected">{s.rotulo}</span>
              <a href="index2.html" className="button">{s.acao}</a>
            </nav>
            <nav className="options_grid_container">
              <div className="configuration_grid_size">
                <button data-size="50%" onClick={s.onClick}>{s.acao2}</button>
                <button className="active" data-size="75%" onClick={s.onClick}>{s.acao3}</button>
                <button data-size="100%" onClick={s.onClick}>{s.acao4}</button>
                <button data-size="125%" onClick={s.onClick}>{s.acao5}</button>
                <button data-size="150%" onClick={s.onClick}>{s.acao6}</button>
              </div>
            </nav>
          </header>
          <div className="content">
            <section
                     className="grid_gallery_container"
                     id="grid-gallery"
                     data-size-grid="75%">
              <div className="grid_gallery_item" style={{'-AspectRatio': '1 / 1'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem})`}}></div>
                <p>01</p>
              </div>
      
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 5'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem2})`}}></div>
                <p>02</p>
              </div>
      
              <div className="grid_gallery_item" style={{'-AspectRatio': '16 / 9'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem3})`}}></div>
                <p>03</p>
              </div>
      
              <div className="grid_gallery_item" style={{'-AspectRatio': '3 / 4'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem4})`}}></div>
                <p>04</p>
              </div>
      
              <div className="grid_gallery_item" style={{'-AspectRatio': '5 / 4'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem5})`}}></div>
                <p>05</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '1 / 1'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem6})`}}></div>
                <p>06</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 5'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem7})`}}></div>
                <p>07</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '1 / 1'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem8})`}}></div>
                <p>08</p>
              </div>
      
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 3'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem9})`}}></div>
                <p>09</p>
              </div>
      
              <div className="grid_gallery_item" style={{'-AspectRatio': '5 / 7'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem10})`}}></div>
                <p>10</p>
              </div>
      
              <div className="grid_gallery_item" style={{'-AspectRatio': '3 / 2'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem11})`}}></div>
                <p>11</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '1 / 1'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem12})`}}></div>
                <p>12</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '16 / 9'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem13})`}}></div>
                <p>13</p>
              </div>
      
              <div className="grid_gallery_item" style={{'-AspectRatio': '5 / 3'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem14})`}}></div>
                <p>14</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 5'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem15})`}}></div>
                <p>15</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '1 / 1'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem16})`}}></div>
                <p>16</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '3 / 4'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem17})`}}></div>
                <p>17</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '1 / 1'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem18})`}}></div>
                <p>18</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '5 / 7'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem19})`}}></div>
                <p>19</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 3'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem20})`}}></div>
                <p>20</p>
              </div>
              ...
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 5'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem21})`}}></div>
                <p>21</p>
              </div>
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 5'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem22})`}}></div>
                <p>22</p>
              </div>
              <div className="grid_gallery_item" style={{'-AspectRatio': '1 / 1'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem23})`}}></div>
                <p>23</p>
              </div>
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 5'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem24})`}}></div>
                <p>24</p>
              </div>
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 3'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem25})`}}></div>
                <p>25</p>
              </div>
              <div className="grid_gallery_item" style={{'-AspectRatio': '1 / 1'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem26})`}}></div>
                <p>26</p>
              </div>
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 5'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem27})`}}></div>
                <p>27</p>
              </div>
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 5'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem28})`}}></div>
                <p>28</p>
              </div>
              <div className="grid_gallery_item" style={{'-AspectRatio': '4 / 5'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem29})`}}></div>
                <p>29</p>
              </div>
              <div className="grid_gallery_item" style={{'-AspectRatio': '6 / 5'}}>
                <div
                     className="image"
                     style={{backgroundImage: `url(${s.imagem30})`}}></div>
                <p>30</p>
              </div>
            </section>
          </div>
