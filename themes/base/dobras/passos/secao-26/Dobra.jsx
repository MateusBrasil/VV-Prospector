"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-26
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="passos-secao-26" ref={raiz}>
      <div className="page-wrapper">
          <main className="main-wrapper">
            <section className="section_faq bg-default">
              <div className="padding-section-large"></div>
              <div className="padding-global">
                <div className="container-large">
                  <div className="faq_grid">
                    <div className="faq_grid-left">
                      <div className="faq_img img-appear">
                        <img src={s.imagem} loading="lazy" alt="A modern living room featuring two large windows, minimalist design, and warm wooden floors and furniture, highlighting a seamless blend of comfort and architectural elegance." className="img-parallax" />
                    ...
                    <div className="faq_layout">
                      ...
                      <div className="faq_list">
                        <details className="accordion scroll-into-view" data-reveal="" open="">
                          <summary className="accordion_top">
                            <h3 className="text-xl">{s.subtitulo}</h3>
                          ...
                          <div className="accordion_bottom">
                            <div className="text-color-secondary">We offer a comprehensive range of services designed to meet your specific needs. Our expertise includes architectural design, interior design, project management, and consultation. Whether you're starting a new project or enhancing an existing one, our team is here to guide you through every step, ensuring innovative solutions and exceptional results.</div>
                            <div className="spacer-xlarge"></div>
                          </div>
                        </details>
                        <details className="accordion scroll-into-view" data-reveal="">
                          <summary className="accordion_top">
                            <h3 className="text-xl">{s.subtitulo2}</h3>
                            <div className="accordion_icon">
                              <div className="line-horizontal"></div>
                              <div className="line-vertical"></div>
                            </div>
                        ...
                        <details className="accordion scroll-into-view" data-reveal="">
                          <summary className="accordion_top">
                            <h3 className="text-xl">{s.subtitulo3}</h3>
                            <div className="accordion_icon">
                              <div className="line-horizontal"></div>
                              <div className="line-vertical"></div>
                            </div>
                        ...
                        <details className="accordion scroll-into-view" data-reveal="">
                          <summary className="accordion_top">
                            <h3 className="text-xl">{s.subtitulo4}</h3>
                            <div className="accordion_icon">
                              <div className="line-horizontal"></div>
                              <div className="line-vertical"></div>
                            </div>
