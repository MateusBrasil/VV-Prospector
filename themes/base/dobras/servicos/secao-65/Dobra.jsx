"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-65
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="servicos-secao-65" ref={raiz}>
                ...
                <div className="about_layout">
                  <div className="about_left">
                    <div className="scroll-into-view">
                      <div className="section_title w-variant-dbb4a0a6-0c21-a050-cfd8-50437556227c">
                        <div className="title-dot bg-neon w-variant-dbb4a0a6-0c21-a050-cfd8-50437556227c"></div>
                        <div>ABOUT US</div>
                      </div>
                    </div>
                    <div className="scroll-into-view">
                      <div className="max-heading is-52rem">
                        <h2 className="h3">{s.titulo}</h2>
                      </div>
                      <div className="spacer-medium"></div>
                      <div className="max-description is-32rem">
                        <div>We bring strategic clarity, actionable insights, and modern processes to help you validate, launch, and scale products with confidence.</div>
                      </div>
                    </div>
                    <div className="button-wrap">
                      <a href="/about" className="button_component w-inline-block">
                  ...
                  <div className="performance_card-wrapper scroll-into-view">
                    <div className="performance_card">
                      <div className="performance_card-top">
                        <h3 className="h6">{s.subtitulo}</h3>
                        <div className="text-sm text-color-secondary">In the past 7 days</div>
                      </div>
                      <div className="performance_stat-wrap">
                        <div className="performance_stat">
                          <div className="performance_stat-text">49%</div>
                          <div className="performance_stat-badge">
                            <div className="text-xs">+2.5%</div>
                          </div>
                        </div>
                        <div className="text-xs text-color-subtle">Business growth</div>
                      </div>
                      <div className="performance_loop-wrapper">
                        <div className="performance_loop-row">
                          <div className="performance_loop">
                            <div className="performance_loop-item"><div className="performance_loop-text"><div>Professional</div></div></div>
                            <div className="performance_loop-item"><div className="performance_loop-text"><div>Startup Feel</div></div></div>
                            <div className="performance_loop-item"><div className="performance_loop-text"><div>Strategic</div></div></div>
                            <div className="performance_loop-item"><div className="performance_loop-text"><div>AI-Focused</div></div></div>
                            <div className="performance_loop-item"><div className="performance_loop-text"><div>Professional</div></div></div>
                            <div className="performance_loop-item"><div className="performance_loop-text"><div>Startup Feel</div></div></div>
                            <div className="performance_loop-item"><div className="performance_loop-text"><div>Strategic</div></div></div>
                            <div className="performance_loop-item"><div className="performance_loop-text"><div>AI-Focused</div></div></div>
