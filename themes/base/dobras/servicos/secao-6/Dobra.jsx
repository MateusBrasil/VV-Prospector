"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-6
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* Genovas — Cases Section
  //    *
  //    * No component-specific JS. All motion is driven by the shared
  //    * /genovas/scripts/scroll-reveal.js classic script:
  //    *   - auto-reveal (fade + blur) for .cases-text and .cases_visual
  //    *   - a-25 image reveal (scale 1.5 -> 1, blur 10 -> 0) on .img-wrapper .img
  //    *   - a-62 rotate (0deg -> 120deg) on .cases_img.is-three
  //    * It self-initializes on DOM ready and sets the hidden start state itself,
  //    * so content stays visible if GSAP fails to load.
  //    */
  //   
  //   /**
  ...
  return (
    <section className="dobra" data-dobra="servicos-secao-6" ref={raiz}>
      <div className="page-wrapper">
          <main>
            <section className="section_cases">
              <div className="padding-global">
                <div className="cases_wrapper">
                  <div className="container-box is-grey is-three">
                    <div className="main_header-left is-left">
                      <h2 className="heading-style-h1">{s.titulo}</h2>
                      <div className="text-base text-color-secondary">
                        Explore the milestones, partnerships, and innovations that define our work in biotechnology.
                      </div>
                    </div>
                  </div>
                  <div className="cases_content is-home-three">
                    <div className="cases_card is-three">
                      <div className="cases-text">
                        Streamlined R&amp;D for BioInnovate: Reduced development timelines by 30%.
                      </div>
                      <img src={s.imagem} loading="lazy" alt="" className="cases_img is-three" />
                    </div>
                    <div className="cases_visual is-three">
                      <div className="img-wrapper">
                        <img src={s.imagem2} loading="lazy" sizes="100vw" alt="" className="img" />
                      </div>
                    </div>
                  </div>
                </div>
