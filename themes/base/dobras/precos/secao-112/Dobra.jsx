"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-112
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // upmind-hero — classic script (no import/export).
  //   // All behavior (hero reveal, floating badges, navbar, button hover, video
  //   // background) is handled by the shared scripts loaded from /upmind/scripts/.
  ...
  return (
    <section className="dobra" data-dobra="precos-secao-112" ref={raiz}>
      <div className="page-wrapper">
              ...
              <div className="container-large">
                <div className="navbar_content ">
                  <a href="/" aria-label="Upmind, home" className="navbar_logo-link w-nav-brand">
                    <img loading="lazy" src={s.imagem2} alt="" className="navbar_logo" />
                  </a>
          ...
          <section className="section_home is-one">
            <div className="padding-global">
              <div className="container-large">
                <div className="hero_content">
                  <div className="hero_heading">
                    <div className="max-heading is-50rem">
                      <h1 className="h2">{s.titulo}</h1>
                    </div>
                    <div className="max-description is-31rem">
                      <div>We help startups and growing teams validate ideas, scale products, and make data-driven decisions.</div>
                    </div>
                  </div>
                  <div className="hero_buttons">
                    <a href="/services" className="button_component w-variant-4771ba7a-d8bc-06b7-c18e-ec0cf74ea13c w-inline-block">
                      <div className="button_mask">
                        <div className="button_text w-variant-4771ba7a-d8bc-06b7-c18e-ec0cf74ea13c">View Demo</div>
                      </div>
                    </a>
                    <a href="/contact" className="button_component w-variant-62c86aa8-15d0-dc6b-786e-c05471c0a18d w-inline-block">
                      <div className="button_mask">
                        <div className="button_text w-variant-62c86aa8-15d0-dc6b-786e-c05471c0a18d">Book a Call</div>
                      </div>
                    </a>
                  </div>
                  <div className="hero_badge-wrap is-three" data-float="down">
                    <div className="hero_badge">
                      <div className="hero_badge-icon w-variant-7288e8bb-3980-fc03-d3d3-58472631214a"><img src={s.imagem3} loading="lazy" alt="" width="16" height="16" className="badge_icon" /></div>
                      <div className="badge_text w-variant-7288e8bb-3980-fc03-d3d3-58472631214a">Startup Feel</div>
                    </div>
                  </div>
                  <div className="hero_badge-wrap is-two" data-float="up">
                    <div className="hero_badge">
                      <div className="hero_badge-icon w-variant-dbec6776-3b9a-0984-68d7-e028ca9d439a"><img src={s.imagem4} loading="lazy" alt="" width="16" height="16" className="badge_icon" /></div>
                      <div className="badge_text w-variant-dbec6776-3b9a-0984-68d7-e028ca9d439a">Professional</div>
                    </div>
                  </div>
                  <div className="hero_badge-wrap is-one" data-float="down">
                    <div className="hero_badge">
                      <div className="hero_badge-icon"><img src={s.imagem5} loading="lazy" alt="" width="16" height="16" className="badge_icon" /></div>
                      <div className="badge_text">Strategic</div>
                    </div>
                  </div>
                  <div className="hero_badge-wrap is-five" data-float="up">
                    <div className="hero_badge w-variant-abd75cb7-f1bf-f22b-f94b-fc0d61545309">
                      <div className="hero_badge-icon w-variant-abd75cb7-f1bf-f22b-f94b-fc0d61545309"><img src={s.imagem6} loading="lazy" alt="" width="16" height="16" className="badge_icon" /></div>
                      <div className="badge_text w-variant-abd75cb7-f1bf-f22b-f94b-fc0d61545309">Build Smart</div>
                    </div>
                  </div>
                  <div className="hero_badge-wrap is-four" data-float="down">
                    <div className="hero_badge">
                      <div className="hero_badge-icon w-variant-94cc4296-fdde-1ca5-7744-167bb3a7206c"><img src={s.imagem7} loading="lazy" alt="" width="16" height="16" className="badge_icon" /></div>
                      <div className="badge_text w-variant-94cc4296-fdde-1ca5-7744-167bb3a7206c">Grow Faster</div>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div className="home_background-wrapper">
              <div data-poster-url="/upmind/videos/asdsa_poster.0000000.jpg" data-video-urls="/upmind/videos/asdsa_mp4.mp4,/upmind/videos/asdsa_webm.webm" data-autoplay="true" data-loop="true" data-wf-ignore="true" className="home-hero_video hide-tablet w-background-video w-background-video-atom">
                <video id="14659115-c6e6-1dd5-4df7-7ecef8c22bcc-video" autoPlay="" loop="" style={{backgroundImage: `url(${s.imagem})`}} muted="" playsinline="" data-wf-ignore="true" data-object-fit="cover">
                  <source src={s.video} data-wf-ignore="true" />
                  <source src={s.video2} data-wf-ignore="true" />
                </video>
              </div>
            </div>
          </section>
