"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-82
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* catalis-contact: sin logica local; reveals desde /catalis/scripts/. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="precos-secao-82" ref={raiz}>
      <div className="navbar w-nav" data-collapse="medium" role="banner"> <div className="nav_space w-variant-8c597988-44c6-1ef4-a09b-e4eee5012188"></div> <div className="padding-global is-navbar"> <div className="container-large is-navbar w-variant-8c597988-44c6-1ef4-a09b-e4eee5012188"> <div className="navbar_content w-variant-8c597988-44c6-1ef4-a09b-e4eee5012188"> <a href="/" aria-label="Catalis home" data-nav-item="" className="navbar_logo-link w-nav-brand"> <img loading="eager" width="36" height="36" src={s.imagem} alt="Catalis" className="navbar_logo" /> </a> <div className="nav_wrap"> <nav role="navigation" className="nav_mobile w-nav-menu"> <div className="navbar_list w-variant-8c597988-44c6-1ef4-a09b-e4eee5012188"> <a href="/about" data-nav-item="" className="nav_links w-nav-link">{s.acao}</a><a href="/features" data-nav-item="" className="nav_links w-nav-link">{s.acao2}</a><a href="/pricing" data-nav-item="" className="nav_links w-nav-link">{s.acao3}</a><a href="/blog" data-nav-item="" className="nav_links w-nav-link">{s.acao4}</a> </div> </nav> </div> <div className="nav_buttons-wrap"> <div className="login-wrap hide-mobile-landscape"> <a href="/contact" data-nav-item="" className="button_component w-inline-block"> <div className="button_content"> <div className="button_text is-one">Contact</div> <div className="button_text is-two">Contact</div> </div> </a> </div> <div className="hamburger-anchor" data-nav-item=""> <div className="hamburger-nav"> <div className="hamburger-nav__bg" aria-hidden="true"></div> <div className="hamburger-nav__group"> <p className="hamburger-nav__menu-p">{s.texto}</p> <ul className="hamburger-nav__ul"> <li className="hamburger-nav__li"> <a href="/about" className="hamburger-nav__a"> <p className="hamburger-nav__p">{s.texto2}</p> <div className="hamburger-nav__dot" aria-hidden="true"></div> </a> </li><li className="hamburger-nav__li"> <a href="/features" className="hamburger-nav__a"> <p className="hamburger-nav__p">{s.texto3}</p> <div className="hamburger-nav__dot" aria-hidden="true"></div> </a> </li><li className="hamburger-nav__li"> <a href="/pricing" className="hamburger-nav__a"> <p className="hamburger-nav__p">{s.texto4}</p> <div className="hamburger-nav__dot" aria-hidden="true"></div> </a> </li><li className="hamburger-nav__li"> <a href="/blog" className="hamburger-nav__a"> <p className="hamburger-nav__p">{s.texto5}</p> <div className="hamburger-nav__dot" aria-hidden="true"></div> </a> </li> <li className="hamburger-nav__li hamburger-nav__li-contact"> <a href="/contact" aria-current="page" className="hamburger-nav__a"> <p className="hamburger-nav__p">{s.texto6}</p> <div className="hamburger-nav__dot" aria-hidden="true"></div> </a> </li> </ul> </div> <button type="button" data-navigation-toggle="toggle" aria-label="Toggle menu" aria-expanded="false" className="hamburger-nav__toggle" onClick={s.onClick}> <div className="hamburger-nav__toggle-bar"></div> <div className="hamburger-nav__toggle-bar"></div> </button> </div> </div> </div> <img src={s.imagem2} loading="lazy" alt="" className="corner-left" /> <img src={s.imagem3} loading="lazy" alt="" className="corner-right" /> </div> </div> </div> </div>
        <div data-navigation-toggle="close" className="navigation__dark-bg" aria-hidden="true"></div>
      <section className="section_contact"> <div className="padding-section-large"></div> <div className="padding-global"> <div className="container-small"> <div> <div className="badge-wrapper"> <div animation="badge" className="badge is-secondary"><img src={s.imagem4} loading="lazy" alt="" className="badge_image is-secondary" /> <div className="badge_text is-secondary">Contact us</div> </div> </div> <div className="spacer-medium"></div> <div className="max-description is-45rem align-center"> <h1 animation="heading" className="text-align-center">Get in <em>touch</em></h1> </div> <div className="spacer-medium"></div> <div className="max-description is-38rem align-center"> <div animation="description" className="text-color-secondary text-align-center">Stay informed with the latest health and wellness insights from our experts.</div> </div> <div className="spacer-xhuge"></div> <div animation="contact-form" className="overflow-hidden"> <div className="contact_form-wrapper w-form"> <form id="contact-form" name="contact-form" data-name="contact form" method="post" onsubmit="this.style.display='none';this.parentNode.querySelector('.w-form-done').style.display='block';return false;" className="contact_form"> <div className="form_field-wrapper"><label htmlFor="name" className="form_label">Your name</label><input className="form_input w-input" maxLength="256" name="name" data-name="Name" placeholder="Enter your name" type="text" id="name" /></div> <div className="form_field-wrapper"><label htmlFor="Email" className="form_label">email address</label><input className="form_input w-input" maxLength="256" name="Email" data-name="Email" placeholder="Enter your email" type="email" id="Email" required="" /></div> <div id="w-node-_24207146-8187-0846-a9f0-046ec5c0a194-c5c0a18a" className="form_field-wrapper"><label htmlFor="field" className="form_label">your message</label><textarea id="field" name="field" maxLength="5000" data-name="Field" placeholder="Write something...." className="form_input is-text-area w-input"></textarea></div> <div><input type="submit" data-wait="Please wait..." className="button_component w-button" value="Submit" /></div> </form> <div className="w-form-done"> <div>Thank you! Your submission has been received!</div> </div> <div className="w-form-fail"> <div>Oops! Something went wrong while submitting the form.</div> </div> </div> </div> </div> </div> </div> <div className="padding-section-large"></div> </section>
    </section>
  );
}