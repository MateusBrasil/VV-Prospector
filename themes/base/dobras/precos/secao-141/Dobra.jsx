"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-141
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* Upmind — About Hero
  //      Classic <script> (NOT a module): no import/export.
  //      All animation is handled by the shared global scripts loaded before this file
  //      (hero-load.js, navbar.js, button-hover.js). The hero reveal hooks live in the
  //      markup/CSS — this file is an intentional stub left for component-specific
  //      behavior. Keep it free of import/export so it parses as a classic script. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="precos-secao-141" ref={raiz}>
      <div className="page-wrapper">
          ...
          <section className="section_about-hero">
            <div className="about_hero-grid">
              <div id="w-node-_3dc79580-7b92-22aa-d9cc-dc120dc9f78e-4e1074c6" className="about_hero-top">
                <div className="about-hero_content">
                  <div className="about_content-left">
                    ...
                    <div>
                      <h1 className="h3">Empowering your business<br />With smarter strategy</h1>
                    </div>
                  </div>
                  <div>
                    <div className="text-color-subtle">With years of experience across various industries, our dedicated team is committed to driving growth and operational excellence.</div>
                  </div>
                </div>
              </div>
              <div id="w-node-_34b1f561-19b2-70c4-207c-b43b4e66b25c-4e1074c6" className="about_hero-bottom">
                <div className="about_hero-img"><img src={s.imagem2} loading="lazy" sizes="100vw" srcSet="https://d173woph5zl366.cloudfront.net/upmind/images/contact-bg-p-500.avif 500w, https://d173woph5zl366.cloudfront.net/upmind/images/contact-bg-p-800.avif 800w, https://d173woph5zl366.cloudfront.net/upmind/images/contact-bg.avif 1280w" alt="" className="img" /></div>
                <div className="about_hero-content">
                  <div>
                    <div className="font-mono">Clarity. Strategy. Impact.</div>
                  </div>
                  <div>
                    <div className="max-heading is-24rem">
                      <h2 className="h4">{s.titulo}</h2>
                    </div>
                    <div className="spacer-xhuge"></div>
                    <div className="hero_buttons">
                      <a button="" data-wf--button--variant="white" href="/services" className="button_component w-variant-1e882d65-2d3f-0018-08ce-664d4afd53a8 w-inline-block">
                        <div className="button_mask">
                          <div button-text="" className="button_text w-variant-1e882d65-2d3f-0018-08ce-664d4afd53a8">View Demo</div>
                        </div>
                      </a>
