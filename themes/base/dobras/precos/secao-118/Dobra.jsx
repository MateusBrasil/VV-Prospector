"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-118
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* catalis-home-hero: sin logica local; reveals/navbar desde /catalis/scripts/. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="precos-secao-118" ref={raiz}>
      <div className="navbar w-nav" data-collapse="medium" role="banner"> <div className="nav_space"></div> <div className="padding-global is-navbar"> <div className="container-large is-navbar"> <div className="navbar_content"> <a href="/" aria-label="Catalis home" data-nav-item="" className="navbar_logo-link w-nav-brand"> <img loading="eager" width="36" height="36" src={s.imagem} alt="Catalis" className="navbar_logo" /> </a> <div className="nav_wrap"> <nav role="navigation" className="nav_mobile w-nav-menu"> <div className="navbar_list"> <a href="/about" data-nav-item="" className="nav_links w-nav-link">{s.acao}</a><a href="/features" data-nav-item="" className="nav_links w-nav-link">{s.acao2}</a><a href="/pricing" data-nav-item="" className="nav_links w-nav-link">{s.acao3}</a><a href="/blog" data-nav-item="" className="nav_links w-nav-link">{s.acao4}</a> </div> </nav> </div> <div className="nav_buttons-wrap"> <div className="login-wrap hide-mobile-landscape"> <a href="/contact" data-nav-item="" className="button_component w-inline-block"> <div className="button_content"> <div className="button_text is-one">Contact</div> <div className="button_text is-two">Contact</div> </div> </a> </div> <div className="hamburger-anchor" data-nav-item=""> <div className="hamburger-nav"> <div className="hamburger-nav__bg" aria-hidden="true"></div> <div className="hamburger-nav__group"> <p className="hamburger-nav__menu-p">{s.texto}</p> <ul className="hamburger-nav__ul"> <li className="hamburger-nav__li"> <a href="/about" className="hamburger-nav__a"> <p className="hamburger-nav__p">{s.texto2}</p> <div className="hamburger-nav__dot" aria-hidden="true"></div> </a> </li><li className="hamburger-nav__li"> <a href="/features" className="hamburger-nav__a"> <p className="hamburger-nav__p">{s.texto3}</p> <div className="hamburger-nav__dot" aria-hidden="true"></div> </a> </li><li className="hamburger-nav__li"> <a href="/pricing" className="hamburger-nav__a"> <p className="hamburger-nav__p">{s.texto4}</p> <div className="hamburger-nav__dot" aria-hidden="true"></div> </a> </li><li className="hamburger-nav__li"> <a href="/blog" className="hamburger-nav__a"> <p className="hamburger-nav__p">{s.texto5}</p> <div className="hamburger-nav__dot" aria-hidden="true"></div> </a> </li> <li className="hamburger-nav__li hamburger-nav__li-contact"> <a href="/contact" className="hamburger-nav__a"> <p className="hamburger-nav__p">{s.texto6}</p> <div className="hamburger-nav__dot" aria-hidden="true"></div> </a> </li> </ul> </div> <button type="button" data-navigation-toggle="toggle" aria-label="Toggle menu" aria-expanded="false" className="hamburger-nav__toggle" onClick={s.onClick}> <div className="hamburger-nav__toggle-bar"></div> <div className="hamburger-nav__toggle-bar"></div> </button> </div> </div> </div> <img src={s.imagem2} loading="lazy" alt="" className="corner-left" /> <img src={s.imagem3} loading="lazy" alt="" className="corner-right" /> </div> </div> </div> </div>
        <div data-navigation-toggle="close" className="navigation__dark-bg" aria-hidden="true"></div>
      <section className="section_home"> <div className="hero_wrap"> <div> <div className="hero_layout"> <div className="badge" style={{height: '2rem'}} animation="badge"><img src={s.imagem4} loading="lazy" alt="" className="badge_image" /> <div className="badge_text">From Strategy to Success</div> </div> <div className="max-heading is-42rem"> <h1 animation="heading">Build and <em>Growth</em> with Scalable Tools</h1> </div> <div className="max-description is-32rem"> <div animation="description">Easily adapt to changes and scale your operations with our flexible infrastructure, designed to support your business growth.</div> </div> </div> <div className="spacer-xhuge"></div> <div className="hero_button-wrap" animation="buttons"> <a animation="" href="/contact" className="button_component w-inline-block"> <div className="button_content"> <div className="button_text is-one">Get Started</div> <div className="button_text is-two">Get Started</div> </div> </a> <a animation="" href="/features" className="button_component w-variant-02578fa3-4dfb-f9fd-9090-5ef572c52b8e w-inline-block"> <div className="button_content"> <div className="button_text is-one">Learn More</div> <div className="button_text is-two">Learn More</div> </div> </a> </div> </div> <div className="hero_visuals"> <div animation="card" className="hero_card-img is-one"><img src={s.imagem5} loading="lazy" alt="" className="img" /></div> <div animation="card" className="hero_card-img is-two"><img src={s.imagem6} loading="lazy" alt="" className="img" /></div> <div animation="card" className="hero_card-img is-three"><img src={s.imagem7} loading="lazy" alt="" className="img" /></div> </div> </div> </section>
    </section>
  );
}