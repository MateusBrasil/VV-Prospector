"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-140
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   /* Upmind — Blogs Hero.
  //      No section-specific boot code is needed. The load-in choreography (eyebrow,
  //      h1 SplitText reveal, description fade, featured-card stagger, image zoom) is
  //      driven by the shared /upmind/scripts/hero-load.js, which targets
  //      `.section_blogs-hero`. The navbar (sticky + mobile menu) and the button mask
  //      hover are wired by /upmind/scripts/navbar.js and /upmind/scripts/button-hover.js.
  //      This file is intentionally an empty classic <script> boot stub. */
  //   
  ...
  return (
    <section className="dobra" data-dobra="precos-secao-140" ref={raiz}>
      <div className="page-wrapper">
          ...
          <section className="section_blogs-hero bg-primary">
            ...
            <div className="padding-global">
              <div className="container-large">
                <div>
                  ...
                  <h1 className="text-6xl text-color-on-primary">{s.titulo}</h1>
                  <div className="spacer-small"></div>
                  <div className="max-description is-32rem">
                    <div className="text-color-subtle">Whether you’re optimizing today or building for tomorrow  we help you move faster with confidence.</div>
                  </div>
                </div>
                ...
                <div className="w-dyn-list">
                  <div role="list" className="w-dyn-items">
                    <div role="listitem" className="w-dyn-item">
                      <div className="blog-hero_bottom">
                        <div className="blog-hero_img">
                          <img src={s.imagem2} loading="lazy" alt="" className="img" />
                        </div>
                        <div className="blog_content">
                          <div className="font-mono text-color-neon">January 8, 2026</div>
                          <div className="max-heading is-rem">
                            <h2 className="text-4xl text-color-neon">{s.titulo2}</h2>
                          </div>
                          <div className="text-color-neon">We offer a comprehensive range of services designed to meet the unique needs of your business. From strategy development to risk management, our expert team is dedicated to driving your success.</div>
                          <div className="hero_buttons">
                            <a data-wf--button--variant="green" href="/blog/why-ai-is-the-missing-piece-in-traditional-consulting" className="button_component w-variant-62c86aa8-15d0-dc6b-786e-c05471c0a18d w-inline-block">
                              <div className="button_mask">
                                <div className="button_text w-variant-62c86aa8-15d0-dc6b-786e-c05471c0a18d">Read More</div>
                              </div>
                            </a>
                          </div>
                        </div>
