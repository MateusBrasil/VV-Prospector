"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-90
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  return (
    <section className="dobra" data-dobra="cta-secao-90" ref={raiz}>
      <div className="page-wrapper">
          <section className="section_contact">
            <div className="contact-hero_grid">
              <div className="contact-hero_left">
                <div>
                  <div data-wf--section-title--variant="black" className="section_title w-variant-dbb4a0a6-0c21-a050-cfd8-50437556227c">
                    <div className="title-dot bg-neon w-variant-dbb4a0a6-0c21-a050-cfd8-50437556227c"></div>
                    <div>Contact us</div>
                  </div>
                </div>
                <div>
                  <h1 className="h3">{s.titulo}</h1>
                  <div className="spacer-medium"></div>
                  <div className="text-color-secondary">Learn about our journey, mission, and the team driving innovation.</div>
                </div>
                <div className="contact_info-wrapper">
                  <div className="contact_data">
                    <div>Email:</div>
                    <div className="spacer-medium"></div>
                    <div className="text-xl">Consulting@gmail.com</div>
                  </div>
                  <div className="contact_data">
                    <div>Phone:</div>
                    <div className="spacer-medium"></div>
                    <div className="text-xl">+1 (123) 456-7890</div>
                  </div>
                  <div className="contact_data">
                    <div>Office:</div>
                    <div className="spacer-medium"></div>
                    <div className="text-xl">456 Business Ave, New York, NY 10001</div>
                  </div>
                  <div className="contact_data">
                    <div>Follow Us:</div>
                    <div className="spacer-medium"></div>
                    <div className="social-icons_grid">
                      <div data-wf--icon-wrapper--variant="small-rounded" className="card-icon-wrap w-variant-946ba254-6541-7473-50f3-558f1a60403c"><img src={s.imagem} loading="lazy" alt="" className="card-icon w-variant-946ba254-6541-7473-50f3-558f1a60403c" /></div>
                      <div data-wf--icon-wrapper--variant="small-rounded" className="card-icon-wrap w-variant-946ba254-6541-7473-50f3-558f1a60403c"><img src={s.imagem2} loading="lazy" alt="" className="card-icon w-variant-946ba254-6541-7473-50f3-558f1a60403c" /></div>
                      <div data-wf--icon-wrapper--variant="small-rounded" className="card-icon-wrap w-variant-946ba254-6541-7473-50f3-558f1a60403c"><img src={s.imagem3} loading="lazy" alt="" className="card-icon w-variant-946ba254-6541-7473-50f3-558f1a60403c" /></div>
                      <div data-wf--icon-wrapper--variant="small-rounded" className="card-icon-wrap w-variant-946ba254-6541-7473-50f3-558f1a60403c"><img src={s.imagem4} loading="lazy" alt="" className="card-icon w-variant-946ba254-6541-7473-50f3-558f1a60403c" /></div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="contact-hero_right">
                <div contact-form="" className="form_wrapper w-form">
                  <form id="wf-form-Form" name="wf-form-Form" data-name="Form" method="get" className="form_form" data-wf-page-id="69767ac0f10e6dc1e3ce412d" data-wf-element-id="e4692129-2b93-03f9-816b-0fe1d8458842">
                    <div className="form_field-wrapper"><label htmlFor="First-Name-3" className="form_label">Full name</label><input className="form_input w-input" maxLength="256" name="First-Name" data-name="First Name" placeholder="Your full name" type="text" id="First-Name-3" /></div>
                    <div className="form_field-wrapper"><label htmlFor="Email-3" className="form_label">Email address</label><input className="form_input w-input" maxLength="256" name="Email" data-name="Email" placeholder="Your email address" type="email" id="Email-3" /></div>
                    <div className="form_field-wrapper"><label htmlFor="Message-3" className="form_label">Messages</label><textarea id="Message-3" name="Message" maxLength="5000" data-name="Message" placeholder="Your messages here.." className="form_input is-text-area w-input"></textarea></div>
                    <div><button type="submit" button="" className="button_component" onClick={s.onClick}>
