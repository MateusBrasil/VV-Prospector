"use client";
/* DOBRA gerada pela esteira a partir de bank/_componentes/secoes/secao-49
 *
...
export default function Dobra({ slots: s = {} }) {
  ...
  useGSAP(() => {
  //   // upmind-cta-section — classic <script>, NO import/export.
  //   //
  //   // All behavior is provided by the shared template scripts loaded before this file:
  //   //   /upmind/scripts/scroll-reveal.js  -> slides the .cta_content (data-reveal) up on enter
  //   //   /upmind/scripts/button-hover.js   -> per-letter slide + press on the two CTA buttons
  //   //
  //   // The background is a native autoplay/loop/muted/playsinline <video> inside a
  //   // Webflow w-background-video, so it plays on its own with no JS. Nothing to boot here.
  //   
  ...
  return (
    <section className="dobra" data-dobra="cta-secao-49" ref={raiz}>
      <div className="page-wrapper">
          <section className="section_cta">
            <div className="cta_gradient"></div>
            <div className="padding-section-medium"></div>
            <div className="padding-global">
              <div className="container-large">
                <div className="cta_content" data-reveal="">
                  <div className="cta_heading">
                    ...
                    <div className="max-description is-31rem">
                      <div>Partner with us to take your digital presence to the next level.</div>
                    </div>
                  </div>
            ...
            <div className="padding-section-medium"></div>
            <div className="cta_background-wrapper">
              <div data-poster-url="/upmind/videos/way_poster.0000000.jpg" data-video-urls="/upmind/videos/way_mp4.mp4,/upmind/videos/way_webm.webm" data-autoplay="true" data-loop="true" data-wf-ignore="true" className="cta-hero_video w-background-video w-background-video-atom">
                <video id="1ef8bf18-0df5-9a3d-cb19-5a7a83c49338-video" autoPlay="" loop="" style={{backgroundImage: `url(${s.imagem})`}} muted="" playsinline="" data-wf-ignore="true" data-object-fit="cover">
