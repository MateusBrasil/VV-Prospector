...
/* /contacto/ — a MESMA dobra que fecha a home (`contacto/secao-83`), com os mesmos
 * slots. Não é duplicação por descuido: é o destino real do botão do rodapé e do CTA da
 * barra, e ter uma página própria é o que permite ao Google indexar a morada e o
 * telefone como conteúdo principal de um URL.
 *
