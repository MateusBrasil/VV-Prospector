 ...
 * diretamente.
 *
 * Este ficheiro é o mesmo do moda-editorial menos `produtos` (não há vitrine de produtos
 * num consultório) e mais nada: as secções deste nicho leem `blocos.*` como as outras.
 */
