...
**NO INVENTED FEATURES**: Do not add animations, scroll effects, parallax, hover transitions, gradient overlays, or any visual/interactive behavior unless it is explicitly present in the Figma design or specifically requested by the user. Simples, static HTML/CSS that matches the design is always correct.
