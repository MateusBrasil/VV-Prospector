(function(){
  var __root = document.querySelector('[data-blk="animacoes-de-rolagem-animacao-rolagem-3"]');
  if(!__root) return;
...
function positionCards() {
  const cards = Array.from(__qa('.card'))
