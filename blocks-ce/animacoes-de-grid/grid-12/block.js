(function(){
  var __root = document.querySelector('[data-blk="animacoes-de-grid-grid-12"]');
  if(!__root) return;
...
const animateFirstGrid = () => {
  const grid = __q('[data-grid-first]');
...
const animateSecondGrid = () => {
  const grid = __q('[data-grid-second]');
  const gridImages = grid.querySelectorAll('.grid__img');
...
const animateThirdGrid = () => {
  const grid = __q('[data-grid-third]');
  const gridImages = grid.querySelectorAll('.grid__img');
...
const animateFourthGrid = () => {
  const grid = __q('[data-grid-fourth]');
  const gridImages = grid.querySelectorAll('.grid__img');
...
const animateFourthV2Grid = () => {
  const grid = __q('[data-grid-fourth-v2]');
  const gridImages = grid.querySelectorAll('.grid__img');
...
const animateFifthGrid = () => {
  const grid = __q('[data-grid-fifth]');
  const gridImages = grid.querySelectorAll('.grid__img');
...
const animateSixthGrid = () => {
  const grid = __q('[data-grid-sixth]');
  const gridImages = grid.querySelectorAll('.grid__img');
...
const animateSeventhGrid = () => {
  const grid = __q('[data-grid-seventh]');
  const gridImages = grid.querySelectorAll('.grid__img');
...
const animateEighthGrid = () => {
  const grid = __q('[data-grid-eighth]');
  const gridImages = grid.querySelectorAll('.grid__img');
...
const animateNinthGrid = () => {
  const grid = __q('[data-grid-ninth]');
  const gridImages = grid.querySelectorAll('.grid__img');
...
preloadImages('.grid__img').then(() => {
  __root.classList.remove('loading'); // Remove the loading class from the body
  init();
  window.scrollTo(0, 0);
});
